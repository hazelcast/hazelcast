...
link:http://docs.hazelcast.org/docs/3.6-EA/manual/html-single/index.html#discovery-spi[here].
      ...
      <discovery-strategies>
        <discovery-strategy enabled="true"
          ...
          <properties>
            ...
            <!-- legal values are IPV4, IPV6 or empty (which defaults to IPV4) -->
            <property name="service-dns-ip-type">IPV4</property>
          </properties>
        </discovery-strategy>
      </discovery-strategies>
    </join>
