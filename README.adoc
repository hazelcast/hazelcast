...
This plugin is included in the link:https://hub.docker.com/r/hazelcast/hazelcast-kubernetes/[hazelcast/hazelcast-kubernetes] and link:https://hub.docker.com/r/hazelcast/hazelcast-enterprise-kubernetes/[hazelcast/hazelcast-enterprise-kubernetes] Docker images whose source and documentation reside in https://github.com/hazelcast/hazelcast-docker. 
