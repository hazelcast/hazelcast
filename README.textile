...
table{border:0}.
|With its various distributed data structures, distributed caching capabilities, elastic nature, memcache support, integration with Spring and Hibernate and more importantly so many happy users, Hazelcast is feature-rich, enterprise-ready and developer-friendly in-memory data grid solution.|\2.!{width:200px; height:120px}http://www.hazelcast.com/screencasts/gettingstarted-small.jpg!:http://www.hazelcast.com/screencast.jsp|
