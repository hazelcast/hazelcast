...
public class PartitionClientProxy implements PartitionService {
    ...
    public Set<Partition> getPartitions() {
        Protocol protocol = proxyHelper.doCommand((Member)null, Command.PARTITIONS, new String[]{}, null);
    ...
    public Partition getPartition(Object key) {
        Protocol protocol = proxyHelper.doCommand((Member)null, Command.PARTITIONS, new String[]{}, proxyHelper.toData(key));
