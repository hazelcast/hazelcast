...
public class ClientReplicatedMapProxy<K, V> extends ClientProxy implements ReplicatedMap<K, V> {
    ...
    public V put(K key, V value, long ttl, TimeUnit timeUnit) {
        ...
        VersionResponsePair result = invoke(new ClientReplicatedMapPutTtlRequest(getName(), dataKey, dataValue,
                timeUnit.toMillis(ttl)));
        return (V) result.getResponse();
    }
    ...
    public V remove(Object key) {
        Data dataKey = toData(key);
        VersionResponsePair result = invoke(new ClientReplicatedMapRemoveRequest(getName(), dataKey));
        return (V) result.getResponse();
    }
