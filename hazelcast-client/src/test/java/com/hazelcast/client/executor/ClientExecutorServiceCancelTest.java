...
public class ClientExecutorServiceCancelTest extends HazelcastTestSupport {
    ...
    public void testCancel_submitRandom(boolean smartRouting) throws ExecutionException, InterruptedException {
    ...
    public void testCancel_submitToKeyOwner(boolean smartRouting) throws ExecutionException, InterruptedException {
        HazelcastInstance client = createClient(smartRouting);
