...
public class FlakeIdGenerator_NodeIdOverflowIntegrationTest {
    ...
    @Test
    public void when_oneOverflowedNodeId_then_theOtherUsed() throws Exception {
        ...
        ClientFlakeIdGeneratorProxy.setNumAttempts(1);
    ...
    @Test
    public void when_allMembersOverflowedNodeId_then_error() {
        factory = new TestHazelcastFactory();
        HazelcastInstance instance1 = factory.newHazelcastInstance();
        HazelcastInstance instance2 = factory.newHazelcastInstance();
        ...
        exception.expectMessage("All members have overflowed nodeIDs");
        gen.newId();
    }

    public void assignOverflowedNodeId(HazelcastInstance instance2) {
