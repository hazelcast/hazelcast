...
public class ClientJCacheConcurrencyTest
    ...
    public void test_concurrect_cachemanager_creation() throws Exception {
        ...
        final Properties properties = HazelcastCachingProvider.propertiesByInstanceName(client.getName());
            ...
            new Thread(new Runnable() {
                ...
                public void run() {
                    try {
                        ...
                        CacheManager cacheManager = cachingProvider3.getCacheManager(uri, null, properties);
