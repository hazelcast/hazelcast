...
- **Hazelcast Client Protocol**: Starting with 3.5, the new clients that use the new Hazelcast Binary Client Protocol are introduced. Please see the important note at the last paragraph of the [Hazelcast Java Client chapter's](#hazelcast-java-client) introduction.
...
- **Management of Unbounded Return Values**: Introduces a `QueryResultSizeLimiter`. Please see the [OOM Prevention section](#oom-prevention).
