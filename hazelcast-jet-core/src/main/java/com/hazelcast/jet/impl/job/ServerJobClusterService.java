...
public class ServerJobClusterService extends JobClusterService<JetOperation> {
    ...
    public JetOperation createInterruptInvoker() {
        return new JobInterruptOperation(
                this.name
        );
    }
    ...
    public JetOperation createExecutionInvoker() {
        return new JobExecuteOperation(
                this.name
        );
    }
    ...
    protected <T> Callable<T> createInvocation(Member member,
        ...
        return new ServerJobInvocation<>(
                factory.get(),
                member.getAddress(),
                this.nodeEngine
        );
