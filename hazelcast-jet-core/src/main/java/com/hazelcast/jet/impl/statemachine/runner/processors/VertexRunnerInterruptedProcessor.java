...
public class VertexRunnerInterruptedProcessor implements VertexRunnerPayloadProcessor<Throwable> {
    private final VertexRunner vertexRunner;
    private final JobManager jobManager;
    private final ILogger logger;

    public VertexRunnerInterruptedProcessor(VertexRunner vertexRunner) {
        this.vertexRunner = vertexRunner;
        this.jobManager = vertexRunner.getJobContext().getJobManager();
