...
public class JobRemoteServiceDescriptorProvider implements RemoteServiceDescriptorProvider {
    private RemoteServiceDescriptor[] descriptors;

    public JobRemoteServiceDescriptorProvider() {
        ...
        this.descriptors[0] = new RemoteServiceDescriptor() {
            ...
            public RemoteService getService(NodeEngine nodeEngine) {
                return new JobService(nodeEngine);
            }
        };
    }
