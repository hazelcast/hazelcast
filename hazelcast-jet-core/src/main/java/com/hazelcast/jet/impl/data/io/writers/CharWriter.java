...
public class CharWriter implements ObjectWriter<Character> {
    @Override
    public void writeType(Character object,
                          ObjectDataOutput objectDataOutput,
                          ObjectWriterFactory objectWriterFactory) throws Exception {
        objectDataOutput.write(Types.CHAR.getTypeID());
    }

    @Override
    public void writePayLoad(Character object,
                             ObjectDataOutput objectDataOutput,
                             ObjectWriterFactory objectWriterFactory) throws Exception {
        objectDataOutput.writeChar(object);
    }

    @Override
    public void write(Character object,
                      ObjectDataOutput objectDataOutput,
                      ObjectWriterFactory objectWriterFactory) throws Exception {
