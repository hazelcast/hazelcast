...
/**
 * State-machine request which starts execution of vertex runners;
 */
public class VertexRunnerExecuteRequest implements StateMachineRequest<VertexRunnerEvent, Dummy> {
    @Override
    public VertexRunnerEvent getEvent() {
        return VertexRunnerEvent.EXECUTE;
    }
