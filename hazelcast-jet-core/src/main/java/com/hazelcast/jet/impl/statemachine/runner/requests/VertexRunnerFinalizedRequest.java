...
public class VertexRunnerFinalizedRequest implements StateMachineRequest<VertexRunnerEvent, VertexRunner> {
    private final VertexRunner vertexRunner;

    public VertexRunnerFinalizedRequest(VertexRunner vertexRunner) {
        this.vertexRunner = vertexRunner;
    }

    @Override
    public VertexRunnerEvent getEvent() {
        return VertexRunnerEvent.FINALIZE;
    }

    @Override
    public VertexRunner getPayload() {
        return this.vertexRunner;
    }
}
