...
public class MetaProcessorSupplierContextImpl implements MetaProcessorSupplierContext {
    private HazelcastInstance instance;
    private int totalParallelism;
    private int perNodeParallelism;

    public MetaProcessorSupplierContextImpl(HazelcastInstance instance, int totalParallelism, int perNodeParallelism) {
