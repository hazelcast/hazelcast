...
import com.hazelcast.jet.internal.api.statemachine.StateMachineRequest;
...
import com.hazelcast.jet.internal.api.statemachine.application.ApplicationResponse;
...
import com.hazelcast.jet.internal.impl.statemachine.application.ApplicationStateMachineRequest;
...
import static com.hazelcast.jet.internal.api.statemachine.application.ApplicationEvent.EXECUTION_FAILURE;
import static com.hazelcast.jet.internal.api.statemachine.application.ApplicationEvent.EXECUTION_START;
import static com.hazelcast.jet.internal.api.statemachine.application.ApplicationEvent.EXECUTION_SUCCESS;
import static com.hazelcast.jet.internal.api.statemachine.application.ApplicationEvent.FINALIZATION_FAILURE;
import static com.hazelcast.jet.internal.api.statemachine.application.ApplicationEvent.FINALIZATION_START;
import static com.hazelcast.jet.internal.api.statemachine.application.ApplicationEvent.FINALIZATION_SUCCESS;
import static com.hazelcast.jet.internal.api.statemachine.application.ApplicationEvent.INIT_FAILURE;
import static com.hazelcast.jet.internal.api.statemachine.application.ApplicationEvent.INIT_SUCCESS;
import static com.hazelcast.jet.internal.api.statemachine.application.ApplicationEvent.INTERRUPTION_FAILURE;
import static com.hazelcast.jet.internal.api.statemachine.application.ApplicationEvent.INTERRUPTION_START;
import static com.hazelcast.jet.internal.api.statemachine.application.ApplicationEvent.INTERRUPTION_SUCCESS;
import static com.hazelcast.jet.internal.api.statemachine.application.ApplicationEvent.LOCALIZATION_FAILURE;
import static com.hazelcast.jet.internal.api.statemachine.application.ApplicationEvent.LOCALIZATION_START;
import static com.hazelcast.jet.internal.api.statemachine.application.ApplicationEvent.LOCALIZATION_SUCCESS;
import static com.hazelcast.jet.internal.api.statemachine.application.ApplicationEvent.SUBMIT_FAILURE;
import static com.hazelcast.jet.internal.api.statemachine.application.ApplicationEvent.SUBMIT_START;
import static com.hazelcast.jet.internal.api.statemachine.application.ApplicationEvent.SUBMIT_SUCCESS;
