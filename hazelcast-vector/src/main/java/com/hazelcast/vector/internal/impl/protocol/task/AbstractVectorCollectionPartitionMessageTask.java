...
public abstract class AbstractVectorCollectionPartitionMessageTask<P> extends AbstractPartitionMessageTask<P> {
    private transient long startTimeNanos;

    protected AbstractVectorCollectionPartitionMessageTask(ClientMessage clientMessage, Node node, Connection connection) {
