...
public class RemoveOperation extends BaseDeleteOwnerOperation {
    ...
    public RemoveOperation(String vectorCollectionName, Data key) {
    ...
    public int getClassId() {
        return VectorCollectionSerializerHook.REMOVE;
    }
}
