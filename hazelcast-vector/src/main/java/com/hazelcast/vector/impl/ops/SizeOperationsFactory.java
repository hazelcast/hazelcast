...
public class SizeOperationsFactory implements OperationFactory {

    private String vectorCollectionName;

    public SizeOperationsFactory() {
    }

    public SizeOperationsFactory(String vectorCollectionName) {
    ...
    public int getClassId() {
        return VectorCollectionSerializerHook.SIZE_FACTORY;
    }
    ...
    public Operation createOperation() {
        return new SizeOperation(vectorCollectionName);
    }
}
