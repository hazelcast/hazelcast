...
public class VectorCollectionClearMessageTask
        extends AbstractVectorCollectionAllPartitionsMessageTask<String> {

    VectorCollectionClearMessageTask(ClientMessage clientMessage, Node node, Connection connection) {
        super(clientMessage, node, connection);
    }

    @Override
    protected String decodeClientMessage(ClientMessage clientMessage) {
        return VectorCollectionClearCodec.decodeRequest(clientMessage);
    }

    @Override
    protected ClientMessage encodeResponse(Object response) {
        return VectorCollectionClearCodec.encodeResponse();
    }

    @Override
    protected OperationFactory createOperationFactory() {
        return new ClearOperationsFactory(parameters);
    }

    @Override
    protected Object reduce(Map<Integer, Object> map) {
        recordStats(LocalVectorCollectionStatsImpl::incrementClearLatencyNanos);
        return null;
    }
