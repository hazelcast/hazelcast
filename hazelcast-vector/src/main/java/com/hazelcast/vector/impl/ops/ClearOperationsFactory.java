...
public class ClearOperationsFactory implements OperationFactory {

    private String vectorCollectionName;

    public ClearOperationsFactory() {
    }

    public ClearOperationsFactory(String vectorCollectionName) {
    ...
    public int getClassId() {
        return VectorCollectionSerializerHook.CLEAR_FACTORY;
    }
    ...
    public Operation createOperation() {
        return new ClearOperation(vectorCollectionName);
    }
}
