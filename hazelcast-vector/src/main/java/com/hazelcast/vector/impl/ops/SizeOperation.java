...
public class SizeOperation extends AbstractNamedOperation implements PartitionAwareOperation, ReadonlyOperation {

    private transient long size;

    public SizeOperation(String vectorCollectionName) {
    ...
    public int getClassId() {
        return VectorCollectionSerializerHook.SIZE;
    }
}
