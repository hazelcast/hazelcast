...
final class MappingTypeGetter {

    private MappingTypeGetter() {
    }

    public static String getMappingType(NodeEngineImpl nodeEngine, GenericMapStoreProperties properties) {
