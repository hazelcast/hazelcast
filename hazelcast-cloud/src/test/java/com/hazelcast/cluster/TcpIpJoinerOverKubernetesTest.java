...
import com.hazelcast.cluster.impl.TcpIpJoinerOverKubernetes;
...
public class TcpIpJoinerOverKubernetesTest extends HazelcastTestSupport {
    ...
    public void testJoinerCreation() {
        ...
        Assert.assertEquals(TcpIpJoinerOverKubernetes.class, joiner.getClass());
    }
}
