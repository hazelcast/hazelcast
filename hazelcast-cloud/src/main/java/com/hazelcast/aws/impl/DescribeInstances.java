...
public class DescribeInstances {
    ...
    public List<AwsIpResolver.PublicPrivatePair> execute(String endpoint) throws Exception {
        rs.sign(this, endpoint);
        return callService(endpoint);
    }

    private List<AwsIpResolver.PublicPrivatePair> callService(String endpoint) throws Exception {
        ...
        List<AwsIpResolver.PublicPrivatePair> response = unmarshalTheResponse(httpConnection.getInputStream(), awsConfig);
        return response;
    }
}
