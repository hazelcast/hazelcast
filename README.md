...
If you setup your Azure resource identities with the correct access roles, you will need just the following minimal configuration to setup Hazelcast Azure Discovery:
