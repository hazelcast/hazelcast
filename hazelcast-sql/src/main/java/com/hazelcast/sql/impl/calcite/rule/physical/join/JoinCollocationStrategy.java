...
import static com.hazelcast.sql.impl.calcite.rule.physical.join.JoinCollocationAction.BROADCAST;
import static com.hazelcast.sql.impl.calcite.rule.physical.join.JoinCollocationAction.NONE;
import static com.hazelcast.sql.impl.calcite.rule.physical.join.JoinCollocationAction.REPLICATED_HASH;
import static com.hazelcast.sql.impl.calcite.rule.physical.join.JoinCollocationAction.UNICAST;
import static com.hazelcast.sql.impl.calcite.rule.physical.join.JoinConditionType.EQUI;
import static com.hazelcast.sql.impl.calcite.rule.physical.join.JoinConditionType.OTHER;
import static com.hazelcast.sql.impl.calcite.rule.physical.join.JoinDistribution.PARTITIONED;
import static com.hazelcast.sql.impl.calcite.rule.physical.join.JoinDistribution.RANDOM;
import static com.hazelcast.sql.impl.calcite.rule.physical.join.JoinDistribution.REPLICATED;
