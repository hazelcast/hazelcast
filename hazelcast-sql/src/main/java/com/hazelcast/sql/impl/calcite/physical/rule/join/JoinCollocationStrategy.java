...
import static com.hazelcast.sql.impl.calcite.physical.rule.join.JoinCollocationAction.BROADCAST;
import static com.hazelcast.sql.impl.calcite.physical.rule.join.JoinCollocationAction.NONE;
import static com.hazelcast.sql.impl.calcite.physical.rule.join.JoinCollocationAction.REPLICATED_HASH;
import static com.hazelcast.sql.impl.calcite.physical.rule.join.JoinCollocationAction.UNICAST;
import static com.hazelcast.sql.impl.calcite.physical.rule.join.JoinConditionType.EQUI;
import static com.hazelcast.sql.impl.calcite.physical.rule.join.JoinConditionType.OTHER;
import static com.hazelcast.sql.impl.calcite.physical.rule.join.JoinDistribution.PARTITIONED;
import static com.hazelcast.sql.impl.calcite.physical.rule.join.JoinDistribution.RANDOM;
import static com.hazelcast.sql.impl.calcite.physical.rule.join.JoinDistribution.REPLICATED;
import static com.hazelcast.sql.impl.calcite.physical.rule.join.JoinType.FULL;
import static com.hazelcast.sql.impl.calcite.physical.rule.join.JoinType.INNER;
import static com.hazelcast.sql.impl.calcite.physical.rule.join.JoinType.OUTER;
