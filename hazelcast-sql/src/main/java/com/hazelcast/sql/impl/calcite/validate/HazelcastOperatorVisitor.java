...
public final class HazelcastOperatorVisitor extends SqlBasicVisitor<Void> {
    ...
    private static final SqlNameMatcher NAME_MATCHER = SqlNameMatchers.withCaseSensitive(true);

    private HazelcastOperatorVisitor() {
    }

    public static void rewriteCall(SqlCall call) {
    ...
    public static void rewriteNodeList(SqlNodeList nodeList) {
