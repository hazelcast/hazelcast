...
import static com.hazelcast.sql.impl.calcite.physical.distribution.PhysicalDistributionType.REPLICATED;
import static com.hazelcast.sql.impl.calcite.physical.distribution.PhysicalDistributionType.SINGLETON;
...
public final class SortPhysicalRule extends RelOptRule {
    ...
    private Collection<RelNode> getTransforms(SortLogicalRel logicalSort, RelNode convertedInput) {
        ...
        if (res.isEmpty()) {
            ...
            SortMergeExchangePhysicalRel rel = createDistributedSort(logicalSort, relInput);
     ...
     */
    private static boolean requiresDistributedPhase(PhysicalDistributionTrait inputDist) {
        PhysicalDistributionType inputDistType = inputDist.getType();
     ...
     * distribution is always SINGLETON by definition of {@link SortMergeExchangePhysicalRel}.
     *
     * @param logicalSort Logical sort.
     * @param physicalInput Physical input.
     * @return Physical distributed sort.
     */
    private static SortMergeExchangePhysicalRel createDistributedSort(SortLogicalRel logicalSort,
        RelNode physicalInput) {
        RelTraitSet traitSet = RuleUtils.traitPlus(physicalInput.getTraitSet(),
            logicalSort.getCollation(),
            PhysicalDistributionTrait.SINGLETON
        );
