...
public final class UpdateByKeyMapPhysicalRule extends ConverterRule {
    ...
    private UpdateByKeyMapPhysicalRule() {
        super(
                UpdateByKeyMapLogicalRel.class, LOGICAL, PHYSICAL,
                UpdateByKeyMapPhysicalRule.class.getSimpleName()
        );
    }

    @Override
    public RelNode convert(RelNode rel) {
        UpdateByKeyMapLogicalRel logicalUpdate = (UpdateByKeyMapLogicalRel) rel;
