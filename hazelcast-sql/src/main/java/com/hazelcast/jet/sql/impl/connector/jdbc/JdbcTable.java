...
public class JdbcTable extends JetTable {
    ...
    private final String externalDataLinkRef;
    ...
    public JdbcTable(
            ...
            @Nonnull String externalDataLinkRef,
            int batchLimit,
        ...
        this.externalDataLinkRef = externalDataLinkRef;
    ...
    public String getExternalDataLinkRef() {
