...
public class CsvQueryTargetTest {
    ...
    public void test_get() {
        ...
        assertThat(topExtractor.get(false)).isInstanceOf(String[].class);
        ...
        assertThat(timestampTzExtractor.get(false)).isEqualTo(OffsetDateTime.of(2020, 9, 9, 12, 23, 34, 200_000_000, UTC));
