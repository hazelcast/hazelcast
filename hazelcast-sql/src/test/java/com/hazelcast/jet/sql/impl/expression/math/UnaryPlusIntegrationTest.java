...
public class UnaryPlusIntegrationTest extends ExpressionTestSupport {
    ...
    public void testColumn() {
        putAndCheckValue(new ExpressionValue.IntegerVal(), sql("field1"), INTEGER, null);

        putAndCheckValue((byte) 0, sql("this"), TINYINT, (byte) 0);
        putAndCheckValue((byte) 1, sql("this"), TINYINT, (byte) 1);
        putAndCheckValue((byte) -1, sql("this"), TINYINT, (byte) -1);
        putAndCheckValue(Byte.MAX_VALUE, sql("this"), TINYINT, Byte.MAX_VALUE);
        putAndCheckValue(Byte.MIN_VALUE, sql("this"), TINYINT, Byte.MIN_VALUE);

        putAndCheckValue((short) 0, sql("this"), SMALLINT, (short) 0);
        putAndCheckValue((short) 1, sql("this"), SMALLINT, (short) 1);
        putAndCheckValue((short) -1, sql("this"), SMALLINT, (short) -1);
        putAndCheckValue(Short.MAX_VALUE, sql("this"), SMALLINT, Short.MAX_VALUE);
        putAndCheckValue(Short.MIN_VALUE, sql("this"), SMALLINT, Short.MIN_VALUE);

        putAndCheckValue(0, sql("this"), INTEGER, 0);
        putAndCheckValue(1, sql("this"), INTEGER, 1);
        putAndCheckValue(-1, sql("this"), INTEGER, -1);
        putAndCheckValue(Integer.MAX_VALUE, sql("this"), INTEGER, Integer.MAX_VALUE);
        putAndCheckValue(Integer.MIN_VALUE, sql("this"), INTEGER, Integer.MIN_VALUE);

        putAndCheckValue(0L, sql("this"), BIGINT, 0L);
        putAndCheckValue(1L, sql("this"), BIGINT, 1L);
        putAndCheckValue(-1L, sql("this"), BIGINT, -1L);
        putAndCheckValue(Long.MAX_VALUE, sql("this"), BIGINT, Long.MAX_VALUE);
        putAndCheckValue(Long.MAX_VALUE, sql("this"), BIGINT, Long.MAX_VALUE);
