...
import static com.hazelcast.test.archunit.ArchUnitRules.COMPATIBILITY_CATEGORY_NOT_NIGHTLY_OR_SLOW;
...
public class CompatibilityTestNotNightlyOrSlowCategoryTest extends ArchUnitTestSupport {
    ...
    public void testCategoryRules() {
        ...
        COMPATIBILITY_CATEGORY_NOT_NIGHTLY_OR_SLOW.check(classes);
    }
}
