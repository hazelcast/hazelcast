...
public class PhysicalIndexDataTypeTest extends IndexOptimizerTestSupport {
    ...
    public void test_tinyint() {
        ...
        checkIndexForCondition("CAST(f_tinyint AS REAL)=1", "index_tinyint", "=(CAST($2):REAL, 1.0E0)");
        checkIndexForCondition("CAST(f_tinyint AS DOUBLE)=1", "index_tinyint", "=(CAST($2):DOUBLE, 1.0E0)");
    ...
    public void test_smallint() {
        ...
        checkIndexForCondition("CAST(f_smallint AS REAL)=1", "index_smallint", "=(CAST($3):REAL, 1.0E0)");
        checkIndexForCondition("CAST(f_smallint AS DOUBLE)=1", "index_smallint", "=(CAST($3):DOUBLE, 1.0E0)");
    ...
    public void test_int() {
        ...
        checkIndexForCondition("CAST(f_int AS REAL)=1", "index_int", "=(CAST($4):REAL, 1.0E0)");
        checkIndexForCondition("CAST(f_int AS DOUBLE)=1", "index_int", "=(CAST($4):DOUBLE, 1.0E0)");
    ...
    public void test_bigint() {
        ...
        checkIndexForCondition("CAST(f_bigint AS REAL)=1", "index_bigint", "=(CAST($5):REAL, 1.0E0)");
        checkIndexForCondition("CAST(f_bigint AS DOUBLE)=1", "index_bigint", "=(CAST($5):DOUBLE, 1.0E0)");
    ...
    public void test_decimal() {
        ...
        checkIndexForCondition("CAST(f_decimal AS REAL)=1", "index_decimal", "=(CAST($6):REAL, 1.0E0)");
        checkIndexForCondition("CAST(f_decimal AS DOUBLE)=1", "index_decimal", "=(CAST($6):DOUBLE, 1.0E0)");
    ...
    public void test_real() {
        ...
        if (indexType == IndexType.SORTED) {
            checkIndexForCondition("f_real>1 AND f_real<3", "index_real", "AND(<($8, 3.0E0), >($8, 1.0E0))");
        }
        ...
        checkIndexForCondition("CAST(f_real AS DOUBLE)=1", "index_real", "=(CAST($8):DOUBLE, 1.0E0)");
    ...
    public void test_double() {
        ...
        checkIndexForCondition("CAST(f_double AS REAL)=1", "index_double", "=(CAST($9):REAL, 1.0E0)");
    ...
    private void checkNumericBasic(String columnName, int columnIndex, String indexName, QueryDataType type) {
        String literal1 = type == REAL || type == DOUBLE ? "1.0E0" : "1";
        String literal2 = type == REAL || type == DOUBLE ? "3.0E0" : "3";
        ...
        // Closed range
        if (indexType == IndexType.SORTED && type != REAL) {
    ...
    public void test_object() {
        // TODO: Tests for comparisons (doesn't work now)
