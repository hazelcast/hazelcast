...
public class MultiplyOperatorIntegrationTest extends ArithmeticOperatorIntegrationTest {
    ...
    public void testTinyint() {
        ...
        // Columns
        checkFields((byte) 2, (byte) 3, SMALLINT, (short) 6);
        checkFields(Byte.MAX_VALUE, Byte.MAX_VALUE, SMALLINT, (short) (Byte.MAX_VALUE * Byte.MAX_VALUE));

        checkFields((byte) 2, (short) 3, INTEGER, 6);
        checkFields(Byte.MAX_VALUE, Short.MAX_VALUE, INTEGER, Byte.MAX_VALUE * Short.MAX_VALUE);

        checkFields((byte) 2, 3, BIGINT, 6L);
        checkFields(Byte.MAX_VALUE, Integer.MAX_VALUE, BIGINT, (long) Byte.MAX_VALUE * Integer.MAX_VALUE);

        checkFields((byte) 2, 3L, BIGINT, 6L);
        checkError(Byte.MAX_VALUE, Long.MAX_VALUE, DATA_EXCEPTION, overflowError());

        checkFields((byte) 2, new BigInteger("3"), DECIMAL, decimal("6"));
        checkFields((byte) 2, decimal("3.3"), DECIMAL, decimal("6.6"));
        checkFields((byte) 2, 3f, REAL, 6f);
        checkFields((byte) 2, 3d, DOUBLE, 6d);
    ...
    public void testSmallint() {
        ...
        // Columns
        checkFields((short) 2, (byte) 3, INTEGER, 6);
        checkFields(Short.MAX_VALUE, Byte.MAX_VALUE, INTEGER, Short.MAX_VALUE * Byte.MAX_VALUE);

        checkFields((short) 2, (short) 3, INTEGER, 6);
        checkFields(Short.MAX_VALUE, Short.MAX_VALUE, INTEGER, Short.MAX_VALUE * Short.MAX_VALUE);

        checkFields((short) 2, 3, BIGINT, 6L);
        checkFields(Short.MAX_VALUE, Integer.MAX_VALUE, BIGINT, (long) Short.MAX_VALUE * Integer.MAX_VALUE);

        checkFields((short) 2, 3L, BIGINT, 6L);
        checkError(Short.MAX_VALUE, Long.MAX_VALUE, DATA_EXCEPTION, overflowError());

        checkFields((short) 2, new BigInteger("3"), DECIMAL, decimal("6"));
        checkFields((short) 2, decimal("3.3"), DECIMAL, decimal("6.6"));
        checkFields((short) 2, 3f, REAL, 6f);
        checkFields((short) 2, 3d, DOUBLE, 6d);
    ...
    public void testInteger() {
        ...
        // Columns
        checkFields(2, (byte) 3, BIGINT, 6L);
        checkFields(Integer.MAX_VALUE, Byte.MAX_VALUE, BIGINT, (long) Integer.MAX_VALUE * Byte.MAX_VALUE);

        checkFields(2, (short) 3, BIGINT, 6L);
        checkFields(Integer.MAX_VALUE, Short.MAX_VALUE, BIGINT, (long) Integer.MAX_VALUE * Short.MAX_VALUE);

        checkFields(2, 3, BIGINT, 6L);
        checkFields(Integer.MAX_VALUE, Integer.MAX_VALUE, BIGINT, (long) Integer.MAX_VALUE * Integer.MAX_VALUE);

        checkFields(2, 3L, BIGINT, 6L);
        checkError(Integer.MAX_VALUE, Long.MAX_VALUE, DATA_EXCEPTION, overflowError());

        checkFields(2, new BigInteger("3"), DECIMAL, decimal("6"));
        checkFields(2, decimal("3.3"), DECIMAL, decimal("6.6"));
        checkFields(2, 3f, REAL, 6f);
        checkFields(2, 3d, DOUBLE, 6d);
    ...
    public void testBigint() {
        ...
        // Columns
        checkFields(2L, (byte) 3, BIGINT, 6L);
        checkError(Long.MAX_VALUE, Byte.MAX_VALUE, DATA_EXCEPTION, overflowError());

        checkFields(2L, (short) 3, BIGINT, 6L);
        checkError(Long.MAX_VALUE, Short.MAX_VALUE, DATA_EXCEPTION, overflowError());

        checkFields(2L, 3, BIGINT, 6L);
        checkError(Long.MAX_VALUE, Integer.MAX_VALUE, DATA_EXCEPTION, overflowError());

        checkFields(2L, 3L, BIGINT, 6L);
        checkError(Long.MAX_VALUE, Long.MAX_VALUE, DATA_EXCEPTION, overflowError());

        checkFields(2L, new BigInteger("3"), DECIMAL, decimal("6"));
        checkFields(2L, decimal("3.3"), DECIMAL, decimal("6.6"));
        checkFields(2L, 3f, REAL, 6f);
        checkFields(2L, 3d, DOUBLE, 6d);
    ...
    public void testDecimal_BigInteger() {
        ...
        // Columns
        checkFields(new BigInteger("2"), (byte) 3, DECIMAL, decimal(6));
        checkFields(new BigInteger("2"), (short) 3, DECIMAL, decimal(6));
        checkFields(new BigInteger("2"), 3, DECIMAL, decimal(6));
        checkFields(new BigInteger("2"), 3L, DECIMAL, decimal(6));
        checkFields(new BigInteger("2"), new BigInteger("3"), DECIMAL, decimal(6));
        checkFields(new BigInteger("2"), decimal("3.3"), DECIMAL, decimal("6.6"));
        checkFields(new BigInteger("2"), 3f, REAL, 6f);
        checkFields(new BigInteger("2"), 3d, DOUBLE, 6d);
    ...
    public void testDecimal_BigDecimal() {
        ...
        // Columns
        checkFields(new BigDecimal("2"), (byte) 3, DECIMAL, decimal(6));
        checkFields(new BigDecimal("2"), (short) 3, DECIMAL, decimal(6));
        checkFields(new BigDecimal("2"), 3, DECIMAL, decimal(6));
        checkFields(new BigDecimal("2"), 3L, DECIMAL, decimal(6));
        checkFields(new BigDecimal("2"), new BigInteger("3"), DECIMAL, decimal(6));
        checkFields(new BigDecimal("2"), decimal("3.3"), DECIMAL, decimal("6.6"));
        checkFields(new BigDecimal("2"), 3f, REAL, 6f);
        checkFields(new BigDecimal("2"), 3d, DOUBLE, 6d);
    ...
    public void testReal() {
        ...
        checkFields(2f, 3f, REAL, 6f);
        checkFields(2f, 3d, DOUBLE, 6d);
