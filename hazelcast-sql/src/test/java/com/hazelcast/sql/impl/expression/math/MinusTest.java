...
public class MinusTest extends ExpressionTestBase {
    ...
    public void testEndToEnd() {
        ...
        assertRows(query(sql, "select __key from records where int1 - 1010 < 0"), keyRange(0, 10, 5000, 6000));
        assertRows(query(sql, "select __key, double1 - 2.1 from records where __key < 1000"), keyRange(0, 1000),
                k -> (k + 2000.1) - 2.1);
        assertQueryThrows(sql, "select ? - int1 from records", "bigint overflow", Long.MIN_VALUE);
    }
