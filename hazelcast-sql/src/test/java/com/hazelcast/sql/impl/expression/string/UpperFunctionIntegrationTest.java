...
public class UpperFunctionIntegrationTest extends SqlExpressionIntegrationTestSupport {
    ...
    public void test_column() {
        ...
        checkColumn(new ExpressionValue.LocalDateVal().field1(LOCAL_DATE), LOCAL_DATE.toString());
        checkColumn(new ExpressionValue.LocalTimeVal().field1(LOCAL_TIME), LOCAL_TIME.toString());
        checkColumn(new ExpressionValue.LocalDateTimeVal().field1(LOCAL_DATE_TIME), LOCAL_DATE_TIME.toString());
        checkColumn(new ExpressionValue.OffsetDateTimeVal().field1(OFFSET_DATE_TIME), OFFSET_DATE_TIME.toString());
