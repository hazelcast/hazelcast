...
public class FloorFunctionIntegrationTest extends ExpressionTestSupport {
    @Test
    public void testColumn() {
        ...
        checkColumnFailure(OBJECT_VAL, SqlErrorCode.PARSING, "Cannot apply [OBJECT] to the 'FLOOR' function (consider adding an explicit CAST)");
    }
    ...
    public void testParameter() {
        ...
        checkFailure("?", SqlErrorCode.DATA_EXCEPTION, "Cannot implicitly convert parameter at position 0 from OBJECT to DECIMAL", OBJECT_VAL);
    }
