...
public class CeilFunctionIntegrationTest extends SqlExpressionIntegrationTestSupport {
    ...
    public void testColumn() {
        ...
        checkColumnFailure(true, SqlErrorCode.PARSING, "No function matches 'CEIL(<BOOLEAN>)' name and argument types (you might need to an explicit CAST)");
    ...
    public void testLiteral() {
        ...
        checkFailure("true", SqlErrorCode.PARSING, "No function matches 'CEIL(<BOOLEAN>)' name and argument types (you might need to an explicit CAST)");
    }
