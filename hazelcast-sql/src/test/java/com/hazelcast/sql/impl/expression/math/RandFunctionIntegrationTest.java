...
public class RandFunctionIntegrationTest extends SqlExpressionIntegrationTestSupport {
    ...
    public void testColumn() {
        ...
        checkColumnFailure(OFFSET_DATE_TIME_VAL, SqlErrorCode.PARSING, "No function matches 'RAND(<TIMESTAMP_WITH_TIME_ZONE>)' name and argument types (you might need to an explicit CAST)");
        checkColumnFailure(new ExpressionValue.ObjectVal(), SqlErrorCode.PARSING, "No function matches 'RAND(<OBJECT>)' name and argument types (you might need to an explicit CAST)");
    }
