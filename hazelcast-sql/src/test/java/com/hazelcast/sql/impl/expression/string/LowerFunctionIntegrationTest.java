...
public class LowerFunctionIntegrationTest extends SqlExpressionIntegrationTestSupport {
    ...
    public void test_column() {
        ...
        checkColumn(new ExpressionValue.LocalDateTimeVal().field1(LOCAL_DATE_TIME), LOCAL_DATE_TIME.toString().toLowerCase());
        checkColumn(new ExpressionValue.OffsetDateTimeVal().field1(OFFSET_DATE_TIME), OFFSET_DATE_TIME.toString().toLowerCase());
