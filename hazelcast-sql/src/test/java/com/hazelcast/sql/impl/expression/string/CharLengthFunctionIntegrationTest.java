...
public class CharLengthFunctionIntegrationTest extends SqlExpressionIntegrationTestSupport {
    ...
    public void test_column() {
        ...
        checkColumn(new ExpressionValue.LocalDateVal().field1(LOCAL_DATE), LOCAL_DATE.toString().length());
        checkColumn(new ExpressionValue.LocalTimeVal().field1(LOCAL_TIME), LOCAL_TIME.toString().length());
        checkColumn(new ExpressionValue.LocalDateTimeVal().field1(LOCAL_DATE_TIME), LOCAL_DATE_TIME.toString().length());
        checkColumn(new ExpressionValue.OffsetDateTimeVal().field1(OFFSET_DATE_TIME), OFFSET_DATE_TIME.toString().length());
