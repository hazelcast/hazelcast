...
public class AndOrPredicateIntegrationTest extends ExpressionTestSupport {
    ...
    public void testArg2() {
        // Column/column
        putCheckCommute(value2(true, true), "field1", "field2", result(true, true));
        putCheckCommute(value2(true, false), "field1", "field2", result(true, false));
        putCheckCommute(value2(true, null), "field1", "field2", result(true, null));
        putCheckCommute(value2(false, false), "field1", "field2", result(false, false));
        putCheckCommute(value2(false, null), "field1", "field2", result(false, null));
        putCheckCommute(value2(null, null), "field1", "field2", result(null, null));
        ...
        // Column/literal
        putCheckCommute(value1(true), "field1", "true", result(true, true));
        putCheckCommute(value1(true), "field1", "false", result(true, false));
        putCheckCommute(value1(true), "field1", "null", result(true, null));
        putCheckCommute(value1(false), "field1", "true", result(false, true));
        putCheckCommute(value1(false), "field1", "false", result(false, false));
        putCheckCommute(value1(false), "field1", "null", result(false, null));
        putCheckCommute(value1(null), "field1", "true", result(null, true));
        putCheckCommute(value1(null), "field1", "false", result(null, false));
        putCheckCommute(value1(null), "field1", "null", result(null, null));
        putCheckFailureSignatureCommute(value1(true), "field1", "'true'", SqlColumnType.BOOLEAN, SqlColumnType.VARCHAR);
        putCheckFailureSignatureCommute(value1(true), "field1", "1", SqlColumnType.BOOLEAN, SqlColumnType.TINYINT);
        putCheckFailureSignatureCommute(value1(true), "field1", "1.1", SqlColumnType.BOOLEAN, SqlColumnType.DECIMAL);
        putCheckFailureSignatureCommute(value1(true), "field1", "1.1E1", SqlColumnType.BOOLEAN, SqlColumnType.DOUBLE);
        ...
        putCheckCommute(value1(true), "field1", "?", result(true, false), false);
        putCheckCommute(value1(true), "field1", "?", result(true, null), (Boolean) null);
        putCheckCommute(value1(false), "field1", "?", result(false, true), true);
        putCheckCommute(value1(false), "field1", "?", result(false, false), false);
        putCheckCommute(value1(false), "field1", "?", result(false, null), (Boolean) null);
        putCheckCommute(value1(null), "field1", "?", result(null, true), true);
        putCheckCommute(value1(null), "field1", "?", result(null, false), false);
        putCheckCommute(value1(null), "field1", "?", result(null, null), (Boolean) null);
        putCheckFailureParameterCommute(value1(true), "field1", "?", 0, SqlColumnType.VARCHAR, "1");
        putCheckFailureParameterCommute(value1(true), "field1", "?", 0, SqlColumnType.TINYINT, (byte) 1);
        putCheckFailureParameterCommute(value1(true), "field1", "?", 0, SqlColumnType.SMALLINT, (short) 1);
        putCheckFailureParameterCommute(value1(true), "field1", "?", 0, SqlColumnType.INTEGER, 1);
        putCheckFailureParameterCommute(value1(true), "field1", "?", 0, SqlColumnType.BIGINT, 1L);
        putCheckFailureParameterCommute(value1(true), "field1", "?", 0, SqlColumnType.DECIMAL, BigInteger.ONE);
        putCheckFailureParameterCommute(value1(true), "field1", "?", 0, SqlColumnType.DECIMAL, BigDecimal.ONE);
        putCheckFailureParameterCommute(value1(true), "field1", "?", 0, SqlColumnType.REAL, 1f);
        putCheckFailureParameterCommute(value1(true), "field1", "?", 0, SqlColumnType.DOUBLE, 1d);
        putCheckFailureParameterCommute(value1(true), "field1", "?", 0, SqlColumnType.DATE, LOCAL_DATE_VAL);
