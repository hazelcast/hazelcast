...
public abstract class AllDistributedObjectsAreIncludedTestBase {

    private static final Logger LOGGER = LoggerFactory.getLogger(AllDistributedObjectsAreIncludedTestBase.class);
