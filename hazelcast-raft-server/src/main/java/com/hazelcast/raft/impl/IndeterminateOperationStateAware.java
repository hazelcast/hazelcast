...
/**
 * When a {@link RaftOp} is replicated to the leader of a Raft group, but the leader fails before it sends any response,
 * the caller has no idea about the status of its operation. The possible cases are:
