...
- [SELECT and WHERE
expressions](https://docs.hazelcast.org/docs/4.1.1/manual/html-single/index.html#expressions)
...
```groovy
compile 'com.hazelcast.jet:hazelcast-jet-sql:4.4'
```
...
on SQL](https://docs.hazelcast.org/docs/4.1.1/manual/html-single/index.html#sql)
