...
* hazelcast-jet-cdc-postgres-4.4.jar
...
dependencies {
    ...
    implementation 'com.hazelcast.jet:hazelcast-jet-cdc-debezium:4.4'
    implementation 'com.hazelcast.jet:hazelcast-jet-cdc-postgres:4.4'
