...
```bash
wget https://download.hazelcast.com/hazelcast-jet-management-center/hazelcast-jet-management-center-4.4.tar.gz
tar zxvf hazelcast-jet-management-center-4.4.tar.gz
```
