...
[Hazelcast IMDG documentation on Blue-Green Deployment](https://docs.hazelcast.org/docs/4.1.1/manual/html-single/index.html#blue-green-deployment-and-disaster-recovery).
