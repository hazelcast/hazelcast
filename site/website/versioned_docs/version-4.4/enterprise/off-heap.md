...
_native_ or _off-heap_ memory using the [High-Density Memory](https://docs.hazelcast.org/docs/4.1.1/manual/html-single/index.html#using-high-density-memory-store-with-map)
...
For additional configuration options, see [configuring high-density memory](https://docs.hazelcast.org/docs/4.1.1/manual/html-single/index.html#configuring-high-density-memory-store)
...
Please refer to the [configuring persistent memory](https://docs.hazelcast.org/docs/4.1.1/manual/html-single/index.html#using-persistent-memory)
