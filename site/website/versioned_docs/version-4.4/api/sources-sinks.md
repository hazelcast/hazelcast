...
```groovy
compile 'com.hazelcast.jet:hazelcast-jet-avro:4.4'
```
...
```groovy
compile 'com.hazelcast.jet:hazelcast-jet-hadoop-all:4.4'
```
...
```groovy
compile 'com.hazelcast.jet:hazelcast-jet-hadoop:4.4'
```
...
```groovy
compile 'com.hazelcast.jet:hazelcast-jet-s3:4.4'
```
...
```groovy
compile 'com.hazelcast.jet:hazelcast-jet-kinesis:4.4'
```
...
As of Jet version 4.4 we have following types of CDC sources:

* [DebeziumCdcSources](/javadoc/4.4/com/hazelcast/jet/cdc/DebeziumCdcSources.html):
  generic source for all databases supported by Debezium
* [MySqlCdcSources](/javadoc/4.4/com/hazelcast/jet/cdc/mysql/MySqlCdcSources.html):
...
* [PostgresCdcSources](/javadoc/4.4/com/hazelcast/jet/cdc/postgres/PostgresCdcSources.html):
...
```groovy
compile 'com.hazelcast.jet:hazelcast-jet-elasticsearch-7:4.4'
```
...
[SourceBuilder](/javadoc/4.4/com/hazelcast/jet/pipeline/SourceBuilder.html)
and
[SinkBuilder](/javadoc/4.4/com/hazelcast/jet/pipeline/SinkBuilder.html).
