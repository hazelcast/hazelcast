...
id: version-4.4-stateful-transforms
...
[AggregateOperations](/javadoc/4.4/com/hazelcast/jet/aggregate/AggregateOperations.html)
class. You can also implement your own aggregate operations using the
builder in
[AggregateOperation](/javadoc/4.4/com/hazelcast/jet/aggregate/AggregateOperation.html)
.
