...
id: version-4.4-data-structures
...
[JCache](https://docs.hazelcast.org/docs/4.1.1/manual/html-single/index.html#jcache-overview)
...
[CP subsystem](https://docs.hazelcast.org/docs/4.1.1/manual/html-single/index.html#cp-subsystem)
