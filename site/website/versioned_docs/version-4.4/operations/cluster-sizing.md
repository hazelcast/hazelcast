...
The [Event
Journal](https://docs.hazelcast.org/docs/4.1.1/manual/html-single/index.html#event-journal)
...
detector](https://docs.hazelcast.org/docs/4.1.1/manual/html-single/index.html#failure-detector-configuration)
