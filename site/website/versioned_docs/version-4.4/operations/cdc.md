...
source](/javadoc/4.4/com/hazelcast/jet/cdc/DebeziumCdcSources.html).
...
For details see the
[javadoc](/javadoc/4.4/com/hazelcast/jet/cdc/mysql/MySqlCdcSources.html).
...
boolean flag specifying if state should be reset on reconnects or not.
For details see the
[javadoc](/javadoc/4.4/com/hazelcast/jet/cdc/postgres/PostgresCdcSources.html).
