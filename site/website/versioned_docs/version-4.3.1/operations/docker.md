...
```text
2020-05-18 19:34:43,872 [ INFO] [main] [c.h.system]: Hazelcast Jet 4.3.1 (20200429 - e6c60a1) starting at [172.17.0.2]:5701
```
...
[here](https://github.com/hazelcast/hazelcast-jet/releases/download/v4.3.1/hazelcast-jet-4.3.1.tar.gz)
...
Step 1/4 : FROM hazelcast/hazelcast-jet:4.3.1
 ---> c126c24c3d0b
