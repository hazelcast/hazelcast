...
dependencies {
    ...
    compile 'com.hazelcast.jet.examples:hazelcast-jet-examples-trade-source:4.3'
}
...
shadowJar {
    dependencies {
        exclude(dependency('com.hazelcast.jet:hazelcast-jet:4.3'))
    }
}
```
