...
id: version-4.3-management-center
...
```bash
wget https://download.hazelcast.com/hazelcast-jet-management-center/hazelcast-jet-management-center-4.3.tar.gz
tar zxvf hazelcast-jet-management-center-4.3.tar.gz
```
