...
[Hazelcast {imdg-minor-version} Reference Manual](https://docs.hazelcast.org/docs/{imdg-minor-version}/manual/html-single/index.html#integrating-openssl-boringssl).
