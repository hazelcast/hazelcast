...
public class UnaryMinusFunctionTest extends SqlTestSupport {
    ...
    public void testEquality() {
        ...
        checkEquals(UnaryMinusFunction.create(ConstantExpression.create(1, INT), INT),
                UnaryMinusFunction.create(ConstantExpression.create(1, INT), BIGINT), false);

        checkEquals(UnaryMinusFunction.create(ConstantExpression.create(1, INT), INT),
                UnaryMinusFunction.create(ConstantExpression.create(2, INT), BIGINT), false);
    }
