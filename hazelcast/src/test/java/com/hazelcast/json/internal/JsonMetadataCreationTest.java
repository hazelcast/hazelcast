...
import com.hazelcast.map.impl.recordstore.AbstractMetadataStore;
...
public class JsonMetadataCreationTest extends HazelcastTestSupport {
    ...
    protected AbstractMetadata getMetadata(String mapName, Object key, int replicaIndex) {
        ...
        AbstractMetadataStore metadataStore = recordStore.getMetadataStore();
    ...
    private void assertMetadataCreated(String mapName, int replicaCount) {
        for (int i = 0; i < replicaCount; i++) {
            ...
            for (int j = 0; j < ENTRY_COUNT; j++) {
                ...
                AbstractMetadata metadata = getMetadata(mapName, jsonValue, i);
    ...
    private void assertMetadata(String msg, AbstractMetadata metadata) {
