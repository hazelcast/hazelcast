...
public class LocalMemoryStatsImplTest {
    ...
    public void testDefaultConstructor() {
        ...
        assertEquals(1024, localMemoryStats.getMaxMemory());
        assertEquals(768, localMemoryStats.getCommittedMemory());
        assertEquals(512, localMemoryStats.getUsedMemory());
        assertEquals(256, localMemoryStats.getFreeMemory());
    ...
    public void testSerialization() {
        ...
        assertEquals(1024, deserialized.getMaxMemory());
        assertEquals(768, deserialized.getCommittedMemory());
        assertEquals(512, deserialized.getUsedMemory());
        assertEquals(256, deserialized.getFreeMemory());
