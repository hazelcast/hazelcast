...
public class AddListenerWithNullParameterTests extends HazelcastTestSupport {
    ...
    public void testMapAddEntryListenerPredicate() {
        instance.getMap("test").addEntryListener(null, mock(Predicate.class), true);
    }
    ...
    public void testMapAddEntryListenerPredicateAndKey() {
        instance.getMap("test").addEntryListener(null, mock(Predicate.class), "key", true);
    }
    ...
    public void testReplicatedMapAddEntryListenerPredicate() {
        instance.getReplicatedMap("test").addEntryListener(null, mock(Predicate.class));
    }
    ...
    public void testReplicatedMapAddEntryListenerPredicateAndKey() {
        instance.getReplicatedMap("test").addEntryListener(null, mock(Predicate.class), "key");
    }
