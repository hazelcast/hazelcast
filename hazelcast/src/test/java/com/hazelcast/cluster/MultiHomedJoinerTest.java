...
public class MultiHomedJoinerTest extends HazelcastTestSupport {
    ...
    Config getConfig(String hostname) {
        ...
        networkConfig.setMemberAddressProviderConfig(new MemberAddressProviderConfig().setEnabled(true).setImplementation(new MemberAddressProviderImpl()));
    ...
    private static class MemberAddressProviderImpl implements MemberAddressProvider {
        ...
        public InetSocketAddress getPublicAddress() {
            return new InetSocketAddress(networks.get(0), 0);
        }
