...
import com.hazelcast.test.starter.FirewallingConnectionManagerConstructor;
...
public class FirewallingConnectionManagerConstructorTest {
    ...
    @Test
    public void firewallingConnectionManagerCloneTest() throws Exception {
        ...
        FirewallingConnectionManager clonedConnectionManager = (FirewallingConnectionManager) constructor.createNew(connectionManager);
