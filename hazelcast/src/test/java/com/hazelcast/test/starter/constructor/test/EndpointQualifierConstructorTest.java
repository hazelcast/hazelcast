...
public class EndpointQualifierConstructorTest {
    ...
    @Before
    public void setup() {
        constructor = new EndpointQualifierConstructor(EndpointQualifier.class);
    }
    ...
    private void assertCloneEquals(EndpointQualifier source) {
        System.out.println(source);
        Object cloned = constructor.createNew(source);
