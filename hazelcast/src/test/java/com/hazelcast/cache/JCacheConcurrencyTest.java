...
public class JCacheConcurrencyTest
    ...
    @Test
    public void test_concurrect_cachemanager_creation()
            throws Exception {
        final URI uri = new URI(randomString());
        final Properties properties = HazelcastCachingProvider.propertiesByInstanceName(hz1.getName());
            ...
            new Thread(new Runnable() {
                ...
                public void run() {
                    try {
                        ...
                        CacheManager cacheManager = cachingProvider1.getCacheManager(uri, null, properties);
    ...
    @Test
    public void test_concurrent_cachestatistics_creation()
            throws Exception {
