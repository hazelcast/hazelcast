...
import static com.hazelcast.query.impl.extractor.specification.PortableDataStructure.CarPortable;
import static com.hazelcast.query.impl.extractor.specification.PortableDataStructure.CarPortableFactory;
import static com.hazelcast.query.impl.extractor.specification.PortableDataStructure.EnginePortable;
import static com.hazelcast.query.impl.extractor.specification.PortableDataStructure.WheelPortable.w;
    ...
    protected Configurator getInstanceConfigurator() {
        return new Configurator() {
            ...
            public void doWithConfig(Config config, Multivalue mv) {
                config.getSerializationConfig().addPortableFactory(CarPortableFactory.ID, new CarPortableFactory());
            }
        };
    }
