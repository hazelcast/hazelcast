...
public class PagingPredicateOptimizationTest extends HazelcastTestSupport {
    ...
    public void testInnerPredicateOptimization() {
        ...
        PagingPredicate<Object, Object> pagingPredicate = new PagingPredicate<Object, Object>(innerPredicate, 10);

        Predicate optimized = optimizer.optimize(pagingPredicate, indexes);
        assertInstanceOf(PagingPredicate.class, optimized);
        Predicate innerOptimized = ((PagingPredicate) optimized).getPredicate();
