...
public abstract class AbstractMapIteratorTest extends HazelcastTestSupport {
    ...
    protected abstract <K, V> Iterator<Map.Entry<K, V>> getIterator(IMap<K, V> map);
    ...
    public void test_DoesNotReturn_DuplicateEntry_When_Migration_Happens() {
        ...
        Iterator<Map.Entry<String, String>> iteratorP1 = getIterator(map);
        Iterator<Map.Entry<String, String>> iteratorP2 = getIterator(map);
