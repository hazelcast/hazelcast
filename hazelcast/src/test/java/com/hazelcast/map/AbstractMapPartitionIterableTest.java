...
public abstract class AbstractMapPartitionIterableTest extends HazelcastTestSupport {
    ...
    public void test_DoesNotReturn_DuplicateEntry_When_Migration_Happens() {
        ...
        Iterator<Map.Entry<String, String>> iteratorP1 = getIterable(map, 0).iterator();
        Iterator<Map.Entry<String, String>> iteratorP2 = getIterable(map, 1).iterator();
