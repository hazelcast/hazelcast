...
public class MapStoreTest {
    ...
    public void testOneMemberWriteThroughWithLRU() throws Exception {
        ...
        mapConfig.getMaxSizeConfig().setSize(10);
        HazelcastInstance h1 = Hazelcast.newHazelcastInstance(config);
        IMap map = h1.getMap("default");
        for (int i = 0; i < 20; i++) {
    ...
    public void testIssue188LoadAllIgnoresMaxSize() {
        ...
        config.getMapConfig("map").setMaxSizeConfig(new MaxSizeConfig()
                .setSize(maxSize).setMaxSizePolicy(MaxSizeConfig.MaxSizePolicy.PER_JVM));
