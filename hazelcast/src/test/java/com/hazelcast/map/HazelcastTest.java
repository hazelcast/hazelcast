...
//    }
    ...
    public void testGetCluster() {
        ...
        assertEquals(instanceCount, members.size());
    }

//    @Test
//    public void testProxySerialization() {
//        IMap mapProxy = getInstance().getMap("proxySerialization");
//        ILock mapLock = getInstance().getLock(mapProxy);
//        assertNotNull(mapLock);
//    }

    @Test
    public void testMapGetName() {
        IMap<String, String> map = getInstance().getMap("testMapGetName");
        assertEquals("testMapGetName", map.getName());
    }

    @Test
    public void testMapValuesSize() {
        Map<String, String> map = getInstance().getMap("testMapValuesSize");
        map.put("Hello", "World");
    ...
    public void testIssue304() {
        IMap<String, String> map = getInstance().getMap("testIssue304");
        map.lock("1");
    ...
    public void testLockKey() {
        IMap<String, String> map = getInstance().getMap("testLockKey");
        map.lock("Hello");
        try {
    ...
    public void testMapReplaceIfSame() {
        IMap<String, String> map = getInstance().getMap("testMapReplaceIfSame");
...
//        IMap<String, String> map = getInstance().getMap("testMapClearQuick");
//        String value = map.put("Hello", "World");
//        assertEquals(null, value);
//        map.clear();
//        assertEquals(0, map.size());
...
//
    ...
    public void testMapPutAll() {
        IMap<String, String> map = getInstance().getMap("testMapPutAll");
    ...
    public void testMapEntrySet() {
        IMap<String, String> map = getInstance().getMap("testMapEntrySet");
        map.put("Hello", "World");
...
//        MultiMap<String, String> map = getInstance().getMultiMap("testMultiMapEntryListener");
...
//
    ...
    public void testMapEvictAndListener() throws InterruptedException {
        ...
        map.addEntryListener(new EntryListener<String, String>() {
            ...
            public void entryEvicted(EntryEvent<String, String> event) {
                System.out.println("event eviction value:" + event.getValue());
        ...
        System.out.println("nlist:"+newList.get(0));
    ...
    public void testMapPutWithTTL() throws Exception {
        IMap<Integer, String> map = getInstance().getMap("testMapPutWithTTL");
...
//        IList<String> list = getInstance().getList("testListAdd");
...
//        IList<String> list = getInstance().getList("testListContains");
//        list.add("Hello World");
...
//        IList<String> list = getInstance().getList("testListIterator");
//        list.add("Hello World");
//        assertEquals("Hello World", list.iterator().next());
//    }
//
...
//        IList<String> list = getInstance().getList("testListIsEmpty");
...
//        IList<String> list = getInstance().getList("testListListener");
...
//        final CountDownLatch latch = new CountDownLatch(2);
//        ISet<String> set = getInstance().getSet("testSetListener");
...
//        IQueue<String> queue = getInstance().getQueue("testQueueItemListener");
...
//        ISet<String> set = getInstance().getSet("testSetAdd");
...
//        ISet<String> set = getInstance().getSet("testSetIterator");
//        boolean added = set.add("HelloWorld");
//        assertTrue(added);
...
//        ISet<String> set = getInstance().getSet("testSetContains");
//        boolean added = set.add("HelloWorld");
//        assertTrue(added);
...
//        ISet<String> set = getInstance().getSet("testSetClear");
//        boolean added = set.add("HelloWorld");
//        assertTrue(added);
//        set.clear();
...
//        ISet<String> set = getInstance().getSet("testSetRemove");
...
//        ISet<String> set = getInstance().getSet("testSetGetName");
//        assertEquals("testSetGetName", set.getName());
//    }
//
//    @Test
//    public void testSetAddAll() {
//        ISet<String> set = getInstance().getSet("testSetAddAll");
...
//        ITopic<String> topic = getInstance().getTopic("testTopicGetName");
//        assertEquals("testTopicGetName", topic.getName());
//    }
//
//    @Test
//    public void testTopicPublish() {
//        ITopic<String> topic = getInstance().getTopic("testTopicPublish");
...
//        IQueue<String> queue = getInstance().getQueue("testQueueAdd");
...
//        IQueue<String> queue = getInstance().getQueue("testQueueTake");
...
//        IQueue<String> queue = getInstance().getQueue("testQueueAddAll");
//        String[] items = new String[]{"one", "two", "three", "four"};
...
//        IQueue<String> queue = getInstance().getQueue("testQueueContains");
//        String[] items = new String[]{"one", "two", "three", "four"};
//        queue.addAll(Arrays.asList(items));
...
//        IQueue<String> queue = getInstance().getQueue("testQueueContainsAll");
//        String[] items = new String[]{"one", "two", "three", "four"};
...
//        IQueue<String> q = getInstance().getQueue("testQueueRemove");
//        for (int i = 0; i < 10; i++) {
//            q.offer("item" + i);
//        }
//        for (int i = 0; i < 5; i++) {
...
//        MultiMap<String, String> map = getInstance().getMultiMap("testMultiMapPutAndGet");
//        map.put("Hello", "World");
...
//        MultiMap mm = getInstance().getMultiMap("testMultiMapPutGetRemove");
//        mm.put("1", "C");
//        mm.put("2", "x");
//        mm.put("2", "y");
//        mm.put("1", "A");
...
//        MultiMap<String, String> map = getInstance().getMultiMap("testMultiMapGetNameAndType");
...
//        MultiMap<String, String> map = getInstance().getMultiMap("testMultiMapClear");
//        map.put("Hello", "World");
//        assertEquals(1, map.size());
//        map.clear();
//        assertEquals(0, map.size());
...
//        MultiMap<String, String> map = getInstance().getMultiMap("testMultiMapContainsKey");
//        map.put("Hello", "World");
//        assertTrue(map.containsKey("Hello"));
//    }
//
...
//        MultiMap<String, String> map = getInstance().getMultiMap("testMultiMapContainsValue");
//        map.put("Hello", "World");
//        assertTrue(map.containsValue("World"));
//    }
//
...
//        MultiMap<String, String> map = getInstance().getMultiMap("testMultiMapContainsEntry");
//        map.put("Hello", "World");
...
//        MultiMap map = getInstance().getMultiMap("testMultiMapWithCustomSerializable");
...
//        IMap<String, ComplexValue> map = getInstance().getMap("testContains");
//        MultiMap<String, ComplexValue> multiMap = getInstance().getMultiMap("testContains");
...
//        getInstance().getConfig().addMultiMapConfig(multiMapConfigList);
//        MultiMap<String, ComplexValue> mmList = getInstance().getMultiMap("testContains.list");
...
//        MultiMap<String, String> map = getInstance().getMultiMap("testMultiMapKeySet");
//        map.put("Hello", "World");
//        map.put("Hello", "Europe");
//        map.put("Hello", "America");
//        map.put("Hello", "Asia");
...
//        MultiMap<String, String> map = getInstance().getMultiMap("testMultiMapValues");
//        map.put("Hello", "World");
//        map.put("Hello", "Europe");
//        map.put("Hello", "America");
//        map.put("Hello", "Asia");
...
//        MultiMap<String, String> map = getInstance().getMultiMap("testMultiMapRemove");
//        map.put("Hello", "World");
//        map.put("Hello", "Europe");
//        map.put("Hello", "America");
//        map.put("Hello", "Asia");
...
//        MultiMap<String, String> map = getInstance().getMultiMap("testMultiMapRemoveEntries");
//        map.put("Hello", "World");
//        map.put("Hello", "Europe");
//        map.put("Hello", "America");
//        map.put("Hello", "Asia");
...
//        MultiMap<String, String> map = getInstance().getMultiMap("testMultiMapEntrySet");
//        map.put("Hello", "World");
//        map.put("Hello", "Europe");
//        map.put("Hello", "America");
//        map.put("Hello", "Asia");
...
//        MultiMap<Integer, String> map = getInstance().getMultiMap("testMultiMapValueCount");
//        map.put(1, "World");
//        map.put(2, "Africa");
//        map.put(1, "America");
//        map.put(2, "Antartica");
...
//        IdGenerator id = getInstance().getIdGenerator("testIdGenerator");
...
//        ILock lock = getInstance().getLock("testLock");
...
//        final IQueue<String> q = getInstance().getQueue("testInterruption");
//        final CountDownLatch latch = new CountDownLatch(1);
...
//        final IMap map = getInstance().getMap("testMapGetAfterPutWhenCacheValueEnabled");
...
//        final IMap map = getInstance().getMap("testPutAndUnlockWhenOwnerOfLockIsDifferent");
