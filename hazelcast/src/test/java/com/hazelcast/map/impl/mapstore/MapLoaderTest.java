...
public class MapLoaderTest extends HazelcastTestSupport {
    ...
    @Test
    public void testNullValueInLoader_withInterceptor() {
        ...
        IMap<String, String> map = instance2.getMap(name);
    ...
    @Test
    public void testNullInLoadAllKeys_onGet_eager() throws InterruptedException {
        String name = "testNullIn_loadAllKeys";
        ...
        expectedException.expect(NullPointerException.class);
        expectedException.expectMessage(CoreMatchers.is("loadAllKeys is not allowed to return nulls inside"));
        map.get("1");
    }

    @Test
    public void testNullInLoadAllKeys_onLoadAll_lazy() throws InterruptedException {
        String name = "testNullIn_loadAllKeys";
    ...
    @Test
    public void testNullKeyInLoadAll_onGet_lazy() throws InterruptedException {
        String name = "testNullIn_loadAllKeys";
        ...
        expectedException.expect(NullPointerException.class);
        expectedException.expectMessage(CoreMatchers.is("key is not allowed to be null, was null loaded by MapLoader"));
        map.get("1");
    }

    @Test
    public void testNullValueInLoadAll_onGet_lazy() throws InterruptedException {
        String name = "testNullIn_loadAllKeys";
        ...
        expectedException.expect(NullPointerException.class);
        expectedException.expectMessage(CoreMatchers.is("value is not allowed to be null, was null loaded by MapLoader"));
        map.get("1");
    }

    @Test
    public void testNullKeyInLoadAll_onLoadAll_eager() throws InterruptedException {
        String name = "testNullIn_loadAllKeys";
    ...
    @Test
    public void testNullValueInLoadAll_onLoadAll_eager() throws InterruptedException {
        String name = "testNullIn_loadAllKeys";
