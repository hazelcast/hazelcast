...
public class EventualConsistencyMigration extends HazelcastTestSupport {
    ...
    @Test
    public void migrated_sequences() throws Exception {
        String mapName = "test";
    ...
    @Test
    public void migrated_sequences2() throws Exception {
        String mapName = "test";
        Config config = newConfig(mapName);
    ...
    @Test
    public void migrated_sequencesx() throws Exception {
    ...
    @Test
    public void migrates_uuids1() throws Exception {
        String mapName = "test";
        Config config = newConfig(mapName);
    ...
    @Test
    public void migrates_uuids2() throws Exception {
        String mapName = "test";
        Config config = newConfig(mapName);
