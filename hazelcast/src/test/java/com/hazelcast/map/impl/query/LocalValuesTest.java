...
public class LocalValuesTest extends HazelcastTestSupport {
    ...
    public void whenPartitionPredicate() {
        ...
        assertEquals(0, map.localValues(partitionPredicate).size());
    }

    @Test
    public void testResultType() {
        map.put(localKey1, "a");
        Collection<String> entries = map.localValues(Predicates.alwaysTrue());
