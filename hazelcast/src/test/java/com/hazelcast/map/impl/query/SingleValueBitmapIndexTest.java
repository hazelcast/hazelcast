...
public class SingleValueBitmapIndexTest extends HazelcastTestSupport {
    ...
    public static Collection<Object[]> parameters() {
        ...
        return asList(new Object[][]{
                {new IndexConfig(IndexType.BITMAP, "age")},
                {new IndexConfig(IndexType.BITMAP, "age").setUniqueKey("stringId")},
                {new IndexConfig(IndexType.BITMAP, "age").setUniqueKey("stringId").setUniqueKeyTransform(OBJECT)},
                {new IndexConfig(IndexType.BITMAP, "age").setUniqueKeyTransform(RAW)},
                {new IndexConfig(IndexType.BITMAP, "age").setUniqueKeyTransform(LONG)}
        });
        // @formatter:on
    }
