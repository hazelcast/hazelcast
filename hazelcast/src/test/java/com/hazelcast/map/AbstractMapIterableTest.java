...
public abstract class AbstractMapIterableTest extends HazelcastTestSupport {
    ...
    public void test_next_Throws_Exception_On_EmptyMap() {
        ...
        Iterator<Map.Entry<Object, Object>> iterator = getIterable(map).iterator();
        iterator.next();
    }
    ...
    public void test_remove_withMultiplePartitions() {
        ...
        String key = generateKeyForPartition(instance, 0);
        String value = randomString();
        map.put(key, value);

        String key2 = generateKeyForPartition(instance, 1);
    ...
    public void test_Next_Returns_Value_On_NonEmptyMap() {
        ...
        Iterator<Map.Entry<String, String>> iterator = getIterable(map).iterator();
    ...
    public void test_DoesNotReturn_DuplicateEntry_When_Migration_Happens() {
        ...
        Iterator<Map.Entry<String, String>> iteratorP1 = getIterable(map).iterator();
        Iterator<Map.Entry<String, String>> iteratorP2 = getIterable(map).iterator();
