...
public class SemaphoreSplitBrainProtectionReadTest extends AbstractSplitBrainProtectionTest {
    ...
    @Test
    public void availablePermits_successful_whenSplitBrainProtectionSize_met() {
        semaphore(0).availablePermits();
    }

    @Test(expected = SplitBrainProtectionException.class)
    public void availablePermits_successful_whenSplitBrainProtectionSize_notMet() {
