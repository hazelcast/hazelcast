...
public class CountDownLatchSplitBrainProtectionReadTest extends AbstractSplitBrainProtectionTest {
    ...
    @Test
    public void getCount_splitBrainProtection() {
        latch(0).getCount();
    }

    @Test(expected = SplitBrainProtectionException.class)
    public void getCount_noSplitBrainProtection() {
        latch(3).getCount();
    }

    @Test
    public void await_splitBrainProtection() throws Exception {
        latch(0).await(1, TimeUnit.SECONDS);
    }

    @Test(expected = SplitBrainProtectionException.class)
    public void await_noSplitBrainProtection() throws Exception {
        latch(3).await(1, TimeUnit.SECONDS);
    }
