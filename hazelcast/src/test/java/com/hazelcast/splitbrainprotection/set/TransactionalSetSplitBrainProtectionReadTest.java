...
public class TransactionalSetSplitBrainProtectionReadTest extends AbstractSplitBrainProtectionTest {
    ...
    public void txSize_successful_whenSplitBrainProtectionSize_met() {
        ...
        TransactionalSet<Object> set = transactionContext.getSet(SET_NAME + splitBrainProtectionOn.name());
        set.size();
