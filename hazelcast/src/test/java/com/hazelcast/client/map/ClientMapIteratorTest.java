...
public class ClientMapIteratorTest extends HazelcastTestSupport {
    ...
    public void test_DoesNotReturn_DuplicateEntry_When_Migration_Happens() {
        ...
        ClientMapProxy<String, String> proxy =
                (ClientMapProxy<String, String>) ClientMapIteratorTest.this.client.<String, String>getMap(randomMapName());

        HashSet<String> readKeysP1 = new HashSet<>();
        HashSet<String> readKeysP2 = new HashSet<>();

        String value = "value";
        putValuesToPartition(ClientMapIteratorTest.this.client, proxy, value, 0, 100);
        putValuesToPartition(ClientMapIteratorTest.this.client, proxy, value, 1, 100);
        ...
        // force rehashing
        putValuesToPartition(ClientMapIteratorTest.this.client, proxy, randomString(), 0, 150);
        putValuesToPartition(ClientMapIteratorTest.this.client, proxy, randomString(), 1, 150);
