...
public class CountDownLatchLongAwaitClientTest extends HazelcastRaftTestSupport {
    ...
    public void setup() {
        ...
        groupId = ((CountDownLatchProxy) client.getCPSubsystem().getCountDownLatch(proxyName)).getGroupId();
    }
