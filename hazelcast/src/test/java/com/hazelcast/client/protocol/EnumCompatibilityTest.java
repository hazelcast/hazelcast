...
public class EnumCompatibilityTest {
    ...
    public void testFieldKind() {
        ...
        mappings.put(FieldKind.ARRAY_OF_INT8S, 3);
        mappings.put(FieldKind.CHAR, 4);
        mappings.put(FieldKind.ARRAY_OF_CHARS, 5);
        mappings.put(FieldKind.INT16, 6);
        mappings.put(FieldKind.ARRAY_OF_INT16S, 7);
        mappings.put(FieldKind.INT32, 8);
        mappings.put(FieldKind.ARRAY_OF_INT32S, 9);
        mappings.put(FieldKind.INT64, 10);
        mappings.put(FieldKind.ARRAY_OF_INT64S, 11);
        mappings.put(FieldKind.FLOAT32, 12);
        mappings.put(FieldKind.ARRAY_OF_FLOAT32S, 13);
        mappings.put(FieldKind.FLOAT64, 14);
        mappings.put(FieldKind.ARRAY_OF_FLOAT64S, 15);
        mappings.put(FieldKind.STRING, 16);
        mappings.put(FieldKind.ARRAY_OF_STRINGS, 17);
        mappings.put(FieldKind.DECIMAL, 18);
        mappings.put(FieldKind.ARRAY_OF_DECIMALS, 19);
        mappings.put(FieldKind.TIME, 20);
        mappings.put(FieldKind.ARRAY_OF_TIMES, 21);
        mappings.put(FieldKind.DATE, 22);
        mappings.put(FieldKind.ARRAY_OF_DATES, 23);
        mappings.put(FieldKind.TIMESTAMP, 24);
        mappings.put(FieldKind.ARRAY_OF_TIMESTAMPS, 25);
        mappings.put(FieldKind.TIMESTAMP_WITH_TIMEZONE, 26);
        mappings.put(FieldKind.ARRAY_OF_TIMESTAMP_WITH_TIMEZONES, 27);
        mappings.put(FieldKind.COMPACT, 28);
        mappings.put(FieldKind.ARRAY_OF_COMPACTS, 29);
        mappings.put(FieldKind.PORTABLE, 30);
        mappings.put(FieldKind.ARRAY_OF_PORTABLES, 31);
        mappings.put(FieldKind.NULLABLE_BOOLEAN, 32);
        mappings.put(FieldKind.ARRAY_OF_NULLABLE_BOOLEANS, 33);
        mappings.put(FieldKind.NULLABLE_INT8, 34);
        mappings.put(FieldKind.ARRAY_OF_NULLABLE_INT8S, 35);
        mappings.put(FieldKind.NULLABLE_INT16, 36);
        mappings.put(FieldKind.ARRAY_OF_NULLABLE_INT16S, 37);
        mappings.put(FieldKind.NULLABLE_INT32, 38);
        mappings.put(FieldKind.ARRAY_OF_NULLABLE_INT32S, 39);
        mappings.put(FieldKind.NULLABLE_INT64, 40);
        mappings.put(FieldKind.ARRAY_OF_NULLABLE_INT64S, 41);
        mappings.put(FieldKind.NULLABLE_FLOAT32, 42);
        mappings.put(FieldKind.ARRAY_OF_NULLABLE_FLOAT32S, 43);
        mappings.put(FieldKind.NULLABLE_FLOAT64, 44);
        mappings.put(FieldKind.ARRAY_OF_NULLABLE_FLOAT64S, 45);
