...
public class MemberCompatibilityTest_2_0 {
    ...
    public void test_ClientAuthenticationCodec_encodeResponse() {
        ...
        ClientMessage encoded = ClientAuthenticationCodec.encodeResponse(aByte, anAddress, aUUID, aUUID, aByte, aString, aListOfMembers, anInt, aUUID);
        ClientMessage fromFile = clientMessages.get(fileClientMessageIndex);
    ...
    public void test_ClientAuthenticationCustomCodec_encodeResponse() {
        ...
        ClientMessage encoded = ClientAuthenticationCustomCodec.encodeResponse(aByte, anAddress, aUUID, aUUID, aByte, aString, aListOfMembers, anInt, aUUID);
        ClientMessage fromFile = clientMessages.get(fileClientMessageIndex);
        compareClientMessages(fromFile, encoded);
    }
    ...
    public void test_DynamicConfigAddMapConfigCodec_decodeRequest() {
        ...
        assertTrue(isEqual(aListOfMapIndexConfigs, parameters.mapIndexConfigs));
