...
public class ClientCompatibilityTest_2_0 {
    ...
    public void test_ClientAuthenticationCodec_encodeRequest() {
        ...
        ClientMessage encoded = ClientAuthenticationCodec.encodeRequest(aString, aString, aUUID, aUUID, aBoolean, aString, aByte, aString, aString, aListOfStrings, anInt, aUUID);
    ...
    public void test_ClientAuthenticationCustomCodec_encodeRequest() {
        ...
        ClientMessage encoded = ClientAuthenticationCustomCodec.encodeRequest(aData, aUUID, aUUID, aBoolean, aString, aByte, aString, aString, aListOfStrings, anInt, aUUID);
        ClientMessage fromFile = clientMessages.get(fileClientMessageIndex);
        compareClientMessages(fromFile, encoded);
    }
    ...
    private class ClientAddPartitionLostListenerCodecHandler extends ClientAddPartitionLostListenerCodec.AbstractEventHandler {
        @Override
        public void handlePartitionLostEvent(int partitionId, int lostBackupCount, com.hazelcast.nio.Address source) {
    ...
    private class ClientAddPartitionListenerCodecHandler extends ClientAddPartitionListenerCodec.AbstractEventHandler {
        @Override
        public void handlePartitionsEvent(java.util.Collection<java.util.Map.Entry<com.hazelcast.nio.Address, java.util.List<java.lang.Integer>>> partitions, int partitionStateVersion) {
    ...
    public void test_MapAddIndexCodec_encodeRequest() {
        ...
        ClientMessage encoded = MapAddIndexCodec.encodeRequest(aString, aString, aBoolean);
        ClientMessage fromFile = clientMessages.get(fileClientMessageIndex);
        compareClientMessages(fromFile, encoded);
    }
    ...
    @Test
    public void test_LockIsLockedCodec_encodeRequest() {
        int fileClientMessageIndex = 367;
        ClientMessage encoded = LockIsLockedCodec.encodeRequest(aString);
        ClientMessage fromFile = clientMessages.get(fileClientMessageIndex);
        compareClientMessages(fromFile, encoded);
    }

    @Test
    public void test_LockIsLockedCodec_decodeResponse() {
        int fileClientMessageIndex = 368;
        ClientMessage fromFile = clientMessages.get(fileClientMessageIndex);
        LockIsLockedCodec.ResponseParameters parameters = LockIsLockedCodec.decodeResponse(fromFile);
        assertTrue(isEqual(aBoolean, parameters.response));
    }

    @Test
    public void test_LockIsLockedByCurrentThreadCodec_encodeRequest() {
        int fileClientMessageIndex = 369;
        ClientMessage encoded = LockIsLockedByCurrentThreadCodec.encodeRequest(aString, aLong);
        ClientMessage fromFile = clientMessages.get(fileClientMessageIndex);
        compareClientMessages(fromFile, encoded);
    }

    @Test
    public void test_LockIsLockedByCurrentThreadCodec_decodeResponse() {
        int fileClientMessageIndex = 370;
        ClientMessage fromFile = clientMessages.get(fileClientMessageIndex);
        LockIsLockedByCurrentThreadCodec.ResponseParameters parameters = LockIsLockedByCurrentThreadCodec.decodeResponse(fromFile);
        assertTrue(isEqual(aBoolean, parameters.response));
    }

    @Test
    public void test_LockGetLockCountCodec_encodeRequest() {
        int fileClientMessageIndex = 371;
        ClientMessage encoded = LockGetLockCountCodec.encodeRequest(aString);
        ClientMessage fromFile = clientMessages.get(fileClientMessageIndex);
        compareClientMessages(fromFile, encoded);
    }

    @Test
    public void test_LockGetLockCountCodec_decodeResponse() {
        int fileClientMessageIndex = 372;
        ClientMessage fromFile = clientMessages.get(fileClientMessageIndex);
        LockGetLockCountCodec.ResponseParameters parameters = LockGetLockCountCodec.decodeResponse(fromFile);
        assertTrue(isEqual(anInt, parameters.response));
    }

    @Test
    public void test_LockGetRemainingLeaseTimeCodec_encodeRequest() {
        int fileClientMessageIndex = 373;
        ClientMessage encoded = LockGetRemainingLeaseTimeCodec.encodeRequest(aString);
        ClientMessage fromFile = clientMessages.get(fileClientMessageIndex);
        compareClientMessages(fromFile, encoded);
    }

    @Test
    public void test_LockGetRemainingLeaseTimeCodec_decodeResponse() {
        int fileClientMessageIndex = 374;
        ClientMessage fromFile = clientMessages.get(fileClientMessageIndex);
        LockGetRemainingLeaseTimeCodec.ResponseParameters parameters = LockGetRemainingLeaseTimeCodec.decodeResponse(fromFile);
        assertTrue(isEqual(aLong, parameters.response));
    }

    @Test
    public void test_LockLockCodec_encodeRequest() {
        int fileClientMessageIndex = 375;
        ClientMessage encoded = LockLockCodec.encodeRequest(aString, aLong, aLong, aLong);
        ClientMessage fromFile = clientMessages.get(fileClientMessageIndex);
        compareClientMessages(fromFile, encoded);
    }

    @Test
    public void test_LockLockCodec_decodeResponse() {
        int fileClientMessageIndex = 376;
        ClientMessage fromFile = clientMessages.get(fileClientMessageIndex);
        LockLockCodec.ResponseParameters parameters = LockLockCodec.decodeResponse(fromFile);
    }

    @Test
    public void test_LockUnlockCodec_encodeRequest() {
        int fileClientMessageIndex = 377;
        ClientMessage encoded = LockUnlockCodec.encodeRequest(aString, aLong, aLong);
        ClientMessage fromFile = clientMessages.get(fileClientMessageIndex);
        compareClientMessages(fromFile, encoded);
    }

    @Test
    public void test_LockUnlockCodec_decodeResponse() {
        int fileClientMessageIndex = 378;
        ClientMessage fromFile = clientMessages.get(fileClientMessageIndex);
        LockUnlockCodec.ResponseParameters parameters = LockUnlockCodec.decodeResponse(fromFile);
    }

    @Test
    public void test_LockForceUnlockCodec_encodeRequest() {
        int fileClientMessageIndex = 379;
        ClientMessage encoded = LockForceUnlockCodec.encodeRequest(aString, aLong);
        ClientMessage fromFile = clientMessages.get(fileClientMessageIndex);
        compareClientMessages(fromFile, encoded);
    }

    @Test
    public void test_LockForceUnlockCodec_decodeResponse() {
        int fileClientMessageIndex = 380;
        ClientMessage fromFile = clientMessages.get(fileClientMessageIndex);
        LockForceUnlockCodec.ResponseParameters parameters = LockForceUnlockCodec.decodeResponse(fromFile);
    }

    @Test
    public void test_LockTryLockCodec_encodeRequest() {
        int fileClientMessageIndex = 381;
        ClientMessage encoded = LockTryLockCodec.encodeRequest(aString, aLong, aLong, aLong, aLong);
        ClientMessage fromFile = clientMessages.get(fileClientMessageIndex);
        compareClientMessages(fromFile, encoded);
    }

    @Test
    public void test_LockTryLockCodec_decodeResponse() {
        int fileClientMessageIndex = 382;
        ClientMessage fromFile = clientMessages.get(fileClientMessageIndex);
        LockTryLockCodec.ResponseParameters parameters = LockTryLockCodec.decodeResponse(fromFile);
        assertTrue(isEqual(aBoolean, parameters.response));
    }

    @Test
    public void test_ConditionAwaitCodec_encodeRequest() {
        int fileClientMessageIndex = 383;
        ClientMessage encoded = ConditionAwaitCodec.encodeRequest(aString, aLong, aLong, aString, aLong);
        ClientMessage fromFile = clientMessages.get(fileClientMessageIndex);
        compareClientMessages(fromFile, encoded);
    }

    @Test
    public void test_ConditionAwaitCodec_decodeResponse() {
        int fileClientMessageIndex = 384;
        ClientMessage fromFile = clientMessages.get(fileClientMessageIndex);
        ConditionAwaitCodec.ResponseParameters parameters = ConditionAwaitCodec.decodeResponse(fromFile);
        assertTrue(isEqual(aBoolean, parameters.response));
    }

    @Test
    public void test_ConditionBeforeAwaitCodec_encodeRequest() {
        int fileClientMessageIndex = 385;
        ClientMessage encoded = ConditionBeforeAwaitCodec.encodeRequest(aString, aLong, aString, aLong);
        ClientMessage fromFile = clientMessages.get(fileClientMessageIndex);
        compareClientMessages(fromFile, encoded);
    }

    @Test
    public void test_ConditionBeforeAwaitCodec_decodeResponse() {
        int fileClientMessageIndex = 386;
        ClientMessage fromFile = clientMessages.get(fileClientMessageIndex);
        ConditionBeforeAwaitCodec.ResponseParameters parameters = ConditionBeforeAwaitCodec.decodeResponse(fromFile);
    }

    @Test
    public void test_ConditionSignalCodec_encodeRequest() {
        int fileClientMessageIndex = 387;
        ClientMessage encoded = ConditionSignalCodec.encodeRequest(aString, aLong, aString);
        ClientMessage fromFile = clientMessages.get(fileClientMessageIndex);
        compareClientMessages(fromFile, encoded);
    }

    @Test
    public void test_ConditionSignalCodec_decodeResponse() {
        int fileClientMessageIndex = 388;
        ClientMessage fromFile = clientMessages.get(fileClientMessageIndex);
        ConditionSignalCodec.ResponseParameters parameters = ConditionSignalCodec.decodeResponse(fromFile);
    }

    @Test
    public void test_ConditionSignalAllCodec_encodeRequest() {
        int fileClientMessageIndex = 389;
        ClientMessage encoded = ConditionSignalAllCodec.encodeRequest(aString, aLong, aString);
        ClientMessage fromFile = clientMessages.get(fileClientMessageIndex);
        compareClientMessages(fromFile, encoded);
    }

    @Test
    public void test_ConditionSignalAllCodec_decodeResponse() {
        int fileClientMessageIndex = 390;
        ClientMessage fromFile = clientMessages.get(fileClientMessageIndex);
        ConditionSignalAllCodec.ResponseParameters parameters = ConditionSignalAllCodec.decodeResponse(fromFile);
    }
    ...
    @Test
    public void test_DynamicConfigAddLockConfigCodec_encodeRequest() {
        int fileClientMessageIndex = 748;
        ClientMessage encoded = DynamicConfigAddLockConfigCodec.encodeRequest(aString, aString);
        ClientMessage fromFile = clientMessages.get(fileClientMessageIndex);
        compareClientMessages(fromFile, encoded);
    }

    @Test
    public void test_DynamicConfigAddLockConfigCodec_decodeResponse() {
        int fileClientMessageIndex = 749;
        ClientMessage fromFile = clientMessages.get(fileClientMessageIndex);
        DynamicConfigAddLockConfigCodec.ResponseParameters parameters = DynamicConfigAddLockConfigCodec.decodeResponse(fromFile);
    }
    ...
    public void test_DynamicConfigAddMapConfigCodec_encodeRequest() {
        ...
        ClientMessage encoded = DynamicConfigAddMapConfigCodec.encodeRequest(aString, anInt, anInt, anInt, anInt, aString, aBoolean, aString, aString, aString, aListOfListenerConfigHolders, aListOfListenerConfigHolders, aBoolean, aString, aData, aString, anInt, aMapStoreConfigHolder, aNearCacheConfigHolder, aWanReplicationRef, aListOfMapIndexConfigs, aListOfAttributeConfigs, aListOfQueryCacheConfigHolders, aString, aData, aHotRestartConfig, anEventJournalConfig, aMerkleTreeConfig, anInt, anInt);
        ClientMessage fromFile = clientMessages.get(fileClientMessageIndex);
        compareClientMessages(fromFile, encoded);
    }
    ...
    public void test_DynamicConfigAddCacheConfigCodec_encodeRequest() {
        ...
        ClientMessage encoded = DynamicConfigAddCacheConfigCodec.encodeRequest(aString, aString, aString, aBoolean, aBoolean, aBoolean, aBoolean, aString, aString, aString, aString, anInt, anInt, aString, aString, aString, aBoolean, aListOfListenerConfigHolders, aString, aTimedExpiryPolicyFactoryConfig, aListOfCacheSimpleEntryListenerConfigs, anEvictionConfigHolder, aWanReplicationRef, anEventJournalConfig, aHotRestartConfig);
        ClientMessage fromFile = clientMessages.get(fileClientMessageIndex);
        compareClientMessages(fromFile, encoded);
    }
    ...
    @Test
    public void test_CPFencedLockLockCodec_encodeRequest() {
        int fileClientMessageIndex = 796;
        ClientMessage encoded = CPFencedLockLockCodec.encodeRequest(aRaftGroupId, aString, aLong, aLong, aUUID);
        ClientMessage fromFile = clientMessages.get(fileClientMessageIndex);
        compareClientMessages(fromFile, encoded);
    }

    @Test
    public void test_CPFencedLockLockCodec_decodeResponse() {
        int fileClientMessageIndex = 797;
        ClientMessage fromFile = clientMessages.get(fileClientMessageIndex);
        CPFencedLockLockCodec.ResponseParameters parameters = CPFencedLockLockCodec.decodeResponse(fromFile);
        assertTrue(isEqual(aLong, parameters.response));
    }

    @Test
    public void test_CPFencedLockTryLockCodec_encodeRequest() {
        int fileClientMessageIndex = 798;
        ClientMessage encoded = CPFencedLockTryLockCodec.encodeRequest(aRaftGroupId, aString, aLong, aLong, aUUID, aLong);
        ClientMessage fromFile = clientMessages.get(fileClientMessageIndex);
        compareClientMessages(fromFile, encoded);
    }

    @Test
    public void test_CPFencedLockTryLockCodec_decodeResponse() {
        int fileClientMessageIndex = 799;
        ClientMessage fromFile = clientMessages.get(fileClientMessageIndex);
        CPFencedLockTryLockCodec.ResponseParameters parameters = CPFencedLockTryLockCodec.decodeResponse(fromFile);
        assertTrue(isEqual(aLong, parameters.response));
    }

    @Test
    public void test_CPFencedLockUnlockCodec_encodeRequest() {
        int fileClientMessageIndex = 800;
        ClientMessage encoded = CPFencedLockUnlockCodec.encodeRequest(aRaftGroupId, aString, aLong, aLong, aUUID);
        ClientMessage fromFile = clientMessages.get(fileClientMessageIndex);
        compareClientMessages(fromFile, encoded);
    }

    @Test
    public void test_CPFencedLockUnlockCodec_decodeResponse() {
        int fileClientMessageIndex = 801;
        ClientMessage fromFile = clientMessages.get(fileClientMessageIndex);
        CPFencedLockUnlockCodec.ResponseParameters parameters = CPFencedLockUnlockCodec.decodeResponse(fromFile);
        assertTrue(isEqual(aBoolean, parameters.response));
    }

    @Test
    public void test_CPFencedLockGetLockOwnershipCodec_encodeRequest() {
        int fileClientMessageIndex = 802;
        ClientMessage encoded = CPFencedLockGetLockOwnershipCodec.encodeRequest(aRaftGroupId, aString);
        ClientMessage fromFile = clientMessages.get(fileClientMessageIndex);
        compareClientMessages(fromFile, encoded);
    }

    @Test
    public void test_CPFencedLockGetLockOwnershipCodec_decodeResponse() {
        int fileClientMessageIndex = 803;
        ClientMessage fromFile = clientMessages.get(fileClientMessageIndex);
        CPFencedLockGetLockOwnershipCodec.ResponseParameters parameters = CPFencedLockGetLockOwnershipCodec.decodeResponse(fromFile);
    ...
    @Test
    public void test_MetricsReadMetricsCodec_encodeRequest() {
        int fileClientMessageIndex = 804;
        ClientMessage encoded = MetricsReadMetricsCodec.encodeRequest(aUUID, aLong);
        ClientMessage fromFile = clientMessages.get(fileClientMessageIndex);
        compareClientMessages(fromFile, encoded);
    }

    @Test
    public void test_MetricsReadMetricsCodec_decodeResponse() {
        int fileClientMessageIndex = 805;
        ClientMessage fromFile = clientMessages.get(fileClientMessageIndex);
        MetricsReadMetricsCodec.ResponseParameters parameters = MetricsReadMetricsCodec.decodeResponse(fromFile);
