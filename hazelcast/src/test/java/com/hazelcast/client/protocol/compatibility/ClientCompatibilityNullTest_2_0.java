...
public class ClientCompatibilityNullTest_2_0 {
    ...
    public void test_ClientAuthenticationCodec_encodeRequest() {
        ...
        ClientMessage encoded = ClientAuthenticationCodec.encodeRequest(aString, aString, null, null, aBoolean, aString, aByte, aString, aString, aListOfStrings, anInt, null);
    ...
    public void test_ClientAuthenticationCodec_decodeResponse() {
        ...
        assertTrue(isEqual(null, parameters.clientUnregisteredMembers));
    ...
    public void test_ClientAuthenticationCustomCodec_encodeRequest() {
        ...
        ClientMessage encoded = ClientAuthenticationCustomCodec.encodeRequest(aData, null, null, aBoolean, aString, aByte, aString, aString, aListOfStrings, anInt, null);
        ClientMessage fromFile = clientMessages.get(fileClientMessageIndex);
        compareClientMessages(fromFile, encoded);
    }
    ...
    public void test_DynamicConfigAddLockConfigCodec_encodeRequest() {
        ...
        ClientMessage encoded = DynamicConfigAddLockConfigCodec.encodeRequest(aString, null);
        ClientMessage fromFile = clientMessages.get(fileClientMessageIndex);
        compareClientMessages(fromFile, encoded);
    }
