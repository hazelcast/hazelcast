...
public class MemberCompatibilityNullTest_2_0 {
    ...
    public void test_ClientAuthenticationCodec_decodeRequest() {
        ...
        assertTrue(isEqual(null, parameters.ownerUuid));
        assertTrue(isEqual(aBoolean, parameters.isOwnerConnection));
        ...
        assertTrue(isEqual(null, parameters.clusterId));
    }

    @Test
    public void test_ClientAuthenticationCodec_encodeResponse() {
        int fileClientMessageIndex = 1;
        ClientMessage encoded = ClientAuthenticationCodec.encodeResponse(aByte, null, null, null, aByte, aString, null, anInt, aUUID);
        ClientMessage fromFile = clientMessages.get(fileClientMessageIndex);
    ...
    public void test_ClientAuthenticationCustomCodec_encodeResponse() {
        ...
        ClientMessage encoded = ClientAuthenticationCustomCodec.encodeResponse(aByte, null, null, null, aByte, aString, null, anInt, aUUID);
        ClientMessage fromFile = clientMessages.get(fileClientMessageIndex);
        compareClientMessages(fromFile, encoded);
    }
    ...
    public void test_ClientAddMembershipListenerCodec_encodeMemberAttributeChangeEvent() {
        ...
        ClientMessage fromFile = clientMessages.get(fileClientMessageIndex);
        ClientMessage encoded = ClientAddMembershipListenerCodec.encodeMemberAttributeChangeEvent(aMember, aListOfMembers, aString, anInt, null);
        compareClientMessages(fromFile, encoded);
    }
    ...
    public void test_MapAddNearCacheEntryListenerCodec_encodeIMapInvalidationEvent() {
        ...
        ClientMessage fromFile = clientMessages.get(fileClientMessageIndex);
        ClientMessage encoded = MapAddNearCacheEntryListenerCodec.encodeIMapInvalidationEvent(null, aUUID, aUUID, aLong);
        compareClientMessages(fromFile, encoded);
    }
    ...
    public void test_MapAddIndexCodec_decodeRequest() {
        ...
        assertTrue(isEqual(aString, parameters.name));
        assertTrue(isEqual(aString, parameters.attribute));
        assertTrue(isEqual(aBoolean, parameters.ordered));
    }
    ...
    @Test
    public void test_LockIsLockedCodec_decodeRequest() {
        int fileClientMessageIndex = 367;
        ClientMessage fromFile = clientMessages.get(fileClientMessageIndex);
        LockIsLockedCodec.RequestParameters parameters = LockIsLockedCodec.decodeRequest(fromFile);
        assertTrue(isEqual(aString, parameters.name));
    }

    @Test
    public void test_LockIsLockedCodec_encodeResponse() {
        int fileClientMessageIndex = 368;
        ClientMessage encoded = LockIsLockedCodec.encodeResponse(aBoolean);
        ClientMessage fromFile = clientMessages.get(fileClientMessageIndex);
        compareClientMessages(fromFile, encoded);
    }

    @Test
    public void test_LockIsLockedByCurrentThreadCodec_decodeRequest() {
        int fileClientMessageIndex = 369;
        ClientMessage fromFile = clientMessages.get(fileClientMessageIndex);
        LockIsLockedByCurrentThreadCodec.RequestParameters parameters = LockIsLockedByCurrentThreadCodec.decodeRequest(fromFile);
        assertTrue(isEqual(aString, parameters.name));
        assertTrue(isEqual(aLong, parameters.threadId));
    }

    @Test
    public void test_LockIsLockedByCurrentThreadCodec_encodeResponse() {
        int fileClientMessageIndex = 370;
        ClientMessage encoded = LockIsLockedByCurrentThreadCodec.encodeResponse(aBoolean);
        ClientMessage fromFile = clientMessages.get(fileClientMessageIndex);
        compareClientMessages(fromFile, encoded);
    }

    @Test
    public void test_LockGetLockCountCodec_decodeRequest() {
        int fileClientMessageIndex = 371;
        ClientMessage fromFile = clientMessages.get(fileClientMessageIndex);
        LockGetLockCountCodec.RequestParameters parameters = LockGetLockCountCodec.decodeRequest(fromFile);
        assertTrue(isEqual(aString, parameters.name));
    }

    @Test
    public void test_LockGetLockCountCodec_encodeResponse() {
        int fileClientMessageIndex = 372;
        ClientMessage encoded = LockGetLockCountCodec.encodeResponse(anInt);
        ClientMessage fromFile = clientMessages.get(fileClientMessageIndex);
        compareClientMessages(fromFile, encoded);
    }

    @Test
    public void test_LockGetRemainingLeaseTimeCodec_decodeRequest() {
        int fileClientMessageIndex = 373;
        ClientMessage fromFile = clientMessages.get(fileClientMessageIndex);
        LockGetRemainingLeaseTimeCodec.RequestParameters parameters = LockGetRemainingLeaseTimeCodec.decodeRequest(fromFile);
        assertTrue(isEqual(aString, parameters.name));
    }

    @Test
    public void test_LockGetRemainingLeaseTimeCodec_encodeResponse() {
        int fileClientMessageIndex = 374;
        ClientMessage encoded = LockGetRemainingLeaseTimeCodec.encodeResponse(aLong);
        ClientMessage fromFile = clientMessages.get(fileClientMessageIndex);
        compareClientMessages(fromFile, encoded);
    }

    @Test
    public void test_LockLockCodec_decodeRequest() {
        int fileClientMessageIndex = 375;
        ClientMessage fromFile = clientMessages.get(fileClientMessageIndex);
        LockLockCodec.RequestParameters parameters = LockLockCodec.decodeRequest(fromFile);
        assertTrue(isEqual(aString, parameters.name));
        assertTrue(isEqual(aLong, parameters.leaseTime));
        assertTrue(isEqual(aLong, parameters.threadId));
        assertTrue(isEqual(aLong, parameters.referenceId));
    }

    @Test
    public void test_LockLockCodec_encodeResponse() {
        int fileClientMessageIndex = 376;
        ClientMessage encoded = LockLockCodec.encodeResponse();
        ClientMessage fromFile = clientMessages.get(fileClientMessageIndex);
        compareClientMessages(fromFile, encoded);
    }

    @Test
    public void test_LockUnlockCodec_decodeRequest() {
        int fileClientMessageIndex = 377;
        ClientMessage fromFile = clientMessages.get(fileClientMessageIndex);
        LockUnlockCodec.RequestParameters parameters = LockUnlockCodec.decodeRequest(fromFile);
        assertTrue(isEqual(aString, parameters.name));
        assertTrue(isEqual(aLong, parameters.threadId));
        assertTrue(isEqual(aLong, parameters.referenceId));
    }
    ...
    @Test
    public void test_LockUnlockCodec_encodeResponse() {
        int fileClientMessageIndex = 378;
        ClientMessage encoded = LockUnlockCodec.encodeResponse();
        ClientMessage fromFile = clientMessages.get(fileClientMessageIndex);
        compareClientMessages(fromFile, encoded);
    }

    @Test
    public void test_LockForceUnlockCodec_decodeRequest() {
        int fileClientMessageIndex = 379;
        ClientMessage fromFile = clientMessages.get(fileClientMessageIndex);
        LockForceUnlockCodec.RequestParameters parameters = LockForceUnlockCodec.decodeRequest(fromFile);
        assertTrue(isEqual(aString, parameters.name));
        assertTrue(isEqual(aLong, parameters.referenceId));
    }

    @Test
    public void test_LockForceUnlockCodec_encodeResponse() {
        int fileClientMessageIndex = 380;
        ClientMessage encoded = LockForceUnlockCodec.encodeResponse();
        ClientMessage fromFile = clientMessages.get(fileClientMessageIndex);
        compareClientMessages(fromFile, encoded);
    }

    @Test
    public void test_LockTryLockCodec_decodeRequest() {
        int fileClientMessageIndex = 381;
        ClientMessage fromFile = clientMessages.get(fileClientMessageIndex);
        LockTryLockCodec.RequestParameters parameters = LockTryLockCodec.decodeRequest(fromFile);
        assertTrue(isEqual(aString, parameters.name));
        assertTrue(isEqual(aLong, parameters.threadId));
        assertTrue(isEqual(aLong, parameters.lease));
        assertTrue(isEqual(aLong, parameters.timeout));
    ...
    @Test
    public void test_LockTryLockCodec_encodeResponse() {
        int fileClientMessageIndex = 382;
        ClientMessage encoded = LockTryLockCodec.encodeResponse(aBoolean);
        ClientMessage fromFile = clientMessages.get(fileClientMessageIndex);
        compareClientMessages(fromFile, encoded);
    }

    @Test
    public void test_ConditionAwaitCodec_decodeRequest() {
        int fileClientMessageIndex = 383;
        ClientMessage fromFile = clientMessages.get(fileClientMessageIndex);
        ConditionAwaitCodec.RequestParameters parameters = ConditionAwaitCodec.decodeRequest(fromFile);
        assertTrue(isEqual(aString, parameters.name));
        assertTrue(isEqual(aLong, parameters.threadId));
        assertTrue(isEqual(aLong, parameters.timeout));
        assertTrue(isEqual(aString, parameters.lockName));
        assertTrue(isEqual(aLong, parameters.referenceId));
    }

    @Test
    public void test_ConditionAwaitCodec_encodeResponse() {
        int fileClientMessageIndex = 384;
        ClientMessage encoded = ConditionAwaitCodec.encodeResponse(aBoolean);
        ClientMessage fromFile = clientMessages.get(fileClientMessageIndex);
        compareClientMessages(fromFile, encoded);
    }

    @Test
    public void test_ConditionBeforeAwaitCodec_decodeRequest() {
        int fileClientMessageIndex = 385;
        ClientMessage fromFile = clientMessages.get(fileClientMessageIndex);
        ConditionBeforeAwaitCodec.RequestParameters parameters = ConditionBeforeAwaitCodec.decodeRequest(fromFile);
        assertTrue(isEqual(aString, parameters.name));
        assertTrue(isEqual(aLong, parameters.threadId));
        assertTrue(isEqual(aString, parameters.lockName));
        assertTrue(isEqual(aLong, parameters.referenceId));
    ...
    @Test
    public void test_ConditionBeforeAwaitCodec_encodeResponse() {
        int fileClientMessageIndex = 386;
        ClientMessage encoded = ConditionBeforeAwaitCodec.encodeResponse();
        ClientMessage fromFile = clientMessages.get(fileClientMessageIndex);
        compareClientMessages(fromFile, encoded);
    }

    @Test
    public void test_ConditionSignalCodec_decodeRequest() {
        int fileClientMessageIndex = 387;
        ClientMessage fromFile = clientMessages.get(fileClientMessageIndex);
        ConditionSignalCodec.RequestParameters parameters = ConditionSignalCodec.decodeRequest(fromFile);
        assertTrue(isEqual(aString, parameters.name));
        assertTrue(isEqual(aLong, parameters.threadId));
        assertTrue(isEqual(aString, parameters.lockName));
    }
    ...
    @Test
    public void test_ConditionSignalCodec_encodeResponse() {
        int fileClientMessageIndex = 388;
        ClientMessage encoded = ConditionSignalCodec.encodeResponse();
        ClientMessage fromFile = clientMessages.get(fileClientMessageIndex);
        compareClientMessages(fromFile, encoded);
    }

    @Test
    public void test_ConditionSignalAllCodec_decodeRequest() {
        int fileClientMessageIndex = 389;
        ClientMessage fromFile = clientMessages.get(fileClientMessageIndex);
        ConditionSignalAllCodec.RequestParameters parameters = ConditionSignalAllCodec.decodeRequest(fromFile);
        assertTrue(isEqual(aString, parameters.name));
        assertTrue(isEqual(aLong, parameters.threadId));
        assertTrue(isEqual(aString, parameters.lockName));
    }
    ...
    @Test
    public void test_ConditionSignalAllCodec_encodeResponse() {
        int fileClientMessageIndex = 390;
        ClientMessage encoded = ConditionSignalAllCodec.encodeResponse();
        ClientMessage fromFile = clientMessages.get(fileClientMessageIndex);
        compareClientMessages(fromFile, encoded);
    }
    ...
    public void test_CacheAddInvalidationListenerCodec_encodeCacheInvalidationEvent() {
        ...
        ClientMessage fromFile = clientMessages.get(fileClientMessageIndex);
        ClientMessage encoded = CacheAddInvalidationListenerCodec.encodeCacheInvalidationEvent(aString, null, null, aUUID, aLong);
        compareClientMessages(fromFile, encoded);
    }
    ...
    public void test_CacheAddInvalidationListenerCodec_encodeCacheBatchInvalidationEvent() {
        ...
        ClientMessage fromFile = clientMessages.get(fileClientMessageIndex);
        ClientMessage encoded = CacheAddInvalidationListenerCodec.encodeCacheBatchInvalidationEvent(aString, aListOfData, null, aListOfUUIDs, aListOfLongs);
        compareClientMessages(fromFile, encoded);
    }
    ...
    public void test_CacheAddNearCacheInvalidationListenerCodec_encodeCacheBatchInvalidationEvent() {
        ...
        ClientMessage fromFile = clientMessages.get(fileClientMessageIndex);
        ClientMessage encoded = CacheAddNearCacheInvalidationListenerCodec.encodeCacheBatchInvalidationEvent(aString, aListOfData, null, aListOfUUIDs, aListOfLongs);
        compareClientMessages(fromFile, encoded);
    }
    ...
    @Test
    public void test_DynamicConfigAddLockConfigCodec_decodeRequest() {
        int fileClientMessageIndex = 748;
        ClientMessage fromFile = clientMessages.get(fileClientMessageIndex);
        DynamicConfigAddLockConfigCodec.RequestParameters parameters = DynamicConfigAddLockConfigCodec.decodeRequest(fromFile);
        assertTrue(isEqual(aString, parameters.name));
        assertTrue(isEqual(null, parameters.splitBrainProtectionName));
    }

    @Test
    public void test_DynamicConfigAddLockConfigCodec_encodeResponse() {
        int fileClientMessageIndex = 749;
        ClientMessage encoded = DynamicConfigAddLockConfigCodec.encodeResponse();
        ClientMessage fromFile = clientMessages.get(fileClientMessageIndex);
        compareClientMessages(fromFile, encoded);
    }
    ...
    public void test_DynamicConfigAddMapConfigCodec_decodeRequest() {
        ...
        assertTrue(isEqual(null, parameters.mapIndexConfigs));
    ...
    @Test
    public void test_CPFencedLockLockCodec_decodeRequest() {
        int fileClientMessageIndex = 796;
        ClientMessage fromFile = clientMessages.get(fileClientMessageIndex);
        CPFencedLockLockCodec.RequestParameters parameters = CPFencedLockLockCodec.decodeRequest(fromFile);
        assertTrue(isEqual(aRaftGroupId, parameters.groupId));
        assertTrue(isEqual(aString, parameters.name));
        assertTrue(isEqual(aLong, parameters.sessionId));
        assertTrue(isEqual(aLong, parameters.threadId));
    ...
    @Test
    public void test_CPFencedLockLockCodec_encodeResponse() {
        int fileClientMessageIndex = 797;
        ClientMessage encoded = CPFencedLockLockCodec.encodeResponse(aLong);
        ClientMessage fromFile = clientMessages.get(fileClientMessageIndex);
        compareClientMessages(fromFile, encoded);
    }

    @Test
    public void test_CPFencedLockTryLockCodec_decodeRequest() {
        int fileClientMessageIndex = 798;
        ClientMessage fromFile = clientMessages.get(fileClientMessageIndex);
        CPFencedLockTryLockCodec.RequestParameters parameters = CPFencedLockTryLockCodec.decodeRequest(fromFile);
        assertTrue(isEqual(aRaftGroupId, parameters.groupId));
        assertTrue(isEqual(aString, parameters.name));
        assertTrue(isEqual(aLong, parameters.sessionId));
        assertTrue(isEqual(aLong, parameters.threadId));
    ...
    @Test
    public void test_CPFencedLockTryLockCodec_encodeResponse() {
        int fileClientMessageIndex = 799;
        ClientMessage encoded = CPFencedLockTryLockCodec.encodeResponse(aLong);
        ClientMessage fromFile = clientMessages.get(fileClientMessageIndex);
        compareClientMessages(fromFile, encoded);
    }

    @Test
    public void test_CPFencedLockUnlockCodec_decodeRequest() {
        int fileClientMessageIndex = 800;
        ClientMessage fromFile = clientMessages.get(fileClientMessageIndex);
        CPFencedLockUnlockCodec.RequestParameters parameters = CPFencedLockUnlockCodec.decodeRequest(fromFile);
        assertTrue(isEqual(aRaftGroupId, parameters.groupId));
        assertTrue(isEqual(aString, parameters.name));
        assertTrue(isEqual(aLong, parameters.sessionId));
        assertTrue(isEqual(aLong, parameters.threadId));
    ...
    @Test
    public void test_CPFencedLockUnlockCodec_encodeResponse() {
        int fileClientMessageIndex = 801;
        ClientMessage encoded = CPFencedLockUnlockCodec.encodeResponse(aBoolean);
        ClientMessage fromFile = clientMessages.get(fileClientMessageIndex);
        compareClientMessages(fromFile, encoded);
    }

    @Test
    public void test_CPFencedLockGetLockOwnershipCodec_decodeRequest() {
        int fileClientMessageIndex = 802;
        ClientMessage fromFile = clientMessages.get(fileClientMessageIndex);
        CPFencedLockGetLockOwnershipCodec.RequestParameters parameters = CPFencedLockGetLockOwnershipCodec.decodeRequest(fromFile);
        assertTrue(isEqual(aRaftGroupId, parameters.groupId));
        assertTrue(isEqual(aString, parameters.name));
    }

    @Test
    public void test_CPFencedLockGetLockOwnershipCodec_encodeResponse() {
        int fileClientMessageIndex = 803;
        ClientMessage encoded = CPFencedLockGetLockOwnershipCodec.encodeResponse(aLong, anInt, aLong, aLong);
        ClientMessage fromFile = clientMessages.get(fileClientMessageIndex);
        compareClientMessages(fromFile, encoded);
    }

    @Test
    public void test_MetricsReadMetricsCodec_decodeRequest() {
        int fileClientMessageIndex = 804;
        ClientMessage fromFile = clientMessages.get(fileClientMessageIndex);
        MetricsReadMetricsCodec.RequestParameters parameters = MetricsReadMetricsCodec.decodeRequest(fromFile);
        assertTrue(isEqual(aUUID, parameters.uuid));
        assertTrue(isEqual(aLong, parameters.fromSequence));
    }

    @Test
    public void test_MetricsReadMetricsCodec_encodeResponse() {
        int fileClientMessageIndex = 805;
        ClientMessage encoded = MetricsReadMetricsCodec.encodeResponse(aListOfLongToByteArray, aLong);
        ClientMessage fromFile = clientMessages.get(fileClientMessageIndex);
        compareClientMessages(fromFile, encoded);
    }
