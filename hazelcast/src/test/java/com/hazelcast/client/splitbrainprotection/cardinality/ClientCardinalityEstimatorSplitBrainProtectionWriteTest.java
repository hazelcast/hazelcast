...
package com.hazelcast.client.splitbrainprotection.cardinality;
...
public class ClientCardinalityEstimatorSplitBrainProtectionWriteTest extends CardinalityEstimatorSplitBrainProtectionWriteTest {
    ...
    protected CardinalityEstimator estimator(int index) {
        return clients.client(index).getCardinalityEstimator(ESTIMATOR_NAME + splitBrainProtectionOn.name());
    }
}
