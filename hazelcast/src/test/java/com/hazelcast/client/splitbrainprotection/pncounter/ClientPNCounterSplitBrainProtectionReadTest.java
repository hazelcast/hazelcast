...
package com.hazelcast.client.splitbrainprotection.pncounter;
...
public class ClientPNCounterSplitBrainProtectionReadTest extends PNCounterSplitBrainProtectionReadTest {
    ...
    protected PNCounter pnCounter(int index) {
        return clients.client(index).getPNCounter(PN_COUNTER_NAME + splitBrainProtectionOn.name());
    }
}
