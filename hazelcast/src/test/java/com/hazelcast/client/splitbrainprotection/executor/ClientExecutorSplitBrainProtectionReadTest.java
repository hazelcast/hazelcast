...
public class ClientExecutorSplitBrainProtectionReadTest extends ExecutorSplitBrainProtectionReadTest {
    ...
    protected IExecutorService exec(int index, SplitBrainProtectionOn splitBrainProtectionOn) {
        return clients.client(index).getExecutorService(EXEC_NAME + splitBrainProtectionOn.name());
    }
}
