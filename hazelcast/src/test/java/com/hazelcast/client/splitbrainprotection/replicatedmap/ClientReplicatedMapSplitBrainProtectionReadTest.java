...
package com.hazelcast.client.splitbrainprotection.replicatedmap;
...
public class ClientReplicatedMapSplitBrainProtectionReadTest extends ReplicatedMapSplitBrainProtectionReadTest {
    ...
    protected ReplicatedMap map(int index) {
        return clients.client(index).getReplicatedMap(REPLICATED_MAP_NAME + splitBrainProtectionOn.name());
    }
}
