...
package com.hazelcast.client.splitbrainprotection.scheduledexecutor;
...
public class ClientScheduledExecutorSplitBrainProtectionWriteTest extends ScheduledExecutorSplitBrainProtectionWriteTest {
    ...
    protected IScheduledExecutorService scheduledExec(int index, SplitBrainProtectionOn splitBrainProtectionOn, String postfix) {
        return clients.client(index).getScheduledExecutorService(SCHEDULED_EXEC_NAME + splitBrainProtectionOn.name() + postfix);
    }
}
