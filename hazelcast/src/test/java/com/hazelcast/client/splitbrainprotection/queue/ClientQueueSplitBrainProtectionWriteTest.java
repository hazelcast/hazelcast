...
package com.hazelcast.client.splitbrainprotection.queue;
...
public class ClientQueueSplitBrainProtectionWriteTest extends QueueSplitBrainProtectionWriteTest {
    ...
    protected IQueue queue(int index) {
        return clients.client(index).getQueue(QUEUE_NAME + splitBrainProtectionOn.name());
    }
}
