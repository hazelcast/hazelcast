...
package com.hazelcast.client.splitbrainprotection.set;
...
public class ClientSetSplitBrainProtectionReadTest extends SetSplitBrainProtectionReadTest {
    ...
    protected ISet set(int index) {
        return clients.client(index).getSet(SET_NAME + splitBrainProtectionOn.name());
    }
}
