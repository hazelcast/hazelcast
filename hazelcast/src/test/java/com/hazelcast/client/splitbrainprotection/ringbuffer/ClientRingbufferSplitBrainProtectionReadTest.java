...
package com.hazelcast.client.splitbrainprotection.ringbuffer;
...
public class ClientRingbufferSplitBrainProtectionReadTest extends RingbufferSplitBrainProtectionReadTest {
    ...
    protected Ringbuffer ring(int index) {
        return clients.client(index).getRingbuffer(RINGBUFFER_NAME + splitBrainProtectionOn.name());
    }
}
