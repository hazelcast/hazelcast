...
package com.hazelcast.client.splitbrainprotection.multimap;
...
public class ClientMultiMapSplitBrainProtectionReadTest extends MultiMapSplitBrainProtectionReadTest {
    ...
    protected MultiMap map(int index) {
        return clients.client(index).getMultiMap(MULTI_MAP_NAME + splitBrainProtectionOn.name());
    }
}
