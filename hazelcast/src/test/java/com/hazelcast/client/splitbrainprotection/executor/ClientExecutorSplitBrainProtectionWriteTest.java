...
package com.hazelcast.client.splitbrainprotection.executor;
...
public class ClientExecutorSplitBrainProtectionWriteTest extends ExecutorSplitBrainProtectionWriteTest {
    ...
    protected IExecutorService exec(int index, SplitBrainProtectionOn splitBrainProtectionOn, String postfix) {
        return clients.client(index).getExecutorService(EXEC_NAME + splitBrainProtectionOn.name() + postfix);
    }

    @Override
    @Test(expected = UnsupportedOperationException.class)
    public void invokeAll_timeout_splitBrainProtection_short_timeout() throws Exception {
        super.invokeAll_timeout_splitBrainProtection_short_timeout();
    }

    @Override
    @Test(expected = UnsupportedOperationException.class)
    public void invokeAll_timeout_splitBrainProtection_long_timeout() throws Exception {
        super.invokeAll_timeout_splitBrainProtection_long_timeout();
    }

    @Override
    @Test(expected = UnsupportedOperationException.class)
    public void invokeAll_timeout_noSplitBrainProtection() throws Exception {
        super.invokeAll_timeout_noSplitBrainProtection();
    }
}
