...
public class SinksRemoteMapWithMergingTest extends PipelineTestSupport {
    ...
    @Test
    public void remoteMapWithMerging_withExternalConfig() {
        // Given
        List<Integer> input = sequence(itemCount);
        putToMap(remoteHz.getMap(srcName), input);
    ...
    @Test
    public void remoteMapWithMerging_when_functionReturnsNull_then_keyIsRemoved_withExternalConfig() {
        // Given
        List<Integer> input = sequence(itemCount);
        putToMap(remoteHz.getMap(srcName), input);
