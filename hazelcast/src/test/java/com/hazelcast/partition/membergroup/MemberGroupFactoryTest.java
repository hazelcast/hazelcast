...
public class MemberGroupFactoryTest {
    ...
    private Collection<Member> createMembers() throws UnknownHostException {
        ...
        members.add(new MemberImpl(new Address("192.192.0.1", fakeAddress, 5701), Version.of("3.8.0"), false));
        members.add(new MemberImpl(new Address("192.192.0.1", fakeAddress, 5702), Version.of("3.8.0"), false));
        members.add(new MemberImpl(new Address("192.168.3.101", fakeAddress, 5701), Version.of("3.8.0"), false));
        members.add(new MemberImpl(new Address("192.168.3.101", fakeAddress, 5702), Version.of("3.8.0"), false));
        members.add(new MemberImpl(new Address("172.16.5.11", fakeAddress, 5701), Version.of("3.8.0"), false));
        members.add(new MemberImpl(new Address("172.16.5.11", fakeAddress, 5702), Version.of("3.8.0"), false));
        members.add(new MemberImpl(new Address("172.123.0.13", fakeAddress, 5701), Version.of("3.8.0"), false));
        members.add(new MemberImpl(new Address("172.123.0.13", fakeAddress, 5702), Version.of("3.8.0"), false));
        members.add(new MemberImpl(new Address("www.hazelcast.com.tr", fakeAddress, 5701), Version.of("3.8.0"), false));
        members.add(new MemberImpl(new Address("www.hazelcast.com.tr", fakeAddress, 5702), Version.of("3.8.0"), false));
        members.add(new MemberImpl(new Address("jobs.hazelcast.com", fakeAddress, 5701), Version.of("3.8.0"), false));
        members.add(new MemberImpl(new Address("jobs.hazelcast.com", fakeAddress, 5702), Version.of("3.8.0"), false));
        members.add(new MemberImpl(new Address("www.hazelcast.org", fakeAddress, 5701), Version.of("3.8.0"), false));
        members.add(new MemberImpl(new Address("www.hazelcast.org", fakeAddress, 5702), Version.of("3.8.0"), false));
    ...
    private Collection<Member> createMembersWithZoneAwareMetadata() throws UnknownHostException {
        Collection<Member> members = new HashSet<Member>();
        InetAddress fakeAddress = InetAddress.getLocalHost();
        MemberImpl member1 = new MemberImpl(new Address("192.192.0.1", fakeAddress, 5701), Version.of("3.8.0"), true);
        member1.setStringAttribute(PartitionGroupMetaData.PARTITION_GROUP_ZONE, "us-east-1");

        MemberImpl member2 = new MemberImpl(new Address("192.192.0.2", fakeAddress, 5701), Version.of("3.8.0"), true);
        member2.setStringAttribute(PartitionGroupMetaData.PARTITION_GROUP_ZONE, "us-west-1");

        MemberImpl member3 = new MemberImpl(new Address("192.192.0.3", fakeAddress, 5701), Version.of("3.8.0"), true);
