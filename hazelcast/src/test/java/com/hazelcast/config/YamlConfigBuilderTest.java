 ...
 * {@link XMLConfigBuilderTest} as well
 *
 * @see XMLConfigBuilderTest
 */
@RunWith(HazelcastParallelClassRunner.class)
@Category({QuickTest.class, ParallelTest.class})
public class YamlConfigBuilderTest extends HazelcastTestSupport {
    ...
    @Ignore
    // TODO un-ignore
    public void testConfig2Yaml2DefaultConfig() {
        testConfig2Yaml2Config("hazelcast-default.yaml");
    }

    @Test
    @Ignore
    public void testConfig2Yaml2FullConfig() {
        testConfig2Yaml2Config("hazelcast-fullconfig.yaml");
    }

    private static void testConfig2Yaml2Config(String fileName) {
    ...
    @Test(expected = IllegalArgumentException.class)
    @Ignore("No YAML identical to the original XML can be written")
    public void testAttributeConfig_noName_noExtractor() {
        // keeping the YAML tests identical to the XML tests at method level for easy comparison
    }
