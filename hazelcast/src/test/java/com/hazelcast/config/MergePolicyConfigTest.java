...
public class MergePolicyConfigTest {
    ...
    public void testToString() {
        ...
        assertTrue(configString.contains("MergePolicyConfig"));
        assertTrue(configString.contains("policy='" + HigherHitsMergePolicy.class.getName() + "'"));
        assertTrue(configString.contains("batchSize=2342"));
    }
