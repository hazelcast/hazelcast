...
import static com.hazelcast.client.config.XmlClientFailoverConfigBuilderTest.HAZELCAST_CLIENT_FAILOVER_START_TAG;
...
public class SchemaValidationSkippingTest {
    ...
    @Test
    public void testSkipping_Member_Yaml_SchemaValidation() {
        YamlConfigBuilderTest.buildConfig(INVALID_YAML);
    }
