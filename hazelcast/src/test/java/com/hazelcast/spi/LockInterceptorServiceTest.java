...
public class LockInterceptorServiceTest extends HazelcastTestSupport {
    ...
    private static final ConcurrentMap<String, AtomicInteger> LOCK_COUNTER = new ConcurrentHashMap<String, AtomicInteger>();
    ...
    public static class LockInterceptingService implements LockInterceptorService<Data>, ManagedService {
        ...
        public void onBeforeLock(String distributedObjectName, Data key) {
            ...
            AtomicInteger counter = getOrPutIfAbsent(LOCK_COUNTER, stringKey, new ConstructorFunction<String, AtomicInteger>() {
                @Override
                public AtomicInteger createNew(String arg) {
