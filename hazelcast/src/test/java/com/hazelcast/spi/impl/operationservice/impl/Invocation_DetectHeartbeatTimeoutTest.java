...
import static com.hazelcast.spi.impl.operationservice.impl.Invocation.HeartbeatTimeout.NO__CALL_TIMEOUT_DISABLED;
import static com.hazelcast.spi.impl.operationservice.impl.Invocation.HeartbeatTimeout.NO__CALL_TIMEOUT_NOT_EXPIRED;
import static com.hazelcast.spi.impl.operationservice.impl.Invocation.HeartbeatTimeout.NO__HEARTBEAT_TIMEOUT_NOT_EXPIRED;
import static com.hazelcast.spi.impl.operationservice.impl.Invocation.HeartbeatTimeout.NO__RESPONSE_AVAILABLE;
import static com.hazelcast.spi.impl.operationservice.impl.Invocation.HeartbeatTimeout.YES;
...
public class Invocation_DetectHeartbeatTimeoutTest extends HazelcastTestSupport {
    ...
    public void whenCallTimeoutDisabled() {
        ...
        config.setProperty(OPERATION_CALL_TIMEOUT_MILLIS, "1000");
        ...
        assertEquals(Long.MAX_VALUE, invocation.callTimeout);
        assertEquals(NO__CALL_TIMEOUT_DISABLED, invocation.detectTimeout(SECONDS.toMillis(1)));
    ...
    public void whenResponseAvailable() {
        ...
        assertEquals(NO__RESPONSE_AVAILABLE, invocation.detectTimeout(SECONDS.toMillis(1)));
        assertFalse(f.isDone());
    }
    ...
    public void whenCallTimeoutNotExpired() {
        ...
        assertEquals(NO__CALL_TIMEOUT_NOT_EXPIRED, invocation.detectTimeout(SECONDS.toMillis(1)));
        assertFalse(f.isDone());
    }
    ...
    public void whenCallTimeoutExpired_ButOperationHeartbeatHasNot() {
        ...
        assertDetectHeartbeatTimeoutEventually(f.invocation, NO__HEARTBEAT_TIMEOUT_NOT_EXPIRED);
    }
    ...
    public void whenExpiresEventually() {
        ...
        assertDetectHeartbeatTimeoutEventually(invocation, NO__CALL_TIMEOUT_NOT_EXPIRED);
        assertDetectHeartbeatTimeoutEventually(invocation, NO__HEARTBEAT_TIMEOUT_NOT_EXPIRED);
        assertDetectHeartbeatTimeoutEventually(invocation, YES);
    }
