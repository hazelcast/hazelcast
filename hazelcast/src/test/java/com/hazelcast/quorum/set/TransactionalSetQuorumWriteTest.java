...
public class TransactionalSetQuorumWriteTest extends AbstractSetQuorumTest {
    ...
    public void txAdd_successful_whenQuorumSize_met() {
        ...
        TransactionalSet<Object> list = transactionContext.getSet(SET_NAME + quorumType.name());
        list.add("foo");
