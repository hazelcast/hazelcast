...
import static com.hazelcast.nio.serialization.impl.PortableValueReaderTestStructure.GroupPortable;
import static com.hazelcast.nio.serialization.impl.PortableValueReaderTestStructure.NestedGroupPortable;
import static com.hazelcast.nio.serialization.impl.PortableValueReaderTestStructure.PrimitiveFields;
import static com.hazelcast.nio.serialization.impl.PortableValueReaderTestStructure.PrimitiveFields.getPrimitiveArrays;
import static com.hazelcast.nio.serialization.impl.PortableValueReaderTestStructure.PrimitiveFields.getPrimitives;
import static com.hazelcast.nio.serialization.impl.PortableValueReaderTestStructure.PrimitivePortable;
import static com.hazelcast.nio.serialization.impl.PortableValueReaderTestStructure.PrimitivePortable.Init.FULL;
import static com.hazelcast.nio.serialization.impl.PortableValueReaderTestStructure.PrimitivePortable.Init.NONE;
import static com.hazelcast.nio.serialization.impl.PortableValueReaderTestStructure.PrimitivePortable.Init.NULL;
import static com.hazelcast.nio.serialization.impl.PortableValueReaderTestStructure.TestPortableFactory;
import static com.hazelcast.nio.serialization.impl.PortableValueReaderTestStructure.group;
import static com.hazelcast.nio.serialization.impl.PortableValueReaderTestStructure.nested;
import static com.hazelcast.nio.serialization.impl.PortableValueReaderTestStructure.prim;
...
public class PortableValueReaderSpecTest extends HazelcastTestSupport {
    ...
    public PortableValueReaderSpecTest(Portable inputObject, Object expectedResult, String pathToRead, String parent) {
    ...
    private static Collection<Object[]> expandPrimitiveArrayScenario(Portable input, PrimitivePortable result,
        ...
        List<Object[]> scenarios = new ArrayList<>();
        // group A:
        for (PortableValueReaderTestStructure.PrimitiveFields primitiveFields : getPrimitiveArrays()) {
        ...
        // group B:
        for (PortableValueReaderTestStructure.PrimitiveFields primitiveFields : getPrimitives()) {
    ...
    private static void fromPortableArrayToPortableArrayToPrimitiveScenarios(List<Object[]> result) {
        ...
        result.addAll(asList(
                ...
                scenario(nestedFullGroup, new Portable[]{prim(1, FULL)},
    ...
    public InternalValueReader reader(Portable portable) throws IOException {
        ...
        return ss.createPortableValueReader(processor.stolenEntryData);
    }
