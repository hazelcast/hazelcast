...
public class LoadTrackerTest {
    ...
    public void testUpdateImbalance() throws Exception {
        NioPipeline selector1Handler1 = mock(NioPipeline.class);
        ...
        NioPipeline selector2Handler1 = mock(NioPipeline.class);
        ...
        NioPipeline selector2Handler3 = mock(NioPipeline.class);
    ...
    public void testUpdateImbalance_notUsingSingleHandlerSelectorAsSource() throws Exception {
        ...
        NioPipeline selector2Handler = mock(NioPipeline.class);
        ...
        NioPipeline selector2Handler2 = mock(NioPipeline.class);
