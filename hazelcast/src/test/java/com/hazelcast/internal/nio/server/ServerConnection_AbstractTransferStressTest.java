...
public abstract class ServerConnection_AbstractTransferStressTest extends ServerConnection_AbstractTest {
    ...
    private void testPackets(long verifyTimeoutInMillis) {
        ...
        final ServerConnection connection = connect(networkingServiceB, addressA);
    ...
    private int totalFramesPending(ServerConnection connection) {
    ...
    private long framesRead(ServerConnection connection, boolean priority) {
        Channel channel = connection.getChannel();
        if (channel instanceof NioChannel) {
    ...
    public class WriteThread extends TestThread {
        ...
        public WriteThread(int id, ServerConnection c) {
