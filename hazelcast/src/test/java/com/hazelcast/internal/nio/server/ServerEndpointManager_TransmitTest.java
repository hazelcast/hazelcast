...
public class ServerEndpointManager_TransmitTest
    ...
    public void withConnection_whenNullPacket() {
        ...
        ServerConnection connection = connect(networkingServiceA, addressB);
    ...
    public void withConnection_whenNullConnection() {
        ...
        boolean result = networkingServiceA.getEndpointManager(MEMBER).transmit(packet, (ServerConnection) null);
