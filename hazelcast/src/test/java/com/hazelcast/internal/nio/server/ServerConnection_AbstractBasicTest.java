...
public abstract class ServerConnection_AbstractBasicTest extends ServerConnection_AbstractTest {
    ...
    public void lastReadTimeMillis() {
        ServerConnection connAB = connect(networkingServiceA, addressB);
        ServerConnection connBA = connect(networkingServiceB, addressA);
    ...
    public void test_equals() {
        ServerConnection connAB = connect(networkingServiceA, addressB);
        ServerConnection connAC = connect(networkingServiceA, addressC);
