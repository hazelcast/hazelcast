...
public enum ConfigProperty {
    ...
    FIRST_MEMBER_WAIT_SECONDS("hazelcast.first.member.wait.seconds", "0"),
    RESTART_ON_MAX_IDLE("hazelcast.restart.on.max.idle", "false"),
    ...
    LOG_STATE("hazelcast.log.state", "false");
