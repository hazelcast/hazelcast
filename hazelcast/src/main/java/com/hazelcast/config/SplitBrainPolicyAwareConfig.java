...
public interface SplitBrainPolicyAwareConfig {
    ...
    /**
     * Gets the {@link MergePolicyConfig} for the data structure.
     *
     * @return the {@link MergePolicyConfig} for the data structure
     */
    MergePolicyConfig getMergePolicyConfig();

    /**
     * Sets the {@link MergePolicyConfig} for the data structure.
     *
     * @return this configuration
     */
