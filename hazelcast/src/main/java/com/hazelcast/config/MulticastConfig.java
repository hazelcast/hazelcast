...
public class MulticastConfig {
    ...
    /**
     * Whether the multicast client discovery mechanism has been enabled
     */
    public static final boolean DEFAULT_CLIENT_DISCOVERY_ENABLED = false;
    /**
    ...
    private boolean clientDiscoveryEnabled = DEFAULT_CLIENT_DISCOVERY_ENABLED;
    ...
    /**
     * Check if the multicast client discovery mechanism has been enabled.
     *
     * @return the enabled
     */
    public boolean isClientDiscoveryEnabled() {
        return clientDiscoveryEnabled;
    }
     ...
     * @return the updated MulticastConfig
     */
    public MulticastConfig setClientDiscoveryEnabled(boolean enabled) {
        this.clientDiscoveryEnabled = enabled;
        return this;
    }
