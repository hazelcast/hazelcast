 ...
 * CacheProxy operations serializer are defined in here. This factory class is used by internal serialization system to create
 * IdentifiedDataSerializable classes without using reflection.
 */
