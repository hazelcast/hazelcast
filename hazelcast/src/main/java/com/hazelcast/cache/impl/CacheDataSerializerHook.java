...
public final class CacheDataSerializerHook
    ...
    public static final short ENTRY_ITERATOR = 38;
    public static final short ENTRY_ITERATION_RESULT = 39;
    public static final short CACHE_PARTITION_LOST_EVENT_FILTER = 40;
    public static final short DEFAULT_CACHE_ENTRY_VIEW = 41;
    public static final short CACHE_REPLICATION = 42;
    public static final short CACHE_POST_JOIN = 43;
    public static final short CACHE_DATA_RECORD = 44;
    public static final short CACHE_OBJECT_RECORD = 45;
    public static final short CACHE_PARTITION_EVENT_DATA = 46;

    public static final short CACHE_INVALIDATION_METADATA = 47;
    public static final short CACHE_INVALIDATION_METADATA_RESPONSE = 48;
    public static final short CACHE_ASSIGN_AND_GET_UUIDS = 49;
    public static final short CACHE_ASSIGN_AND_GET_UUIDS_FACTORY = 50;
    public static final short CACHE_NEAR_CACHE_STATE_HOLDER = 51;
    public static final short CACHE_EVENT_LISTENER_ADAPTOR = 52;
    public static final short EVENT_JOURNAL_SUBSCRIBE_OPERATION = 53;
    public static final short EVENT_JOURNAL_READ_OPERATION = 54;
    public static final short EVENT_JOURNAL_DESERIALIZING_CACHE_EVENT = 55;
    public static final short EVENT_JOURNAL_INTERNAL_CACHE_EVENT = 56;
    public static final short EVENT_JOURNAL_READ_RESULT_SET = 57;
    public static final int PRE_JOIN_CACHE_CONFIG = 58;
    public static final int CACHE_BROWSER_ENTRY_VIEW = 59;
    public static final int GET_CACHE_ENTRY_VIEW_PROCESSOR = 60;

    public static final int MERGE_FACTORY = 61;
    public static final int MERGE = 62;
    public static final int ADD_CACHE_CONFIG_OPERATION = 63;
    public static final int SET_EXPIRY_POLICY = 64;
    public static final int SET_EXPIRY_POLICY_BACKUP = 65;
    public static final int EXPIRE_BATCH_BACKUP = 66;
    public static final int CACHE_DESTROY_EVENT_CONTEXT = 67;
