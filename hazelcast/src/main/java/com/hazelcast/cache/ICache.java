 ...
 * additional operations to support a broader range of programming styles.<p>
 *
 * There are three different types of extension methods provided:
 * <ul>
 ...
 * <b>Split-brain</b>
 * <p>
 * Behavior of {@link ICache} under split-brain scenarios should be taken into account when using this
 ...
 * <p>
 * As a defense mechanism against such inconsistency, consider using the in-built
...
public interface ICache<K, V>
     ...
     * {@link java.lang.ClassCastException} as the operation's result if the {@link javax.cache.Cache}
     ...
     * <p>
     * In case a previous assignment already exists, the previous value is overridden by
     * the newly given value and the previous value is returned to the caller. This is
