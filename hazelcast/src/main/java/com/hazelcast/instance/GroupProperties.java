...
public class GroupProperties {
    ...
    public static final String PROP_PARTITION_STRATEGY_CLASS = "hazelcast.partition.strategy.class";
    ...
    public final GroupProperty PARTITION_STRATEGY_CLASS;
    ...
    public GroupProperties(Config config) {
        ...
        PARTITION_STRATEGY_CLASS = new GroupProperty(config, PROP_PARTITION_STRATEGY_CLASS, PartitionAwarePartitionStrategy.class.getName());
