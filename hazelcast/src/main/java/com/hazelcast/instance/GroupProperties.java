...
public class GroupProperties {
    ...
    public static final String PROP_ENTRYPROCESSOR_BATCH_MAX_SIZE = "hazelcast.entryprocessor.batch.max.size";
    public static final String PROP_ENTRYPROCESSOR_BATCH_MAX_TIME_MILLIS = "hazelcast.entryprocessor.batch.max.time.millis";
    ...
    public final GroupProperty ENTRYPROCESSOR_BATCH_MAX_SIZE;
    public final GroupProperty ENTRYPROCESSOR_BATCH_MAX_TIME_MILLIS;
    ...
    public GroupProperties(Config config) {
        ...
        ENTRYPROCESSOR_BATCH_MAX_SIZE = new GroupProperty(config, PROP_ENTRYPROCESSOR_BATCH_MAX_SIZE, "10000");
        ENTRYPROCESSOR_BATCH_MAX_TIME_MILLIS = new GroupProperty(config, PROP_ENTRYPROCESSOR_BATCH_MAX_TIME_MILLIS, "2000");
