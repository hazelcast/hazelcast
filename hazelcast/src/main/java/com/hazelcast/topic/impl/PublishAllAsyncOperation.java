 ...
 */
public class PublishAllAsyncOperation extends AbstractNamedOperation
        implements IdentifiedDataSerializable {

    private Data[] messages;

    public PublishAllAsyncOperation() {
    }

    @SuppressFBWarnings("EI_EXPOSE_REP")
    public PublishAllAsyncOperation(String name, Data[] messages) {
        super(name);
