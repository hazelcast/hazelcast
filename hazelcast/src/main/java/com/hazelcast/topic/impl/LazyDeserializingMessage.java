...
public class LazyDeserializingMessage extends Message<Object> {
    ...
    public LazyDeserializingMessage(String topicName, Data messageData, long publishTime, Member publishingMember,
