...
public class CPMapPermission extends InstancePermission {
    private static final int PUT = 4;
    private static final int REMOVE = 8;
    private static final int READ = 16;
    private static final int ALL = CREATE | DESTROY | PUT | REMOVE | READ;

    public CPMapPermission(String name, String... actions) {
        super(name, actions);
    }
