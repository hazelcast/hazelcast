...
public class VectorCollectionPermission extends InstancePermission {
    private static final int PUT = 4;
    private static final int REMOVE = 8;
    private static final int READ = 16;
    private static final int OPTIMIZE = 32;
    private static final int ALL = CREATE | DESTROY | PUT | REMOVE | READ | OPTIMIZE;

    public VectorCollectionPermission(String name, String... actions) {
        super(name, actions);
    }
    ...
    protected int initMask(String[] actions) {
        ...
        for (String action : actions) {
            ...
            if (ActionConstants.ACTION_CREATE.equals(action)) {
                ...
                mask |= READ;
            } else if (ActionConstants.ACTION_OPTIMIZE.equals(action)) {
                mask |= OPTIMIZE;
            }
        }
        return mask;
