...
public interface Ringbuffer<E> {
    ...
    /**
     * Merges the given {@link RingbufferMergeTypes} with the given {@link SplitBrainMergePolicy}.
     *
     ...
     */
    long merge(RingbufferMergeTypes mergingEntry, SplitBrainMergePolicy<Object, RingbufferMergeTypes> mergePolicy,
