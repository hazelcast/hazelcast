...
public class HeadSequenceRequest extends RingbufferRequest {

    public HeadSequenceRequest() {
    }

    public HeadSequenceRequest(String name) {
        super(name);
    }

    @Override
    protected Operation prepareOperation() {
        return new GenericOperation(name, OPERATION_HEAD);
    }

    @Override
    public int getClassId() {
        return RingbufferPortableHook.HEAD_SEQUENCE;
    }
