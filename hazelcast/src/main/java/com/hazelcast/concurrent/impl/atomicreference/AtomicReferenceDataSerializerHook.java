...
package com.hazelcast.concurrent.impl.atomicreference;

import com.hazelcast.concurrent.impl.atomicreference.operations.AlterAndGetOperation;
import com.hazelcast.concurrent.impl.atomicreference.operations.AlterOperation;
import com.hazelcast.concurrent.impl.atomicreference.operations.ApplyOperation;
import com.hazelcast.concurrent.impl.atomicreference.operations.AtomicReferenceReplicationOperation;
import com.hazelcast.concurrent.impl.atomicreference.operations.CompareAndSetOperation;
import com.hazelcast.concurrent.impl.atomicreference.operations.ContainsOperation;
import com.hazelcast.concurrent.impl.atomicreference.operations.GetAndAlterOperation;
import com.hazelcast.concurrent.impl.atomicreference.operations.GetAndSetOperation;
import com.hazelcast.concurrent.impl.atomicreference.operations.GetOperation;
import com.hazelcast.concurrent.impl.atomicreference.operations.IsNullOperation;
import com.hazelcast.concurrent.impl.atomicreference.operations.SetAndGetOperation;
import com.hazelcast.concurrent.impl.atomicreference.operations.SetBackupOperation;
import com.hazelcast.concurrent.impl.atomicreference.operations.SetOperation;
