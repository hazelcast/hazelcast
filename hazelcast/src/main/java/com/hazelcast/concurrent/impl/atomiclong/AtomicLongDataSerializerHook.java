...
package com.hazelcast.concurrent.impl.atomiclong;

import com.hazelcast.concurrent.impl.atomiclong.operations.AddAndGetOperation;
import com.hazelcast.concurrent.impl.atomiclong.operations.AddBackupOperation;
import com.hazelcast.concurrent.impl.atomiclong.operations.AlterAndGetOperation;
import com.hazelcast.concurrent.impl.atomiclong.operations.AlterOperation;
import com.hazelcast.concurrent.impl.atomiclong.operations.ApplyOperation;
import com.hazelcast.concurrent.impl.atomiclong.operations.AtomicLongReplicationOperation;
import com.hazelcast.concurrent.impl.atomiclong.operations.CompareAndSetOperation;
import com.hazelcast.concurrent.impl.atomiclong.operations.GetAndAddOperation;
import com.hazelcast.concurrent.impl.atomiclong.operations.GetAndAlterOperation;
import com.hazelcast.concurrent.impl.atomiclong.operations.GetAndSetOperation;
import com.hazelcast.concurrent.impl.atomiclong.operations.GetOperation;
import com.hazelcast.concurrent.impl.atomiclong.operations.SetBackupOperation;
import com.hazelcast.concurrent.impl.atomiclong.operations.SetOperation;
