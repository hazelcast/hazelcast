...
import com.hazelcast.concurrent.impl.lock.operations.AwaitBackupOperation;
import com.hazelcast.concurrent.impl.lock.operations.AwaitOperation;
import com.hazelcast.concurrent.impl.lock.operations.BeforeAwaitBackupOperation;
import com.hazelcast.concurrent.impl.lock.operations.BeforeAwaitOperation;
import com.hazelcast.concurrent.impl.lock.operations.GetLockCountOperation;
import com.hazelcast.concurrent.impl.lock.operations.GetRemainingLeaseTimeOperation;
import com.hazelcast.concurrent.impl.lock.operations.IsLockedOperation;
import com.hazelcast.concurrent.impl.lock.operations.LockBackupOperation;
import com.hazelcast.concurrent.impl.lock.operations.LockOperation;
import com.hazelcast.concurrent.impl.lock.operations.LockReplicationOperation;
import com.hazelcast.concurrent.impl.lock.operations.SignalBackupOperation;
import com.hazelcast.concurrent.impl.lock.operations.SignalOperation;
import com.hazelcast.concurrent.impl.lock.operations.UnlockBackupOperation;
