...
import com.hazelcast.jet.sql.impl.expression.CaseExpression;
...
import com.hazelcast.jet.sql.impl.expression.datetime.ExtractFunction;
import com.hazelcast.jet.sql.impl.expression.datetime.ToEpochMillisFunction;
import com.hazelcast.jet.sql.impl.expression.datetime.ToTimestampTzFunction;
import com.hazelcast.jet.sql.impl.expression.math.AbsFunction;
import com.hazelcast.jet.sql.impl.expression.math.DivideFunction;
import com.hazelcast.jet.sql.impl.expression.math.DoubleBiFunction;
import com.hazelcast.jet.sql.impl.expression.math.DoubleFunction;
import com.hazelcast.jet.sql.impl.expression.math.FloorCeilFunction;
import com.hazelcast.jet.sql.impl.expression.math.MinusFunction;
import com.hazelcast.jet.sql.impl.expression.math.MultiplyFunction;
import com.hazelcast.jet.sql.impl.expression.math.PlusFunction;
import com.hazelcast.jet.sql.impl.expression.math.RandFunction;
import com.hazelcast.jet.sql.impl.expression.math.RemainderFunction;
import com.hazelcast.jet.sql.impl.expression.math.RoundTruncateFunction;
import com.hazelcast.jet.sql.impl.expression.math.SignFunction;
import com.hazelcast.jet.sql.impl.expression.math.UnaryMinusFunction;
import com.hazelcast.jet.sql.impl.expression.predicate.AndPredicate;
import com.hazelcast.jet.sql.impl.expression.predicate.ComparisonPredicate;
import com.hazelcast.jet.sql.impl.expression.predicate.IsFalsePredicate;
import com.hazelcast.jet.sql.impl.expression.predicate.IsNotFalsePredicate;
import com.hazelcast.jet.sql.impl.expression.predicate.IsNotNullPredicate;
import com.hazelcast.jet.sql.impl.expression.predicate.IsNotTruePredicate;
import com.hazelcast.jet.sql.impl.expression.predicate.IsNullPredicate;
import com.hazelcast.jet.sql.impl.expression.predicate.IsTruePredicate;
import com.hazelcast.jet.sql.impl.expression.predicate.NotPredicate;
import com.hazelcast.jet.sql.impl.expression.predicate.OrPredicate;
import com.hazelcast.jet.sql.impl.expression.string.AsciiFunction;
import com.hazelcast.jet.sql.impl.expression.string.CharLengthFunction;
import com.hazelcast.jet.sql.impl.expression.string.ConcatFunction;
import com.hazelcast.jet.sql.impl.expression.string.ConcatWSFunction;
import com.hazelcast.jet.sql.impl.expression.string.InitcapFunction;
import com.hazelcast.jet.sql.impl.expression.string.LikeFunction;
import com.hazelcast.jet.sql.impl.expression.string.LowerFunction;
import com.hazelcast.jet.sql.impl.expression.string.PositionFunction;
import com.hazelcast.jet.sql.impl.expression.string.ReplaceFunction;
import com.hazelcast.jet.sql.impl.expression.string.SubstringFunction;
import com.hazelcast.jet.sql.impl.expression.string.TrimFunction;
import com.hazelcast.jet.sql.impl.expression.string.UpperFunction;
