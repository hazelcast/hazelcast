 ...
 * MAX expression.
 */
public class MaxAggregateExpression extends AbstractSingleOperandAggregateExpression<Comparable<?>> {
    public MaxAggregateExpression() {
        // No-op.
    }

    private MaxAggregateExpression(Expression<?> operand, QueryDataType resType, boolean distinct) {
        super(operand, resType, distinct);
    }

    public static MaxAggregateExpression create(Expression<?> operand, boolean distinct) {
