...
/**
 * Common class for data exchange operations (batches, flow control).
 */
public abstract class QueryDataExchangeOperation extends QueryIdAwareOperation {
    /** Edge ID. */
    protected int edgeId;

    public QueryDataExchangeOperation() {
        // No-op.
    }

    public QueryDataExchangeOperation(long epochWatermark, QueryId queryId, int edgeId) {
