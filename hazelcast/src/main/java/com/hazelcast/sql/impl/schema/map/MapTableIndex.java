...
public class MapTableIndex {
    ...
    /** Query path of the fields in the owning table. */
    private final List<QueryPath> fieldQueryPaths;
    ...
    public MapTableIndex(
            ...
            List<QueryPath> fieldsQueryPaths,
        ...
        this.fieldQueryPaths = fieldsQueryPaths;
    ...
    public List<QueryPath> getFieldQueryPaths() {
    ...
    public boolean equals(Object o) {
        ...
        return componentsCount == index.componentsCount
                ...
                && fieldQueryPaths.equals(index.fieldQueryPaths)
    ...
    public int hashCode() {
        ...
        result = 31 * result + fieldQueryPaths.hashCode();
    ...
    public String toString() {
        return "MapTableIndex {name='" + name + '\'' + ", type=" + type + ", componentsCount=" + componentsCount
                ...
                + ", fieldQueryPaths=" + fieldQueryPaths
                + ", fieldConverterTypes=" + fieldConverterTypes + '}';
    }
}
