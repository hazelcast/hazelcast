...
/**
 * Snapshot of a {@link AtomicLongService} state for a Raft group
 */
public class AtomicLongSnapshot extends RaftAtomicValueSnapshot<Long> implements IdentifiedDataSerializable {
    ...
    public AtomicLongSnapshot(Map<String, Long> longs, Set<String> destroyed) {
    ...
    public String toString() {
        return "AtomicLongSnapshot{" + "longs=" + values + ", destroyed=" + destroyed + '}';
    }
}
