...
public interface CPSubsystem {
     ...
     * <p>
     *     If no group name is given within the {@code name} parameter, then the {@link CPMap} instance will be created on the
     *     DEFAULT CP group. If a group name is given, like {@code .getMap("myMap@group1")}, the given group will be initialized
     *     first, if not initialized already, and then the {@link CPMap} instance will be created on this group. The returned
     *     {@link CPMap} instance offers linearizability. When a network partition occurs, proxies that exist on the minority side
     *     of its CP group lose availability.
     * </p>
     * <p>
     *     <strong>Each call of this method performs a commit to the METADATA CP group. Hence, callers should cache the
     *     returned proxy.</strong>
     * </p>
