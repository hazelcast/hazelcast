...
//
//        public String name() {
////            return owner.getLockAddress() + ":" + owner.getLockThreadId();  //TODO @msk ???
...
////                    owner.getLockThreadId() == vertex.owner.getLockThreadId()) : vertex.owner != null) return false; //TODO @msk ???
//            if (owner != null ? !owner.getKey().equals(vertex.owner.getKey())  : vertex.owner != null) return false;
//            return true;
//        }
//
//        @Override
