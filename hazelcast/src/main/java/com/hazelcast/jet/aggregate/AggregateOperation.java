 ...
 * processing. Check out {@code AggregateOperations} to find the one
 * you need and, if you don't find it there, construct one by using the
 * {@code #withCreate aggregate operation builder} and reading the
 * description below.
 * <p>
 ...
 * aggregating pipeline stage using the {@code StageWithKeyAndWindow#aggregateBuilder
 ...
 * as {@code StageWithKeyAndWindow#aggregate2
 * stage.aggregate2()}, then you'll deal with specializations of this interface
 * such as {@code AggregateOperation2} and you'll identify the input stages by
 ...
 * </li></ol>
 *
 * All the functions must be stateless and {@code
...
public interface AggregateOperation<A, R> extends Serializable {
     ...
     * <p>
     * The supplier must be stateless and {@code Processor#isCooperative()
     * cooperative}.
     */
    @Nonnull
     ...
     * <p>
     * The function must be stateless and {@code Processor#isCooperative()
     * cooperative}.
     */
    @Nonnull
     ...
     * <p>
     * The functions must be stateless and {@code
     * Processor#isCooperative() cooperative}.
     */
    @Nonnull
     ...
     */
    @Nonnull
    <T> AggregateOperation1<T, A, R> withCombiningAccumulateFn(@Nonnull FunctionEx<T, A> getAccFn);
     ...
     * <p>
     * The given function must be stateless and {@code
     * Processor#isCooperative() cooperative}.
     *
