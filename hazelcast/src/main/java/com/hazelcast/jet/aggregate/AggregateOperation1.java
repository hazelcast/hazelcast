 ...
 * a single data stream being aggregated over. {@code AggregateOperations}
 * contains factories for the built-in implementations and you can create
 * your own using the {@code  AggregateOperation#withCreate aggregate
 * operation builder}.
 * <p>
...
public interface AggregateOperation1<T, A, R> extends AggregateOperation<A, R> {
     ...
     * item.
     * <p>
     * The consumer must be stateless and {@code  Processor#isCooperative()
     * cooperative}.
     */
    @Nonnull
