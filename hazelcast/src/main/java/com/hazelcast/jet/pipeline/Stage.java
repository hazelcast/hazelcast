...
public interface Stage {
     ...
     * com.hazelcast.jet.core.ProcessorMetaSupplier#LOCAL_PARALLELISM_USE_DEFAULT}
     * and it signals to Jet to figure out a default value. Jet will determine
     * the vertex's local parallelism during job initialization from the global
     * default and the processor meta-supplier's preferred value.
     *
     * @return this stage
     */
    @Nonnull
