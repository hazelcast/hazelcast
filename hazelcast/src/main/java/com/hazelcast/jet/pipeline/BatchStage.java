...
public interface BatchStage<T> extends GeneralStage<T> {
    ...
    /**
     * Extension of {@link BatchStage} providing additional capabilities
     ...
     * @param <S> the type implementing additional methods for {@link BatchStage}
     *
     ...
     * {@code S} to extend {@link BatchStage}. Single extension class can be
    ...
    interface StageExtension<T, S> {
         ...
         *
         * @param batchStage stage to be extended
         ...
         */
        @Nonnull
        S extend(@Nonnull BatchStage<T> batchStage);
    }
