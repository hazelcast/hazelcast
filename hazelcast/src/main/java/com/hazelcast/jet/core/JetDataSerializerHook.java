...
public final class JetDataSerializerHook implements DataSerializerHook {
    ...
    public static final int PARALLELISM_ON_SINGLE_MEMBER_PROCESSOR_META_SUPPLIER = 21;
    ...
    private static class Factory implements DataSerializableFactory {
        ...
        public IdentifiedDataSerializable create(int typeId) {
            switch (typeId) {
                ...
                case PARALLELISM_ON_SINGLE_MEMBER_PROCESSOR_META_SUPPLIER:
                    return new ProcessorMetaSupplier.ParallelismOnRandomMemberPms();
                default:
