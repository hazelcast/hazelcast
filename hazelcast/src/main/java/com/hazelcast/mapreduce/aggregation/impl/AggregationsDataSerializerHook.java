...
public class AggregationsDataSerializerHook
    ...
    public static final int COUNT_COMBINER_FACTORY = 23;
    public static final int COUNT_REDUCER_FACTORY = 24;
    public static final int DISTINCT_VALUES_COMBINER_FACTORY = 25;
    public static final int DISTINCT_VALUES_REDUCER_FACTORY = 26;
    public static final int DOUBLE_AVG_COMBINER_FACTORY = 27;
    public static final int DOUBLE_AVG_REDUCER_FACTORY = 28;
    public static final int DOUBLE_MAX_COMBINER_FACTORY = 29;
    public static final int DOUBLE_MAX_REDUCER_FACTORY = 30;
    public static final int DOUBLE_MIN_COMBINER_FACTORY = 31;
    public static final int DOUBLE_MIN_REDUCER_FACTORY = 32;
    public static final int DOUBLE_SUM_COMBINER_FACTORY = 33;
    public static final int DOUBLE_SUM_REDUCER_FACTORY = 34;
    public static final int INTEGER_AVG_COMBINER_FACTORY = 35;
    public static final int INTEGER_AVG_REDUCER_FACTORY = 36;
    public static final int INTEGER_MAX_COMBINER_FACTORY = 37;
    public static final int INTEGER_MAX_REDUCER_FACTORY = 38;
    public static final int INTEGER_MIN_COMBINER_FACTORY = 39;
    public static final int INTEGER_MIN_REDUCER_FACTORY = 40;
    public static final int INTEGER_SUM_COMBINER_FACTORY = 41;
    public static final int INTEGER_SUM_REDUCER_FACTORY = 42;
    public static final int LONG_AVG_COMBINER_FACTORY = 43;
    public static final int LONG_AVG_REDUCER_FACTORY = 44;
    public static final int LONG_MAX_COMBINER_FACTORY = 45;
    public static final int LONG_MAX_REDUCER_FACTORY = 46;
    public static final int LONG_MIN_COMBINER_FACTORY = 47;
