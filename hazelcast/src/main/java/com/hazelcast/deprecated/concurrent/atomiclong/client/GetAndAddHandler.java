...
public class GetAndAddHandler extends AtomicLongCommandHandler {
    public GetAndAddHandler(AtomicLongService atomicLongService) {
    ...
    public Protocol processCall(Node node, Protocol protocol) {
        ...
        long result = proxy.getAndAdd(delta);
