...
public class DrainPermitsHandler extends SemaphoreCommandHandler {
    public DrainPermitsHandler(SemaphoreService semaphoreService) {
    ...
    public Protocol processCall(Node node, Protocol protocol) {
        ...
        return protocol.success(String.valueOf(sp.drainPermits()));
    }
}
