...
public class InitHandler extends SemaphoreCommandHandler {
    public InitHandler(SemaphoreService semaphoreService) {
    ...
    public Protocol processCall(Node node, Protocol protocol) {
        ...
        boolean result = sp.init(Integer.valueOf(protocol.args[1]));
