...
public abstract class BaseTxRemoveOperation extends TransactionalMapOperation implements BackupAwareOperation {

    protected transient Data dataOldValue;

    public BaseTxRemoveOperation() {
    }

    protected BaseTxRemoveOperation(String name, Data dataKey) {
        super(name, dataKey);
    }

    protected BaseTxRemoveOperation(String name, Data dataKey, Data dataValue) {
