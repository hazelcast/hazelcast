...
public class MapForceUnlockRequest extends AbstractClientRequest implements ClientRequest {

    private String name;
    private Data key;

    public MapForceUnlockRequest() {
    }

    public MapForceUnlockRequest(String name, Data key) {
        this.name = name;
        this.key = key;
    }
    ...
    public Object process() throws Exception {
        ...
        UnlockOperation op = new UnlockOperation(namespace, key, -1, true);
    ...
    public int getClassId() {
        return MapPortableHook.FORCE_UNLOCK;
    }
