...
public interface MapOperationProvider {
    ...
    MapOperation createMergeOperation(String name, KeyMergeDataHolder<Data, Data> mergeDataHolder, SplitBrainMergePolicy policy,
                                      boolean disableWanReplicationEvent);
    ...
    OperationFactory createMergeOperationFactory(String name, int[] partitions,
                                                 List<KeyMergeDataHolder<Data, Data>>[] mergeData,
