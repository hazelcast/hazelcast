...
public class NearCachedMapProxyImpl<K, V> extends MapProxyImpl<K, V> {
    ...
    @Override
    protected void createPutAllOperationFactory(Address address, long size, int[] partitions, MapEntries[] entries)
            throws Exception {
        ...
        super.createPutAllOperationFactory(address, size, partitions, entries);
    }
