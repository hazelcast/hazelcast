...
public abstract class AbstractEvictableRecordStore extends AbstractRecordStore {
    ...
    protected AbstractEvictableRecordStore(MapContainer mapContainer, int partitionId) {
        ...
        this.expirationManager = mapServiceContext.getExpirationManager();
    ...
    private void invalidateNearCache(Data key) {
        ...
        //source-uuid is used not to apply one invalidation twice to the
        //original caller. But, in this case, we shouldn't use any valid
        //source-uuid since invalidations are generated by the expiration system
        //and all near-caches should be invalidated. Instead we are passing "NA"
        //as source-uuid.
        invalidator.invalidateKey(key, name, "NA");
    }
