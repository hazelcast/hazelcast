...
public interface MapServiceContext extends MapServiceContextInterceptorSupport,
    ...
    Future<UUID> addListenerAdapter(ListenerAdapter listenerAdaptor, EventFilter eventFilter, String mapName);

    Future<UUID> addLocalListenerAdapter(ListenerAdapter listenerAdaptor, String mapName);
