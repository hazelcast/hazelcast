...
public final class MapDataSerializerHook implements DataSerializerHook {
    ...
    public static final int NEAR_CACHE_SINGLE_INVALIDATION = 35;
    public static final int NEAR_CACHE_BATCH_INVALIDATION = 36;
    public static final int IS_PARTITION_LOADED = 37;
    public static final int PARTITION_WIDE_ENTRY = 38;
    public static final int PARTITION_WIDE_ENTRY_BACKUP = 39;
    public static final int PARTITION_WIDE_PREDICATE_ENTRY = 40;
    public static final int PARTITION_WIDE_PREDICATE_ENTRY_BACKUP = 41;
    public static final int ADD_INDEX = 42;
    public static final int AWAIT_MAP_FLUSH = 43;
    public static final int CONTAINS_VALUE = 44;
    public static final int GET_ENTRY_VIEW = 45;
    public static final int FETCH_ENTRIES = 46;
    public static final int FETCH_KEYS = 47;
    public static final int FLUSH_BACKUP = 48;
    public static final int FLUSH = 49;
    public static final int MULTIPLE_ENTRY_BACKUP = 50;
    public static final int MULTIPLE_ENTRY = 51;
    public static final int MULTIPLE_ENTRY_PREDICATE_BACKUP = 52;
    public static final int MULTIPLE_ENTRY_PREDICATE = 53;
    public static final int NOTIFY_MAP_FLUSH = 54;
    public static final int PUT_IF_ABSENT = 55;
    public static final int PUT_FROM_LOAD_ALL = 56;
    public static final int PUT_FROM_LOAD_ALL_BACKUP = 57;
    public static final int QUERY_PARTITION = 58;
    public static final int QUERY_OPERATION = 59;
    public static final int PUT_TRANSIENT = 60;
    public static final int REPLACE_IF_SAME = 61;
    public static final int TRY_PUT = 62;
    public static final int TRY_REMOVE = 63;
    public static final int TXN_LOCK_AND_GET = 64;
    public static final int TXN_DELETE = 65;
    public static final int TXN_PREPARE = 66;
    public static final int TXN_PREPARE_BACKUP = 67;
    public static final int TXN_ROLLBACK = 68;
    public static final int TXN_ROLLBACK_BACKUP = 69;
    public static final int TXN_SET = 70;
    public static final int TXN_UNLOCK = 71;
    public static final int TXN_UNLOCK_BACKUP = 72;
    public static final int IS_PARTITION_LOADED_FACTORY = 73;
    public static final int ADD_INDEX_FACTORY = 74;
    public static final int CLEAR_FACTORY = 75;
    public static final int CONTAINS_VALUE_FACTORY = 76;
    public static final int EVICT_ALL_FACTORY = 77;
    public static final int IS_EMPTY_FACTORY = 78;
    public static final int KEY_LOAD_STATUS_FACTORY = 79;
    public static final int MAP_FLUSH_FACTORY = 80;
    public static final int MAP_GET_ALL_FACTORY = 81;
    public static final int LOAD_ALL_FACTORY = 82;
    public static final int PARTITION_WIDE_ENTRY_FACTORY = 83;
    public static final int PARTITION_WIDE_PREDICATE_ENTRY_FACTORY = 84;
    public static final int PUT_ALL_PARTITION_AWARE_FACTORY = 85;
    public static final int SIZE_FACTORY = 86;
    public static final int MULTIPLE_ENTRY_FACTORY = 87;
    public static final int ENTRY_EVENT_FILTER = 88;
    public static final int EVENT_LISTENER_FILTER = 89;
    public static final int PARTITION_LOST_EVENT_FILTER = 90;
    public static final int ADD_INTERCEPTOR = 91;
    public static final int MAP_REPLICATION = 92;
    public static final int POST_JOIN_MAP_OPERATION = 93;
    public static final int INDEX_INFO = 94;
    public static final int MAP_INDEX_INFO = 95;
    public static final int INTERCEPTOR_INFO = 96;
    public static final int REMOVE_INTERCEPTOR = 97;
    public static final int QUERY_EVENT_FILTER = 98;
    public static final int RECORD_INFO = 99;
    public static final int RECORD_REPLICATION_INFO = 100;
    public static final int UUID_FILTER = 101;
    public static final int MAP_TRANSACTION_LOG_RECORD = 102;
    public static final int VERSIONED_VALUE = 103;
    public static final int MAP_REPLICATION_STATE_HOLDER = 104;
    public static final int WRITE_BEHIND_STATE_HOLDER = 105;
    public static final int AGGREGATION_RESULT = 106;
    public static final int QUERY = 107;
    public static final int TARGET = 108;
    public static final int MAP_INVALIDATION_METADATA = 109;
    public static final int MAP_INVALIDATION_METADATA_RESPONSE = 110;
    public static final int MAP_NEAR_CACHE_STATE_HOLDER = 111;
    public static final int MAP_ASSIGN_AND_GET_UUIDS = 112;
    public static final int MAP_ASSIGN_AND_GET_UUIDS_FACTORY = 113;
    public static final int DESTROY_QUERY_CACHE = 114;
    public static final int MADE_PUBLISHABLE = 115;
    public static final int MADE_PUBLISHABLE_FACTORY = 116;
    public static final int PUBLISHER_CREATE = 117;
    public static final int READ_AND_RESET_ACCUMULATOR = 118;
    public static final int SET_READ_CURSOR = 119;
    public static final int ACCUMULATOR_CONSUMER = 120;
    public static final int LAZY_MAP_ENTRY = 121;
    public static final int TRIGGER_LOAD_IF_NEEDED = 122;
    public static final int IS_KEYLOAD_FINISHED = 123;
    public static final int REMOVE_FROM_LOAD_ALL = 124;
    public static final int ENTRY_REMOVING_PROCESSOR = 125;
    public static final int ENTRY_OFFLOADABLE_SET_UNLOCK = 126;
    public static final int LOCK_AWARE_LAZY_MAP_ENTRY = 127;
    public static final int FETCH_WITH_QUERY = 128;
    public static final int RESULT_SEGMENT = 129;
    public static final int EVICT_BATCH_BACKUP = 130;
    public static final int EVENT_JOURNAL_SUBSCRIBE_OPERATION = 131;
    public static final int EVENT_JOURNAL_READ = 132;
    public static final int EVENT_JOURNAL_DESERIALIZING_MAP_EVENT = 133;
    public static final int EVENT_JOURNAL_INTERNAL_MAP_EVENT = 134;
    public static final int EVENT_JOURNAL_READ_RESULT_SET = 135;
    public static final int MERGE_FACTORY = 136;
    public static final int MERGE = 137;
    public static final int SET_TTL = 138;
    public static final int SET_TTL_BACKUP = 139;
    public static final int MERKLE_TREE_NODE_ENTRIES = 140;
    public static final int ADD_INDEX_BACKUP = 141;
    public static final int TXN_SET_BACKUP = 142;
    public static final int TXN_DELETE_BACKUP = 143;
