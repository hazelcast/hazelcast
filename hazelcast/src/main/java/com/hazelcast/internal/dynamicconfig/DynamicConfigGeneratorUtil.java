...
public final class DynamicConfigGeneratorUtil {
    ...
    public static String externalDataLinkConfigGenerator(ExternalDataLinkConfig subConfig, boolean configIsXml, int indent) {
        return configGenerator(subConfig, configIsXml, indent,
                EXTERNAL_DATA_LINK.getName(),
                Config::addExternalDataLinkConfig,
                DynamicConfigXmlGenerator::externalDataLinkXmlGenerator,
                DynamicConfigYamlGenerator::externalDataLinkYamlGenerator
        );
    }
