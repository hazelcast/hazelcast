...
public interface ConfigurationService {
    ...
    /**
     * Finds existing external data link config.
     *
     * @param name name of the config
     * @return External data link config or {@code null} when requested configuration does not exist
     */
    ExternalDataLinkConfig findExternalDataLinkConfig(String name);

    /**
     * Returns all registered external data link configurations keyed by store's name.
     *
     * @return registered data link configurations keyed by store's name
     */
    Map<String, ExternalDataLinkConfig> getExternalDataLinkConfigs();
}
