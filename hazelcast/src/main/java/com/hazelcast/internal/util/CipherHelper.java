...
public final class CipherHelper {
    ...
    public static Cipher createSymmetricReaderCipher(AbstractSymmetricEncryptionConfig<?> config, byte[] key, String exceptionMessage) {
        return createCipher(config, key, false, exceptionMessage);
    }

    public static Cipher createSymmetricWriterCipher(AbstractSymmetricEncryptionConfig<?> config, byte[] key, String exceptionMessage) {
        return createCipher(config, key, true, exceptionMessage);
    }

    @SuppressWarnings("SynchronizedMethod")
    private static synchronized Cipher createCipher(AbstractSymmetricEncryptionConfig<?> config, byte[] key,
                                                    boolean createWriter, String exceptionMessage) {
        try {
            SymmetricCipherBuilder symmetricCipherBuilder = new SymmetricCipherBuilder(config, key);
    ...
    static class SymmetricCipherBuilder {
        ...
        SymmetricCipherBuilder(AbstractSymmetricEncryptionConfig<?> config, byte[] key) {
