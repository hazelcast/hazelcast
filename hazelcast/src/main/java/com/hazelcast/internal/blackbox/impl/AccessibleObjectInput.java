...
/**
 * An 'input' that provides an abstraction for {@link FieldSensorInput} and {@link MethodSensorInput}. This is comparable to the
 ...
 *
 * One of the reasons this class exists is that the {@link SensorImpl} only needs to check the 'input' field if it implements
 * {@link AccessibleObjectInput}. Otherwise it would need to deal with FieldSensorInput and MethodSensorInput.
 */
