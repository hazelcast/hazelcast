 ...
 *
 * Each sensor can be uniquely identified using a parameter. See {@link #getParameter()}.
 *
 * A sensor gets its content from sensor input. An input can be one of the following:
 * <ol>
 *     <li>a method with the {@link SensorInput} annotation</li>
 *     <li>a field with the {@link SensorInput} annotation</li>
 *     <li>a {@link LongSensorInput} function</li>
 *     <li>a {@link DoubleSensorInput} function</li>
 * </ol>
 *
