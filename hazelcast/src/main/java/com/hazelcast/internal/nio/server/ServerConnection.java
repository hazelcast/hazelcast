 ...
 * <p>
 * A {@link ServerConnection} is not responsible for reading or writing data to the socket; that is task of
 * the {@link Channel}.
 *
 * @see Networking
 */
...
public class ServerConnection implements Connection {
    ...
    public ServerConnection(ServerEndpointManager endpointManager,
        ...
        this.logger = ioService.getLoggingService().getLogger(ServerConnection.class);
    ...
    public ServerEndpointManager getEndpointManager() {
    ...
    public void setErrorHandler(ServerConnectionErrorHandler errorHandler) {
