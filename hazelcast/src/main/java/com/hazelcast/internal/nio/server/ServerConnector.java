...
/**
 * The ServerConnector is responsible to make connections by connecting to a remote serverport. Once completed,
...
class ServerConnector {
    ...
    private final ServerEndpointManager endpointManager;
    ...
    ServerConnector(ServerEndpointManager endpointManager) {
