...
final class MemberHandshakeHandler {
    ...
    private final ServerEndpointManager tcpIpEndpointManager;
    ...
    MemberHandshakeHandler(ServerEndpointManager tcpIpEndpointManager, IOService ioService, ILogger logger,
    ...
    public void process(Packet packet) {
        ...
        ServerConnection connection = (ServerConnection) packet.getConn();
    ...
    private synchronized boolean process(ServerConnection connection, MemberHandshake handshake) {
        if (logger.isFinestEnabled()) {
     ...
     * with which it was registered in {@link ServerEndpointManager#connectionsInProgress},
    ...
    private synchronized boolean process0(ServerConnection connection, Address remoteEndpoint,
    ...
    private boolean checkAlreadyConnected(ServerConnection connection, Address remoteEndPoint) {
