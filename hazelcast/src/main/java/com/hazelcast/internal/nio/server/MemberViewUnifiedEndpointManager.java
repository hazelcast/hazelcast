...
public class MemberViewUnifiedEndpointManager
    ...
    MemberViewUnifiedEndpointManager(ServerUnifiedEndpointManager unifiedEndpointManager) {
    ...
    @Override
    public boolean registerConnection(Address address, ServerConnection connection) {
