...
public class TextViewUnifiedEndpointManager
        implements EndpointManager<ServerConnection> {

    private final ServerUnifiedEndpointManager unifiedEndpointManager;
    private final boolean rest;

    TextViewUnifiedEndpointManager(ServerUnifiedEndpointManager unifiedEndpointManager, boolean rest) {
    ...
    @Override
    public boolean registerConnection(Address remoteEndPoint, ServerConnection connection) {
        return unifiedEndpointManager.registerConnection(remoteEndPoint, connection);
    }

    @Override
    public ServerConnection getConnection(Address address) {
