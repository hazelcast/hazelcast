...
public class ClusterJoinManager {
    ...
    void startJoin(MemberInfo memberInfo) {
        ...
        try {
            ...
            try {
                ...
                sendFinalizeJoinOp(memberInfo, thisUuid, newMembersView, partitionRuntimeState, time, migrationPaused);
    ...
    private boolean shouldTriggerRepartitionSyncStrategyOnly(MemberMap memberMap) {
        ...
        if (syncJoinStrategy != null) {
            ...
            for (MemberInfo member : syncJoinStrategy.getJoiningMembers().values()) {
