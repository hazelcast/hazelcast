 ...
 * ability to listen to compatibility (4.x) WAN replication events.
 */
public interface CompatibilityWanSupportingService {

    /**
     * Processes a compatibility (4.x) WAN replication event.
     *
     ...
     *                        appropriate member
     */
    void onReplicationEvent(CompatibilityInternalWanEvent event, WanAcknowledgeType acknowledgeType);
}
