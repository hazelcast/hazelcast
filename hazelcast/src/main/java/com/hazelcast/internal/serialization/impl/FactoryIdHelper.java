...
public final class FactoryIdHelper {
    ...
    public static final String ENTERPRISE_QUEUE_DS_FACTORY = "hazelcast.serialization.ds.enterprise.queue";
    public static final int ENTERPRISE_QUEUE_DS_FACTORY_ID = -41;
