...
import static com.hazelcast.internal.serialization.impl.portable.PortableNavigatorContext.NavigationFrame;
import static com.hazelcast.internal.serialization.impl.portable.PortablePositionFactory.emptyAnyPosition;
import static com.hazelcast.internal.serialization.impl.portable.PortablePositionFactory.nilAnyPosition;
import static com.hazelcast.internal.serialization.impl.portable.PortablePositionFactory.nilNotLeafPosition;
import static com.hazelcast.internal.serialization.impl.portable.PortableUtils.createUnknownFieldException;
import static com.hazelcast.internal.serialization.impl.portable.PortableUtils.createWrongUseOfAnyOperationException;
import static com.hazelcast.internal.serialization.impl.portable.PortableUtils.isCurrentPathTokenWithAnyQuantifier;
import static com.hazelcast.internal.serialization.impl.portable.PortableUtils.isCurrentPathTokenWithoutQuantifier;
import static com.hazelcast.internal.serialization.impl.portable.PortableUtils.validateAndGetArrayQuantifierFromCurrentToken;
import static com.hazelcast.internal.serialization.impl.portable.PortableUtils.validateArrayType;
import static com.hazelcast.internal.serialization.impl.portable.PortableUtils.validateFactoryAndClass;
