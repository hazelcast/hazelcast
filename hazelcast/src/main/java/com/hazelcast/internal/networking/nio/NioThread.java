...
public final class NioThread extends Thread implements OperationHostileThread {
    ...
    public void run() {
        ...
        //
        // The idea about this approach is that the runSelectNowLoop and runSelectLoop
        // are as clean as possible and don't contain any logic that isn't happening on
        // the happy-path.
        try {
            for (; ; ) {
                try {
