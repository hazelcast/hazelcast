...
package com.hazelcast.internal.management.metrics;
...
public class CompressingProbeRenderer implements ProbeRenderer {
    ...
    public CompressingProbeRenderer(OutputStream out) throws IOException {
        ...
        this.os = out;
        this.os.write((BINARY_FORMAT_VERSION >>> BITS_IN_BYTE) & BYTE_MASK);
        this.os.write(BINARY_FORMAT_VERSION & BYTE_MASK);
        this.dos = new DataOutputStream(new DeflaterOutputStream(os, compressor));
    }
