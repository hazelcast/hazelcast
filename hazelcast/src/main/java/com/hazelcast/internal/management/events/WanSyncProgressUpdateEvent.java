...
public class WanSyncProgressUpdateEvent extends AbstractWanAntiEntropyEventBase {
    ...
    public WanSyncProgressUpdateEvent(UUID configUpdateProcessId, String wanReplicationName, String wanPublisherId,
                                      String mapName, int partitionsToSync, int partitionsSynced, int recordsSynced) {
