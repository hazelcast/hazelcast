 ...
 * @ali 1/22/13
 */
public class SemaphoreMigrationOperation extends AbstractOperation {

    Map<String, Permit> migrationData;

    public SemaphoreMigrationOperation() {
    }

    public SemaphoreMigrationOperation(Map<String, Permit> migrationData) {
