 ...
 * {@link PingFailureDetector} used by this member's {@link com.hazelcast.internal.cluster.impl.ClusterHeartbeatManager}
 * will be provided on initialization.
 */
public interface PingAware {

    /**
     * Notifies the {@link QuorumFunction} of ping loss.
     *
    ...
    /**
     * Notifies the {@link QuorumFunction} of a successful ping after one or more pings to that member were lost.
     *
