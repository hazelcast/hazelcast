...
public class Server {
    ...
    public Server(Context context) {
        ...
        for (int k = 0; k < serverThreadCount; k++) {
            serverThreads[k] = new ServerThread(k);
        }
    ...
    public class ServerThread extends Thread {
        ...
        private ServerThread(int id) {
            super("ServerThread-" + id);
            this.setDaemon(true);
        ...
        private void onWrite(SelectionKey sk) throws IOException {
            ...
            for (; ; ) {
                ...
                //System.out.println("          sendOffset:"+con.sendOffset);
                //System.out.println("          sendFrame.length:"+con.sendFrame.length);
                //System.out.println("          missingFromFrame:"+missingFromFrame);
            ...
            // System.out.println("          Server:bytes written:" + bytesWritten);
            ...
            if (con.sendBuf.remaining() == 0 && con.sendFrame == null) {
                ...
                if ((interestOps & SelectionKey.OP_WRITE) != 0) {
                    // System.out.println("          Unregistering OP_WRITE");
                    sk.interestOps(interestOps & ~SelectionKey.OP_WRITE);
                }
            } else {
                // register OP_WRITE
                //System.out.println("          Registering OP_WRITE");
    ...
    public static class Context {
        private int serverThreadCount = Math.max(4, Runtime.getRuntime().availableProcessors());
