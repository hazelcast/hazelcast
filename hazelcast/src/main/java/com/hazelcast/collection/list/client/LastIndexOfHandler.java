...
public class LastIndexOfHandler extends ListCommandHandler {
    public LastIndexOfHandler(CollectionService collectionService) {
    ...
    protected Protocol processCall(ObjectListProxy proxy, Protocol protocol) {
        ...
        int index = proxy.lastIndexOf(item);
