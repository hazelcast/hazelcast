...
public class ContainsEntryHandler extends MultiMapCommandHandler {
    public ContainsEntryHandler(CollectionService collectionService) {
    ...
    protected Protocol processCall(ObjectMultiMapProxy proxy, Protocol protocol) {
        ...
        boolean contains = proxy.containsEntry(key, value);
