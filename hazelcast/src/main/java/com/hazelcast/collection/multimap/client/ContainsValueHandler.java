...
public class ContainsValueHandler extends MultiMapCommandHandler {
    public ContainsValueHandler(CollectionService collectionService) {
    ...
    protected Protocol processCall(ObjectMultiMapProxy proxy, Protocol protocol) {
        ...
        boolean contains = proxy.containsValue(key);
