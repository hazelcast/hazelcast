...
import com.hazelcast.dataset.impl.query.ExecuteQueryOperationFactory;
    ...
    public List<V> execute(Map<String, Object> bindings) {
        try {
            ...
            Map<Integer, Object> r = operationService.invokeOnAllPartitions(
                    DataSetService.SERVICE_NAME, new ExecuteQueryOperationFactory(name, preparedId, bindings));
