...
public class PrepareAggregationOperationFactory implements OperationFactory {
    ...
    public PrepareAggregationOperationFactory(String name, String preparationId, AggregationRecipe aggregationRecipe) {
        this.name = name;
    ...
    @Override
    public int getId() {
        return DataSetDataSerializerHook.PREPARE_AGGREGATION_OPERATION_FACTORY;
    }
