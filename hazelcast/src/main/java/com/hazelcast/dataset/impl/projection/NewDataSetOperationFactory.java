...
public class NewDataSetOperationFactory implements OperationFactory {
    ...
    public NewDataSetOperationFactory(String srcName, String targetName, String recordType, String preparationId, Map<String, Object> bindings) {
    ...
    public Operation createOperation() {
        return new NewDataSetOperation(srcName, targetName, recordType, preparationId, bindings);
    }
