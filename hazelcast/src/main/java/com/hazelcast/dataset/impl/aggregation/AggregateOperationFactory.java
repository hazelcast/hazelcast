...
public class AggregateOperationFactory implements OperationFactory {
    ...
    public AggregateOperationFactory(String name, String compileId, Map<String, Object> bindings) {
        this.name = name;
    ...
    public Operation createOperation() {
        return new AggregateOperation(name, compileId, bindings);
    }
    ...
    @Override
    public int getId() {
        return DataSetDataSerializerHook.AGGREGATE_OPERATION_FACTORY;
    }
