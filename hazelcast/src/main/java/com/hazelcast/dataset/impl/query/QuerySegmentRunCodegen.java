...
public class QuerySegmentRunCodegen extends SegmentRunCodegen {
    ...
    public void generate() {
        ...
        add("import static com.hazelcast.dataset.impl.IndexOffsets.offsetInIndex;\n");
        add("\n");
        add("public class " + className() + " extends com.hazelcast.dataset.impl.query.QuerySegmentRun {\n\n");
