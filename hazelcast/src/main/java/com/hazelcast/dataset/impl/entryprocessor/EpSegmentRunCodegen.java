...
public class EpSegmentRunCodegen extends SegmentRunCodegen {

    private final Mutator mutator;
    private final Class projectionClass;
    public Field field;

    public EpSegmentRunCodegen(String compileId, EntryProcessorRecipe recipe, RecordModel recordModel) {
        super(compileId, recipe.getPredicate(), recordModel);
    ...
    public String className() {
        return "EntryProcessor_" + compilationId;
    }

    @Override
    public void generate() {
        add("import java.util.*;\n");
        add("public class " + className() + " extends com.hazelcast.dataset.impl.entryprocessor.EpSegmentRun {\n\n");
    ...
    private void addRunFullScanMethod() {
        ...
        add("           }\n");
        add("           recordAddress+=recordDataSize;\n");
        add("        }\n");
        add("    }\n\n");
    }
