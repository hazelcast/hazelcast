...
public class PartitionStateGenerator {
    ...
    public PartitionInfo[] arrange(final PartitionInfo[] currentState, final List<MemberImpl> members, 
            final int partitionCount, Queue<PartitionTransfer> migrationQueue, Queue<PartitionTransfer> backupQueue) {
