...
public class MapTxnBackupRollbackOperation extends AbstractOperation implements NonBlockingOperation {
    String txnId;
    ...
    public void run() {
        ...
        System.out.println(context.getNodeService().getThisAddress() + " backupRollback " + txnId);
