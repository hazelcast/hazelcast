...
import com.hazelcast.dataseries.impl.aggregation.AggregateFJResult;
import com.hazelcast.dataseries.impl.aggregation.AggregationSegmentRun;
import com.hazelcast.dataseries.impl.aggregation.AggregationSegmentRunCodegen;
import com.hazelcast.dataseries.impl.aggregation.AggregatorRecursiveTask;
import com.hazelcast.dataseries.impl.entryprocessor.EntryProcessorSegmentRun;
import com.hazelcast.dataseries.impl.entryprocessor.EntryProcessorSegmentRunCodegen;
import com.hazelcast.dataseries.impl.projection.ProjectionSegmentRun;
import com.hazelcast.dataseries.impl.projection.ProjectionSegmentRunCodegen;
import com.hazelcast.dataseries.impl.query.QuerySegmentRun;
import com.hazelcast.dataseries.impl.query.QuerySegmentRunCodegen;
...
public class Partition {
    ...
    public Partition(DataSeriesConfig config, SerializationService serializationService, Compiler compiler) {
        this.config = config;
...
//        System.out.println(codegen.getCode());
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        DataSeriesConfig config1 = config.getDataSeriesConfig("dataseries");
...
//        }
    ...
    public void insert(Data keyData, Object valueData) {
        if (frozen) {
            throw new IllegalStateException("Can't insert on a frozen dataseries");
        }
