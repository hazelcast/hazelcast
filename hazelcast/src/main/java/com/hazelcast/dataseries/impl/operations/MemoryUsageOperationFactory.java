...
import static com.hazelcast.dataseries.impl.DataSeriesDataSerializerHook.F_ID;
import static com.hazelcast.dataseries.impl.DataSeriesDataSerializerHook.MEMORY_USAGE_OPERATION_FACTORY;
...
public class MemoryUsageOperationFactory implements OperationFactory {
    ...
    @Override
    public int getId() {
        return MEMORY_USAGE_OPERATION_FACTORY;
    }
