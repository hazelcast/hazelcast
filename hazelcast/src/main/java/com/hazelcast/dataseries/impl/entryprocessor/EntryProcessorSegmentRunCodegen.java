...
import com.hazelcast.dataseries.AddMutator;
import com.hazelcast.dataseries.EntryProcessorRecipe;
import com.hazelcast.dataseries.FieldMutator;
import com.hazelcast.dataseries.MultiplyMutator;
import com.hazelcast.dataseries.Mutator;
import com.hazelcast.dataseries.RecordMutator;
...
public class EntryProcessorSegmentRunCodegen extends SegmentRunCodegen {
    ...
    public void generate() {
        ...
        add("public class " + className() + " extends com.hazelcast.dataseries.impl.entryprocessor.EntryProcessorSegmentRun {\n\n");
