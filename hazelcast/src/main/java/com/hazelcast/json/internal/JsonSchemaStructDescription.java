...
/**
 * A schema that describes either a Json array or Json object.
 */
public class JsonSchemaStructDescription extends JsonSchemaDescription {

    private final List<JsonSchemaNameValue> inners = new ArrayList<JsonSchemaNameValue>();

    public JsonSchemaStructDescription(JsonSchemaStructDescription parent) {
        super(parent);
    }

    /**
     * Adds a child node to this Json struct. It is added as the last item
     * in order.
     *
     * @param description
     */
    ...
    public boolean equals(Object o) {
        ...
        JsonSchemaStructDescription that = (JsonSchemaStructDescription) o;
