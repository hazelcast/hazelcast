 ...
 */
public class DynamicConfigAddReplicatedMapConfigCodec {

        private static final int REQUEST_ASYNC_FILLUP_FIELD_OFFSET = CORRELATION_ID_FIELD_OFFSET + BOOLEAN_SIZE_IN_BYTES;
        ...
        public static final int REQUEST_MESSAGE_TYPE = 7687;//hex: 0x1E07,
