 ...
 */
public class CPCountDownLatchCountDownCodec {

        private static final int REQUEST_INVOCATION_UID_FIELD_OFFSET = CORRELATION_ID_FIELD_OFFSET + UUID_SIZE_IN_BYTES;
        private static final int REQUEST_EXPECTED_ROUND_FIELD_OFFSET = REQUEST_INVOCATION_UID_FIELD_OFFSET + INT_SIZE_IN_BYTES;
        private static final int REQUEST_INITIAL_FRAME_SIZE = REQUEST_EXPECTED_ROUND_FIELD_OFFSET + LONG_SIZE_IN_BYTES;
        public static final int REQUEST_MESSAGE_TYPE = 9475;//hex: 0x2503,
