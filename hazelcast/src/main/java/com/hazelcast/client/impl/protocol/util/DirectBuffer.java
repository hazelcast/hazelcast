...
public interface DirectBuffer {
    ...
    /**
     * Attach a view to a {@link java.nio.ByteBuffer} for providing direct access.
     *
     * @param buffer to which the view is attached.
     * @param offset at which the view begins.
     * @param length of the buffer included in the view
    ...
    /**
     * Get the underlying {@link java.nio.ByteBuffer} if one exists.
     *
     * @return the underlying {@link java.nio.ByteBuffer} if one exists.
     */
    ...
    /**
     * Get from the underlying buffer into a supplied {@link java.nio.ByteBuffer}.
     *
     * @param index     in the underlying buffer to start from.
