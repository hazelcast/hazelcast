...
public final class CacheReplaceCodec {
    ...
    public static ClientMessage encodeRequest(java.lang.String name, Data key, @Nullable Data oldValue, Data newValue, @Nullable Data expiryPolicy, int completionId) {
