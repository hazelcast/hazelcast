 ...
 */
public class LockForceUnlockCodec {
        ...
        public static final int REQUEST_MESSAGE_TYPE = 1799;//hex: 0x0707,
    ...
    public static ClientMessage encodeRequest(java.lang.String name, long referenceId) {
