 ...
 * TODO DOC
 */
public class ExecutorServiceSubmitToPartitionCodec {

        private static final int REQUEST_PARTITION_ID_FIELD_OFFSET = CORRELATION_ID_FIELD_OFFSET + INT_SIZE_IN_BYTES;
        private static final int REQUEST_INITIAL_FRAME_SIZE = REQUEST_PARTITION_ID_FIELD_OFFSET + LONG_SIZE_IN_BYTES;
        public static final int REQUEST_MESSAGE_TYPE = 2309;//hex: 0x0905,
