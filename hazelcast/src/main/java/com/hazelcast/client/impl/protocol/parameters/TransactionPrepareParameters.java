...
public final class TransactionPrepareParameters {


    public static final ClientMessageType TYPE = ClientMessageType.TRANSACTION_PREPARE;
    public String transactionId;
    public long threadId;

    private TransactionPrepareParameters(ClientMessage clientMessage) {
        transactionId = clientMessage.getStringUtf8();
        threadId = clientMessage.getLong();
    }

    public static TransactionPrepareParameters decode(ClientMessage clientMessage) {
