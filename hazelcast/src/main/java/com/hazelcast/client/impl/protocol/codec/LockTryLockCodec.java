...
public class LockTryLockCodec {
        ...
        public static final int REQUEST_MESSAGE_TYPE = 1800;//hex: 0x0708,
    ...
    public static ClientMessage encodeRequest(java.lang.String name, long threadId, long lease, long timeout, long referenceId) {
