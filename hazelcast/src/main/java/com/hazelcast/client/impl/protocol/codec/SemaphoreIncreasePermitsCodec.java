 ...
 */
public class SemaphoreIncreasePermitsCodec {

        private static final int REQUEST_INCREASE_FIELD_OFFSET = CORRELATION_ID_FIELD_OFFSET + INT_SIZE_IN_BYTES;
        private static final int REQUEST_INITIAL_FRAME_SIZE = REQUEST_INCREASE_FIELD_OFFSET + LONG_SIZE_IN_BYTES;
        public static final int REQUEST_MESSAGE_TYPE = 3336;//hex: 0x0D08,
