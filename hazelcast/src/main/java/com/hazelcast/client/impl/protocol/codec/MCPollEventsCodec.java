 ...
 */
@Generated("38c4d8ca3e5717d1ccf1d0dff8d7cced")
public final class MCPollEventsCodec {
    //hex: 0x201600
    ...
    public static ClientMessage encodeRequest() {
        ...
        clientMessage.setOperationName("MC.PollEvents");
    ...
    public static MCPollEventsCodec.RequestParameters decodeRequest(ClientMessage clientMessage) {
    ...
    public static MCPollEventsCodec.ResponseParameters decodeResponse(ClientMessage clientMessage) {
        ClientMessage.ForwardFrameIterator iterator = clientMessage.frameIterator();
