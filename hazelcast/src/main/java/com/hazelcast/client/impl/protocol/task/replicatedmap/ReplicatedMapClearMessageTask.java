...
public class ReplicatedMapClearMessageTask extends AbstractCallableMessageTask<ReplicatedMapClearParameters> {
    ...
    @Override
    protected ReplicatedMapClearParameters decodeClientMessage(ClientMessage clientMessage) {
        return ReplicatedMapClearParameters.decode(clientMessage);
    }
