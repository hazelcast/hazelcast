 ...
 * TODO DOC
 */
public class CacheCreateConfigCodec {

        private static final int REQUEST_CREATE_ALSO_ON_OTHERS_FIELD_OFFSET = CORRELATION_ID_FIELD_OFFSET + BOOLEAN_SIZE_IN_BYTES;
        private static final int REQUEST_INITIAL_FRAME_SIZE = REQUEST_CREATE_ALSO_ON_OTHERS_FIELD_OFFSET + LONG_SIZE_IN_BYTES;
        public static final int REQUEST_MESSAGE_TYPE = 5383;//hex: 0x1507,
