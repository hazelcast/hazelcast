 ...
 */
public class DynamicConfigAddSemaphoreConfigCodec {

        private static final int REQUEST_INITIAL_PERMITS_FIELD_OFFSET = CORRELATION_ID_FIELD_OFFSET + INT_SIZE_IN_BYTES;
        ...
        private static final int REQUEST_INITIAL_FRAME_SIZE = REQUEST_ASYNC_BACKUP_COUNT_FIELD_OFFSET + LONG_SIZE_IN_BYTES;
        public static final int REQUEST_MESSAGE_TYPE = 7692;//hex: 0x1E0C,
