 ...
 */
@Generated("198d8041c5daf91a4a35fec7f3d43048")
public final class SqlExecuteCodec {
    ...
    private static final int RESPONSE_RESULT_TYPE_FIELD_OFFSET = RESPONSE_BACKUP_ACKS_FIELD_OFFSET + BYTE_SIZE_IN_BYTES;
    private static final int RESPONSE_ROW_PAGE_LAST_FIELD_OFFSET = RESPONSE_RESULT_TYPE_FIELD_OFFSET + INT_SIZE_IN_BYTES;
    ...
    public static class ResponseParameters {
        /**
         * Type of the result (rows, void, update count...)
         */
    ...
    public static ClientMessage encodeResponse(int resultType, @Nullable com.hazelcast.sql.impl.QueryId queryId, @Nullable java.util.List<com.hazelcast.sql.SqlColumnMetadata> rowMetadata, @Nullable java.util.Collection<java.util.Collection<com.hazelcast.internal.serialization.Data>> rowPage, boolean rowPageLast, @Nullable com.hazelcast.sql.impl.client.SqlError error) {
        ClientMessage clientMessage = ClientMessage.createForEncode();
        ClientMessage.Frame initialFrame = new ClientMessage.Frame(new byte[RESPONSE_INITIAL_FRAME_SIZE], UNFRAGMENTED_MESSAGE);
        encodeInt(initialFrame.content, TYPE_FIELD_OFFSET, RESPONSE_MESSAGE_TYPE);
        encodeInt(initialFrame.content, RESPONSE_RESULT_TYPE_FIELD_OFFSET, resultType);
    ...
    public static SqlExecuteCodec.ResponseParameters decodeResponse(ClientMessage clientMessage) {
        ...
        ClientMessage.Frame initialFrame = iterator.next();
        response.resultType = decodeInt(initialFrame.content, RESPONSE_RESULT_TYPE_FIELD_OFFSET);
