...
public final class CacheAddNearCacheInvalidationListenerCodec {
    ...
    public static ClientMessage encodeCacheInvalidationEvent(java.lang.String name, @Nullable Data key, @Nullable java.util.UUID sourceUuid, java.util.UUID partitionUuid, long sequence) {
        ClientMessage clientMessage = ClientMessage.createForEncode();
    ...
    public static ClientMessage encodeCacheBatchInvalidationEvent(java.lang.String name, java.util.Collection<Data> keys, java.util.Collection<java.util.UUID> sourceUuids, java.util.Collection<java.util.UUID> partitionUuids, java.util.Collection<java.lang.Long> sequences) {
        ClientMessage clientMessage = ClientMessage.createForEncode();
    ...
    public abstract static class AbstractEventHandler {
        ...
        public void handle(ClientMessage clientMessage) {
            ...
            if (messageType == EVENT_CACHE_BATCH_INVALIDATION_MESSAGE_TYPE) {
                ...
                iterator.next();
                java.lang.String name = StringCodec.decode(iterator);
                java.util.Collection<Data> keys = ListMultiFrameCodec.decode(iterator, DataCodec::decode);
        ...
        public abstract void handleCacheInvalidationEvent(java.lang.String name, @Nullable Data key, @Nullable java.util.UUID sourceUuid, java.util.UUID partitionUuid, long sequence);
        public abstract void handleCacheBatchInvalidationEvent(java.lang.String name, java.util.Collection<Data> keys, java.util.Collection<java.util.UUID> sourceUuids, java.util.Collection<java.util.UUID> partitionUuids, java.util.Collection<java.lang.Long> sequences);
    }
}
