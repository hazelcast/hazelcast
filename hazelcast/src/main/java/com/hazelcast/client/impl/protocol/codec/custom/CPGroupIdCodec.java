...
@Generated("a5b8c52d36035d8e2d91e1f732f4882d")
public final class CPGroupIdCodec {
    ...
    public static void encode(ClientMessage clientMessage, com.hazelcast.cp.internal.RaftGroupId cPGroupId) {
        clientMessage.add(BEGIN_FRAME.copy());

        ClientMessage.Frame initialFrame = new ClientMessage.Frame(new byte[INITIAL_FRAME_SIZE]);
        encodeLong(initialFrame.content, SEED_FIELD_OFFSET, cPGroupId.getSeed());
        encodeLong(initialFrame.content, ID_FIELD_OFFSET, cPGroupId.getId());
