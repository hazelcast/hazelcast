 ...
 */
public class CPSemaphoreAvailablePermitsCodec {

        private static final int REQUEST_INITIAL_FRAME_SIZE = CORRELATION_ID_FIELD_OFFSET + LONG_SIZE_IN_BYTES;
        public static final int REQUEST_MESSAGE_TYPE = 9990;//hex: 0x2706,
    ...
    public static CPSemaphoreAvailablePermitsCodec.RequestParameters decodeRequest(ClientMessage clientMessage) {
    ...
    public static CPSemaphoreAvailablePermitsCodec.ResponseParameters decodeResponse(ClientMessage clientMessage) {
        ListIterator<ClientMessage.Frame> iterator = clientMessage.iterator();
