 ...
 * TODO DOC
 */
public class CacheListenerRegistrationCodec {

        private static final int REQUEST_SHOULD_REGISTER_FIELD_OFFSET = CORRELATION_ID_FIELD_OFFSET + BOOLEAN_SIZE_IN_BYTES;
        private static final int REQUEST_INITIAL_FRAME_SIZE = REQUEST_SHOULD_REGISTER_FIELD_OFFSET + LONG_SIZE_IN_BYTES;
        public static final int REQUEST_MESSAGE_TYPE = 5392;//hex: 0x1510,
