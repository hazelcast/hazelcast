...
public class ScheduledExecutorTaskIsCancelledMessageTask
        extends AbstractInvocationMessageTask<ScheduledExecutorIsCancelledCodec.RequestParameters> {

    public ScheduledExecutorTaskIsCancelledMessageTask(ClientMessage clientMessage, Node node, Connection connection) {
    ...
    protected Operation prepareOperation() {
        Operation op = new IsCanceledOperation(parameters.handler);
        op.setPartitionId(getPartitionId());
        return op;
    }

    @Override
    protected ScheduledExecutorIsCancelledCodec.RequestParameters decodeClientMessage(ClientMessage clientMessage) {
        return ScheduledExecutorIsCancelledCodec.decodeRequest(clientMessage);
    }
