 ...
 */
public class SetAddListenerCodec {
        ...
        public static final int REQUEST_MESSAGE_TYPE = 1547;//hex: 0x060B,
        private static final int RESPONSE_INITIAL_FRAME_SIZE = CORRELATION_ID_FIELD_OFFSET + LONG_SIZE_IN_BYTES;
        public static final int RESPONSE_MESSAGE_TYPE = 104;//hex: 0x0068,
        private static final int EVENT_ITEM_EVENT_TYPE_FIELD_OFFSET = CORRELATION_ID_FIELD_OFFSET + INT_SIZE_IN_BYTES;
        private static final int EVENT_ITEM_INITIAL_FRAME_SIZE = EVENT_ITEM_EVENT_TYPE_FIELD_OFFSET + INT_SIZE_IN_BYTES;
        public static final int EVENT_ITEM_MESSAGE_TYPE = 104;//hex: 0x00CC,
    ...
    public abstract static class AbstractEventHandler {
        ...
        public void handle(ClientMessage clientMessage) {
            ...
            if (messageType == EVENT_ITEM_MESSAGE_TYPE) {
                frame = iterator.next();
                int eventType = decodeInt(frame.content, EVENT_ITEM_EVENT_TYPE_FIELD_OFFSET);
