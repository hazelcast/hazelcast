 ...
 */
public class CountDownLatchTrySetCountCodec {
        ...
        public static final int REQUEST_MESSAGE_TYPE = 3076;//hex: 0x0C04,
    ...
    public static ClientMessage encodeRequest(java.lang.String name, int count) {
