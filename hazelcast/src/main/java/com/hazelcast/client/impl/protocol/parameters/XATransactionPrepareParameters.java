...
public class XATransactionPrepareParameters {
    ...
    public static final ClientMessageType TYPE = ClientMessageType.XA_TRANSACTION_PREPARE;
    public String transactionId;


    private XATransactionPrepareParameters(ClientMessage clientMessage) {
        transactionId = clientMessage.getStringUtf8();
    }

    public static XATransactionPrepareParameters decode(ClientMessage clientMessage) {
        return new XATransactionPrepareParameters(clientMessage);
    }
