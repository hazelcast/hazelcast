 ...
 */
public class DynamicConfigAddTopicConfigCodec {

        private static final int REQUEST_GLOBAL_ORDERING_ENABLED_FIELD_OFFSET = CORRELATION_ID_FIELD_OFFSET + BOOLEAN_SIZE_IN_BYTES;
        ...
        private static final int REQUEST_INITIAL_FRAME_SIZE = REQUEST_MULTI_THREADING_ENABLED_FIELD_OFFSET + LONG_SIZE_IN_BYTES;
        public static final int REQUEST_MESSAGE_TYPE = 7688;//hex: 0x1E08,
