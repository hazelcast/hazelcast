...
public final class ReplicatedMapEndEntryViewIterationCodec {
    ...
    //hex: 0x0D1501
    public static final int RESPONSE_MESSAGE_TYPE = 857345;
    private static final int REQUEST_CURSOR_ID_FIELD_OFFSET = PARTITION_ID_FIELD_OFFSET + INT_SIZE_IN_BYTES;
    private static final int REQUEST_INITIAL_FRAME_SIZE = REQUEST_CURSOR_ID_FIELD_OFFSET + UUID_SIZE_IN_BYTES;
    ...
    public static ClientMessage encodeRequest(java.lang.String name, @Nullable java.util.UUID cursorId) {
        ClientMessage clientMessage = ClientMessage.createForEncode();
        clientMessage.setRetryable(true);
        clientMessage.setOperationName("ReplicatedMap.EndEntryViewIteration");
    ...
    public static ReplicatedMapEndEntryViewIterationCodec.RequestParameters decodeRequest(ClientMessage clientMessage) {
