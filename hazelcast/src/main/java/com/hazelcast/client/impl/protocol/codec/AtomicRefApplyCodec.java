...
public final class AtomicRefApplyCodec {
    ...
    public static ClientMessage encodeRequest(com.hazelcast.cp.internal.RaftGroupId groupId, java.lang.String name, Data function, int returnValueType, boolean alter) {
