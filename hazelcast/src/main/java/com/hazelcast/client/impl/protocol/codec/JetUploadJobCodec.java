...
/**
 */
@Generated("178883c3f9b2a4b82eb06117937fdf2a")
public final class JetUploadJobCodec {
    //hex: 0xFE1000
    ...
    public static ClientMessage encodeRequest(@Nullable String snapshotName, @Nullable String jobName, @Nullable String mainClass, java.util.Collection<String> jobParameters, byte[] jarData) {
        ClientMessage clientMessage = ClientMessage.createForEncode();
        clientMessage.setRetryable(true);
        clientMessage.setOperationName("Jet.UploadJob");
        ...
        ByteArrayCodec.encode(clientMessage, jarData);
    ...
    public static RequestParameters decodeRequest(ClientMessage clientMessage) {
        ...
        request.jarData = ByteArrayCodec.decode(iterator);
        return request;
    }
