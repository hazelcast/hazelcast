 ...
 * initialized before.
 */
public class CPSemaphoreInitCodec {
        ...
        public static final int REQUEST_MESSAGE_TYPE = 9985;//hex: 0x2701,
    ...
    public static CPSemaphoreInitCodec.RequestParameters decodeRequest(ClientMessage clientMessage) {
    ...
    public static CPSemaphoreInitCodec.ResponseParameters decodeResponse(ClientMessage clientMessage) {
        ListIterator<ClientMessage.Frame> iterator = clientMessage.iterator();
