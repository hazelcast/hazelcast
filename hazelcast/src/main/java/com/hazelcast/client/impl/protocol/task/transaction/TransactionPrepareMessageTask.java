...
public class TransactionPrepareMessageTask extends AbstractTransactionalMessageTask<TransactionPrepareParameters> {

    public TransactionPrepareMessageTask(ClientMessage clientMessage, Node node, Connection connection) {
