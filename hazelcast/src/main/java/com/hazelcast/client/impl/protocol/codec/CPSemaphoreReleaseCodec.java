 ...
 */
public class CPSemaphoreReleaseCodec {
        ...
        private static final int REQUEST_INVOCATION_UID_FIELD_OFFSET = REQUEST_THREAD_ID_FIELD_OFFSET + UUID_SIZE_IN_BYTES;
        private static final int REQUEST_PERMITS_FIELD_OFFSET = REQUEST_INVOCATION_UID_FIELD_OFFSET + INT_SIZE_IN_BYTES;
        private static final int REQUEST_INITIAL_FRAME_SIZE = REQUEST_PERMITS_FIELD_OFFSET + LONG_SIZE_IN_BYTES;
        public static final int REQUEST_MESSAGE_TYPE = 9987;//hex: 0x2703,
    ...
    public static CPSemaphoreReleaseCodec.RequestParameters decodeRequest(ClientMessage clientMessage) {
    ...
    public static CPSemaphoreReleaseCodec.ResponseParameters decodeResponse(ClientMessage clientMessage) {
        ListIterator<ClientMessage.Frame> iterator = clientMessage.iterator();
