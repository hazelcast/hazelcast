...
public class XATransactionCommitParameters {
    ...
    public static final ClientMessageType TYPE = ClientMessageType.XA_TRANSACTION_COMMIT;
    public String transactionId;
    public boolean onePhase;

    private XATransactionCommitParameters(ClientMessage clientMessage) {
        transactionId = clientMessage.getStringUtf8();
        onePhase = clientMessage.getBoolean();
    }

    public static XATransactionCommitParameters decode(ClientMessage clientMessage) {
        return new XATransactionCommitParameters(clientMessage);
    }
