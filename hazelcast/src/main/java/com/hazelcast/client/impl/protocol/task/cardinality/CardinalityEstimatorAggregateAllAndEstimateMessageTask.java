...
public class CardinalityEstimatorAggregateAllAndEstimateMessageTask
    ...
    protected Operation prepareOperation() {
        return new BatchAggregateAndEstimateOperation(parameters.name, parameters.hashes);
    }
    ...
    protected ClientMessage encodeResponse(Object response) {
        return CardinalityEstimatorAggregateAllAndEstimateCodec.encodeResponse((Long) response);
    }
    ...
    public String getMethodName() {
        return "aggregateAllAndEstimate";
    }
