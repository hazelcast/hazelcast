...
@Generated("b5b7667c5c1e3a4660d0b081bf39717d")
public final class MapGetCodec {
    ...
    public static MapGetCodec.RequestParameters decodeRequest(ClientMessage clientMessage) {
        ...
        ClientMessage.Frame initialFrame = clientMessage.getStartFrame();
        request.threadId = decodeLong(initialFrame.content, REQUEST_THREAD_ID_FIELD_OFFSET);
        request.name = StringCodec.decode(initialFrame);
        request.key = DataCodec.decode(initialFrame);
        return request;
    }
    ...
    public static com.hazelcast.internal.serialization.Data decodeResponse(ClientMessage clientMessage) {
        ...
        //empty initial frame
        frame = frame.next;
        return CodecUtil.decodeNullable(frame, DataCodec::decode);
    }
}
