...
@Generated("54657d8db7d1b08b375d5dd6db55e7d0")
public final class KubernetesConfigCodec {
    ...
    public static void encode(ClientMessage clientMessage, com.hazelcast.config.KubernetesConfig kubernetesConfig) {
        clientMessage.add(BEGIN_FRAME.copy());

        ClientMessage.Frame initialFrame = new ClientMessage.Frame(new byte[INITIAL_FRAME_SIZE]);
        encodeBoolean(initialFrame.content, ENABLED_FIELD_OFFSET, kubernetesConfig.isEnabled());
        encodeBoolean(initialFrame.content, USE_PUBLIC_IP_FIELD_OFFSET, kubernetesConfig.isUsePublicIp());
    ...
    public static com.hazelcast.config.KubernetesConfig decode(ClientMessage.ForwardFrameIterator iterator) {
        // begin frame
        iterator.next();
        ...
        return new com.hazelcast.config.KubernetesConfig(tag, enabled, usePublicIp, properties);
    }
}
