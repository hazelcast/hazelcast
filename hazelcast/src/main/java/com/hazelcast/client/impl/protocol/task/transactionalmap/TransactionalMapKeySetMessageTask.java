...
public class TransactionalMapKeySetMessageTask extends AbstractTransactionalMessageTask<TransactionalMapKeySetParameters> {
    ...
    @Override
    protected TransactionalMapKeySetParameters decodeClientMessage(ClientMessage clientMessage) {
        return TransactionalMapKeySetParameters.decode(clientMessage);
    }
