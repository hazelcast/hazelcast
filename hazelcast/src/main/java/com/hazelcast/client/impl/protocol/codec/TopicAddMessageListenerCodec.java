 ...
 */
public class TopicAddMessageListenerCodec {
        ...
        public static final int REQUEST_MESSAGE_TYPE = 1026;//hex: 0x0402,
        private static final int RESPONSE_INITIAL_FRAME_SIZE = CORRELATION_ID_FIELD_OFFSET + LONG_SIZE_IN_BYTES;
        public static final int RESPONSE_MESSAGE_TYPE = 104;//hex: 0x0068,
        private static final int EVENT_TOPIC_PUBLISH_TIME_FIELD_OFFSET = CORRELATION_ID_FIELD_OFFSET + LONG_SIZE_IN_BYTES;
        private static final int EVENT_TOPIC_INITIAL_FRAME_SIZE = EVENT_TOPIC_PUBLISH_TIME_FIELD_OFFSET + INT_SIZE_IN_BYTES;
        public static final int EVENT_TOPIC_MESSAGE_TYPE = 104;//hex: 0x00CD,
    ...
    public abstract static class AbstractEventHandler {
        ...
        public void handle(ClientMessage clientMessage) {
            ...
            if (messageType == EVENT_TOPIC_MESSAGE_TYPE) {
                frame = iterator.next();
                long publishTime = decodeLong(frame.content, EVENT_TOPIC_PUBLISH_TIME_FIELD_OFFSET);
