 ...
 */
public class DynamicConfigAddRingbufferConfigCodec {

        private static final int REQUEST_CAPACITY_FIELD_OFFSET = CORRELATION_ID_FIELD_OFFSET + INT_SIZE_IN_BYTES;
        ...
        public static final int REQUEST_MESSAGE_TYPE = 7682;//hex: 0x1E02,
    ...
    public static ClientMessage encodeRequest(java.lang.String name, int capacity, int backupCount, int asyncBackupCount, int timeToLiveSeconds, java.lang.String inMemoryFormat, com.hazelcast.client.impl.protocol.task.dynamicconfig.RingbufferStoreConfigHolder ringbufferStoreConfig, java.lang.String quorumName, java.lang.String mergePolicy, int mergeBatchSize) {
