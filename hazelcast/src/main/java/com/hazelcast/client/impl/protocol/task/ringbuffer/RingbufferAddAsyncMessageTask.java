 ...
 */
public class RingbufferAddAsyncMessageTask
        extends AbstractPartitionMessageTask<RingbufferAddAsyncCodec.RequestParameters> {

    public RingbufferAddAsyncMessageTask(ClientMessage clientMessage, Node node, Connection connection) {
    ...
    protected ClientMessage encodeResponse(Object response) {
        return RingbufferAddAsyncCodec.encodeResponse((Long) response);
    }

    @Override
    protected RingbufferAddAsyncCodec.RequestParameters decodeClientMessage(ClientMessage clientMessage) {
        return RingbufferAddAsyncCodec.decodeRequest(clientMessage);
    }
