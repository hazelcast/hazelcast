 ...
 * and returns false
 */
public class CPCountDownLatchTrySetCountCodec {

        private static final int REQUEST_COUNT_FIELD_OFFSET = CORRELATION_ID_FIELD_OFFSET + INT_SIZE_IN_BYTES;
        private static final int REQUEST_INITIAL_FRAME_SIZE = REQUEST_COUNT_FIELD_OFFSET + LONG_SIZE_IN_BYTES;
        public static final int REQUEST_MESSAGE_TYPE = 9473;//hex: 0x2501,
    ...
    public static CPCountDownLatchTrySetCountCodec.RequestParameters decodeRequest(ClientMessage clientMessage) {
    ...
    public static CPCountDownLatchTrySetCountCodec.ResponseParameters decodeResponse(ClientMessage clientMessage) {
        ListIterator<ClientMessage.Frame> iterator = clientMessage.iterator();
