 ...
 */
@Generated("331274d2b56b19b16e868a60cfe334db")
public final class MapGetEntryViewCodec {
    ...
    public static ClientMessage encodeRequest(java.lang.String name, Data key, long threadId) {
    ...
    public static class ResponseParameters {
         ...
         * TODO DOC
         */
        public @Nullable com.hazelcast.map.impl.SimpleEntryView<Data, Data> response;
    ...
    public static ClientMessage encodeResponse(@Nullable com.hazelcast.map.impl.SimpleEntryView<Data, Data> response, long maxIdle) {
        ClientMessage clientMessage = ClientMessage.createForEncode();
