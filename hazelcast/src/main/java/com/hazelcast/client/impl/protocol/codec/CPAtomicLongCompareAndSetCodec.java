 ...
 */
public class CPAtomicLongCompareAndSetCodec {

        private static final int REQUEST_EXPECTED_FIELD_OFFSET = CORRELATION_ID_FIELD_OFFSET + LONG_SIZE_IN_BYTES;
        ...
        public static final int REQUEST_MESSAGE_TYPE = 8964;//hex: 0x2304,
