 ...
 */
public class ScheduledExecutorCancelFromPartitionCodec {

        private static final int REQUEST_MAY_INTERRUPT_IF_RUNNING_FIELD_OFFSET = CORRELATION_ID_FIELD_OFFSET + BOOLEAN_SIZE_IN_BYTES;
        private static final int REQUEST_INITIAL_FRAME_SIZE = REQUEST_MAY_INTERRUPT_IF_RUNNING_FIELD_OFFSET + LONG_SIZE_IN_BYTES;
        public static final int REQUEST_MESSAGE_TYPE = 7433;//hex: 0x1D09,
