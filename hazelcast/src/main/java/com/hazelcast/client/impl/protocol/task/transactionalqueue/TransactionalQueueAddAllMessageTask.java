...
public class TransactionalQueueAddAllMessageTask
    ...
    public TransactionalQueueAddAllMessageTask(ClientMessage clientMessage, Node node, Connection connection) {
    ...
    @Override
    protected TransactionalQueueAddAllCodec.RequestParameters decodeClientMessage(ClientMessage clientMessage) {
        return TransactionalQueueAddAllCodec.decodeRequest(clientMessage);
    }

    @Override
    protected ClientMessage encodeResponse(Object response) {
        return TransactionalQueueAddAllCodec.encodeResponse((Boolean) response);
    }
    ...
    public Object[] getParameters() {
        return new Object[]{parameters.items, parameters.timeout};
    }
}
