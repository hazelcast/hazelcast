...
import com.hazelcast.client.impl.protocol.task.transactionalqueue.TransactionalQueueContainsAllMessageTask;
...
public class DefaultMessageTaskFactoryProvider implements MessageTaskFactoryProvider {
    ...
    private void initializeTransactionalQueueTaskFactories() {
        ...
        factories.put(TransactionalQueueContainsAllCodec.REQUEST_MESSAGE_TYPE,
                (cm, con) -> new TransactionalQueueContainsAllMessageTask(cm, node, con));
    }
