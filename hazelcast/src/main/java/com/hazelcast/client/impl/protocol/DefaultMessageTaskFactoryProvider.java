...
import com.hazelcast.client.impl.protocol.task.transactionalqueue.TransactionalQueueRemoveAllMessageTask;
...
public class DefaultMessageTaskFactoryProvider implements MessageTaskFactoryProvider {
    ...
    private void initializeTransactionalQueueTaskFactories() {
        ...
        factories.put(TransactionalQueueRemoveAllCodec.REQUEST_MESSAGE_TYPE,
                (cm, con) -> new TransactionalQueueRemoveAllMessageTask(cm, node, con));
    }
