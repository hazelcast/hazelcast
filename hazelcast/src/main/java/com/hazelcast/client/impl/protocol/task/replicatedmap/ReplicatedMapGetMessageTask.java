...
public class ReplicatedMapGetMessageTask extends AbstractCallableMessageTask<ReplicatedMapGetParameters> {
    ...
    @Override
    protected ReplicatedMapGetParameters decodeClientMessage(ClientMessage clientMessage) {
        return ReplicatedMapGetParameters.decode(clientMessage);
    }
