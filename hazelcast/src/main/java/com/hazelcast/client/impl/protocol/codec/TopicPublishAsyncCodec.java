 ...
 */
@Generated("940be12e0cda3c7152447753b0982faf")
public final class TopicPublishAsyncCodec {
    //hex: 0x040500
    public static final int REQUEST_MESSAGE_TYPE = 263424;
    //hex: 0x040501
    public static final int RESPONSE_MESSAGE_TYPE = 263425;
    ...
    private TopicPublishAsyncCodec() {
    }
    ...
    public static ClientMessage encodeRequest(java.lang.String name, com.hazelcast.internal.serialization.Data message) {
        ...
        clientMessage.setOperationName("Topic.PublishAsync");
    ...
    public static TopicPublishAsyncCodec.RequestParameters decodeRequest(ClientMessage clientMessage) {
    ...
    public static TopicPublishAsyncCodec.ResponseParameters decodeResponse(ClientMessage clientMessage) {
        ClientMessage.ForwardFrameIterator iterator = clientMessage.frameIterator();
