...
public class ReduceOperation extends LogOperation {

    private BinaryOperator accumulator;
    private Object result;

    public ReduceOperation() {
    }

    public ReduceOperation(String name, BinaryOperator accumulator) {
        super(name);
    ...
    public void run() throws Exception {
        ...
        result = container.reduce(accumulator);
    }
    ...
    public int getClassId() {
        return LogDataSerializerHook.REDUCE;
    }
