 ...
 * and finds a random target address to sent that callable according to the given target creator function.
 */
public class RandomTargetCallableRequest extends TargetCallableRequest implements RefreshableRequest {
    ...
    @Override
    public void refresh() {
        Address target = targetCreator.createNew(null);
        setTarget(target);
    }
}
