 ...
 */
public final class TcpConnectionReadHandler extends AbstractSelectionHandler implements ReadHandler {
    ...
    public TcpConnectionReadHandler(TcpIpConnection connection, IOReactor ioReactor) {
        super(connection, ioReactor, SelectionKey.OP_READ);
    ...
    public void requestMigration(IOReactor newOwner) {
        ioReactor.addTaskAndWakeup(new StartMigrationTask(newOwner));
    }
    ...
    private class StartMigrationTask implements Runnable {
        private final IOReactor newOwner;

        public StartMigrationTask(IOReactor newOwner) {
