...
class MigrationStrategy {
     ...
     */
    <T extends MigratableHandler & SelectionHandler> MigratableHandler findHandlerToMigrate(BalancerState<T> state) {
        Set<T> candidates = state.getHandlersOwnerBy(state.sourceSelector);
