 ...
 */
public final class TcpConnectionWriteHandler extends AbstractSelectionHandler implements Runnable, WriteHandler {
    ...
    private IOReactor newOwner;

    TcpConnectionWriteHandler(TcpIpConnection connection, IOReactor ioReactor) {
        super(connection, ioReactor, SelectionKey.OP_WRITE);
    ...
    void setProtocol(final String protocol) {
        ...
        ioReactor.addTaskAndWakeup(new Runnable() {
            @Override
            public void run() {
    ...
    private void schedule() {
        ...
        ioReactor.addTaskAndWakeup(this);
    }
    ...
    public void handleWrite() {
        ...
        if (newOwner == null) {
            ...
            IOReactor newOwner = this.newOwner;
            this.newOwner = null;
    ...
    public void run() {
        try {
            ...
            ioReactor.handleSelectionKeyFailure(e);
        }
    }
    ...
    @Override
    public void requestMigration(IOReactor newOwner) {
    ...
    private class StartMigrationTask extends TaskPacket {
        ...
        private final IOReactor theNewOwner;

        public StartMigrationTask(IOReactor theNewOwner) {
