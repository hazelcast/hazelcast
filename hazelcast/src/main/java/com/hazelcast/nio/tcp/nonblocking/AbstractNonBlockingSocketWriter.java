...
public abstract class AbstractNonBlockingSocketWriter<C extends Connection>
    ...
    private WriteHandler<OutboundFrame> writeHandler;
    ...
    protected void configureBuffers(int size, boolean direct) {
        outputBuffer = newByteBuffer(size, direct);
    }
    ...
    public void handle() throws Exception {
        ...
        if (writeHandler == null) {
            writeHandler = createWriterHandler();
        }
    ...
    protected abstract WriteHandler createWriterHandler() throws IOException;
    ...
    /**
     * The TaskFrame is not really a OutboundFrame. It is a way to put a task on the write-queues. Using this approach we
