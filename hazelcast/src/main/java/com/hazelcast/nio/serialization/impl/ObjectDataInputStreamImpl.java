...
public class ObjectDataInputStreamImpl extends InputStream implements ObjectDataInputStream {
    ...
    public ObjectDataInputStreamImpl(InputStream in, SerializationService serializationService) {
