...
public class ObjectDataOutputStreamImpl extends OutputStream implements ObjectDataOutputStream {
    ...
    public ObjectDataOutputStreamImpl(OutputStream outputStream, SerializationService serializationService) {
