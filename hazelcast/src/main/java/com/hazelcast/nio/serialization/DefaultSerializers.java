...
public final class DefaultSerializers {
    ...
    private static final List<SingletonTypeSerializerSupport> DEFAULT_SERIALIZERS;

    static {
        // order is important !
        final List<SingletonTypeSerializerSupport> coll = new LinkedList<SingletonTypeSerializerSupport>();
    ...
    public static TypeSerializer serializerFor(Class type) {
        for (SingletonTypeSerializerSupport serializer : DEFAULT_SERIALIZERS) {
    ...
    public static final class IntegerSerializer extends SingletonTypeSerializerSupport<Integer> {
    ...
    public static final class LongSerializer extends SingletonTypeSerializerSupport<Long> {
    ...
    public static final class StringSerializer extends SingletonTypeSerializerSupport<String> {
    ...
    public static final class ByteArraySerializer extends SingletonTypeSerializerSupport<byte[]> {
    ...
    public static final class BooleanSerializer extends SingletonTypeSerializerSupport<Boolean> {
    ...
    public static final class BigIntegerSerializer extends SingletonTypeSerializerSupport<BigInteger> {
    ...
    public static final class DateSerializer extends SingletonTypeSerializerSupport<Date> {
    ...
    public static final class ClassSerializer extends SingletonTypeSerializerSupport<Class> {
    ...
    public static final class Externalizer extends SingletonTypeSerializerSupport<Externalizable> {
    ...
    public static final class ObjectSerializer extends SingletonTypeSerializerSupport<Object> {
    ...
    private abstract static class SingletonTypeSerializerSupport<T> implements TypeSerializer<T> {
