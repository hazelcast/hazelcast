...
public enum Command {
    ...
    MCONTAINSKEY, MCONTAINSVALUE, ADDLSTNR, EVENT, RMVLSTNR, KEYSET, ENTRYSET, MGETENTRY, MLOCK, MISKEYLOCKED, MUNLOCK,
    MLOCKMAP, MUNLOCKMAP, MFORCEUNLOCK, MPUTALL, MPUTIFABSENT, MREMOVEIFSAME, MREPLACEIFNOTNULL, MREPLACEIFSAME,
    MTRYLOCKANDGET, MFLUSH,
    SADD, LADD, MMPUT, MMREMOVE, MMVALUECOUNT, QOFFER;
