...
public enum Command {
    ...
    AUTH(), OK(), ERROR(), INSTANCES(), MEMBERS(), CLUSTERTIME(), PARTITIONS(), TRXCOMMIT(), TRXROLLBACK(), TRXBEGIN(), DESTROY(),UNKNOWN(),
    ...
    MTRYLOCK(), MLOCKMAP(), MUNLOCKMAP(), MFORCEUNLOCK(), MPUTALL(), MPUTIFABSENT(), MREMOVEIFSAME(), MREPLACEIFNOTNULL(), MREPLACEIFSAME(),
    MTRYLOCKANDGET(), MTRYREMOVE(), MFLUSH(), MEVICT(), MADDLISTENER(), MREMOVELISTENER(),

    QOFFER(), QPUT(), QPOLL(), QTAKE(), QSIZE(), QPEEK(), QREMOVE(), QREMCAPACITY(), QENTRIES(), QADDLISTENER(), QREMOVELISTENER(),
    ...
    SADD(), LADD(), MMPUT(), MMREMOVE(), MMVALUECOUNT(),
