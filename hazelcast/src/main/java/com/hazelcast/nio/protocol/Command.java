...
public enum Command {
    ...
    AUTH(), OK(), ERROR(), INSTANCES(), MEMBERS(), MEMBERLISTEN(), CLUSTERTIME(), PARTITIONS(), MIGRATIONLISTEN(), TRXCOMMIT(), TRXROLLBACK(), TRXBEGIN(),
    ...
    SADD(), SREMOVE(), SCONTAINS(), SGETALL(), SLISTEN(),
    LADD(), LREMOVE(), LCONTAINS(), LGETALL(),LLISTEN(), LGET(), LINDEXOF(), LLASTINDEXOF(), LSET(),
