...
public class CompareToOperation
    ...
    public CompareToOperation(ScheduledTaskHandler descriptor, Data delayed) {
        this(descriptor,  (Delayed) null);
        this.delayed = getNodeEngine().getSerializationService().toObject(delayed);
    }
