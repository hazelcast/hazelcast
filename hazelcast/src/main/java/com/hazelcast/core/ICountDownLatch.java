 ...
 * data structure.  During a split, each partitioned cluster will either create a brand new and uninitialised
 ...
 * may diverge.
 * <p>
 * When the split heals, Hazelcast performs a default largest cluster wins resolution. This can lead to situations
 * where the {@ICountDown} is left in an unpredictable state, and a countdown to zero may not be achieved.
 * <p>
