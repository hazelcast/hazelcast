 ...
 * doing remote call for every call to {@link #newId()}, it does it less frequently. It checks out a chunk, e.g. 1..1000
 ...
 * chunk. It can be that member 1 has chunk 1..1000 and member 2 has 1001..2000. Therefore, member 2 will automatically
 * have IDs that are out of order with the IDs generated by member 1.
 * <p>
 ...
 * underlying persistent storage, for example a {@link IMap} that writes to a Relational Database using {@link MapStore}.
 */
