...
public interface QueueStore<V> {
     ...
     */
    void store(Long key, StoreValue<V> value);
     ...
     */
    void storeAll(Map<Long, StoreValue<V>> map);
     ...
     */
    Map<Long, StoreValue<V>> loadAll(Collection<Long> keys);
