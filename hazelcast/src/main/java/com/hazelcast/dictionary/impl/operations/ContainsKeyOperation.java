...
import static com.hazelcast.dictionary.impl.DictionaryDataSerializerHook.CONTAINS_KEY_OPERATION;
import static com.hazelcast.spi.CallStatus.DONE_RESPONSE;

public class ContainsKeyOperation extends DictionaryOperation {
    ...
    public ContainsKeyOperation(String name, Data keyData) {
        super(name);
    ...
    public CallStatus call() throws Exception {
        ...
        response = segment.containsKey(keyData, partitionHash);
