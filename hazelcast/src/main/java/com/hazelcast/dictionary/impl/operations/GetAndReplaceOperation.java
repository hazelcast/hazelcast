...
public class GetAndReplaceOperation extends DictionaryOperation {

    private Data value;
    private Data key;
    private Object response;

    public GetAndReplaceOperation() {
    }

    public GetAndReplaceOperation(String name, Data key, Data value) {
        super(name);
        this.key = key;
        this.value = value;
    }
    ...
    public CallStatus call() throws Exception {
        ...
        response = segment.getAndReplace(key, partitionHash, value);
