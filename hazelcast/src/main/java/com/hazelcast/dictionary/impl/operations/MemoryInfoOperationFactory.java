...
public class MemoryInfoOperationFactory implements OperationFactory {

    private String name;

    public MemoryInfoOperationFactory() {
    }

    public MemoryInfoOperationFactory(String name) {
        this.name = name;
    }

    @Override
    public Operation createOperation() {
        return new MemoryInfoOperation(name);
    }
