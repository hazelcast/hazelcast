 ...
 */
public final class PartitionOperationThreadImpl extends OperationThread implements PartitionOperationThread {

    private final OperationRunner[] partitionOperationRunners;

    @SuppressFBWarnings("EI_EXPOSE_REP")
    public PartitionOperationThreadImpl(String name,
                                        int threadId,
