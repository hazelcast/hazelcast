...
public final class TargetInvocation extends Invocation {
    ...
    public TargetInvocation(OperationServiceImpl operationService, Operation op,
        ...
        super(operationService, op, tryCount, tryPauseMillis, callTimeout, resultDeserialized, null);
        this.target = target;
    }

    public TargetInvocation(OperationServiceImpl operationService, Operation op,
                            Address target, int tryCount, long tryPauseMillis, long callTimeout,
                            boolean resultDeserialized, ExecutionCallback callback) {
        super(operationService, op, tryCount, tryPauseMillis, callTimeout, resultDeserialized, callback);
        this.target = target;
    }
