...
public interface OperationService {
    ...
    <E> InvocationFuture<E> invokeOnMaster(String serviceName, Operation op, Address knownMasterAddress);
    ...
    InvocationBuilder createMasterInvocationBuilder(String serviceName, Operation op, Address knownMasterAddress);
