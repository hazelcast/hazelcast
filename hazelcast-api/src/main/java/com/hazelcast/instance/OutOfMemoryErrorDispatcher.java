...
public final class OutOfMemoryErrorDispatcher {
    ...
    private static volatile OutOfMemoryHandler handler;
    ...
    static {
        try {
            ClassLoader classLoader = OutOfMemoryErrorDispatcher.class.getClassLoader();
            Class<OutOfMemoryHandler> clazz = (Class<OutOfMemoryHandler>) classLoader
                    .loadClass("com.hazelcast.instance.DefaultOutOfMemoryHandler");
