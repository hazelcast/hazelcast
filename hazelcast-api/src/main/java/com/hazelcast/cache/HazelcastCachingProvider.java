...
public final class HazelcastCachingProvider
    ...
    private static final String SERVER_CACHING_PROVIDER_CLASS = "com.hazelcast.cache.impl.HazelcastServerCachingProvider";
    ...
    private CachingProvider createServerProvider() {
        try {
            return ClassLoaderUtil.newInstance(getClass().getClassLoader(), SERVER_CACHING_PROVIDER_CLASS);
        } catch (Exception e) {
            throw new CacheException("Could not load server CachingProvider!", e);
        }
    }
