...
class JobManagerRequestCallback implements ExecutionCallback<JobManagerResponse> {
    private final Operation operation;
    private final String failureMsg;
    private final Runnable onSuccess;

    public JobManagerRequestCallback(Operation operation, String failureMsg, Runnable onSuccess) {
