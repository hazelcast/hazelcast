...
public class RestServiceProvider implements ServiceDescriptorProvider {

    @Override
    public ServiceDescriptor[] createServiceDescriptors() {
        return new ServiceDescriptor[]{new RestServiceDescriptor()};
    }

    private static class RestServiceDescriptor implements ServiceDescriptor {

        @Override
        public String getServiceName() {
            return RestServiceImpl.SERVICE_NAME;
        }
