 ...
 * <ol>
 *     <li>Global tasks: tasks that are offered by other threads</li>
 ...
 *     <li>Tasks from some asynchronous eventing system that interacts with I/O like the
 *     {@link com.hazelcast.internal.tpcengine.file.AsyncFile}, {@link AsyncServerSocket} and
 *     {@link AsyncSocket}.</li>>
 * </ol>
 * <p/>
...
public abstract class Reactor implements Executor {
    ...
    /**
     * Returns the {@link ReactorMetrics} of this reactor.
     * <p/>
     * This method is thread-safe.
     *
     * @return the {@link ReactorMetrics}. Thee returned value will always be a
     * valid {@link ReactorMetrics} instance independent of the state of the reactor.
     */
    ...
    public final boolean offer(Object task, TaskQueueHandle handle) {
        ...
        } else if (handle.queue.offerGlobal(task)) {
            wakeup();
            return true;
        } else {
            return false;
