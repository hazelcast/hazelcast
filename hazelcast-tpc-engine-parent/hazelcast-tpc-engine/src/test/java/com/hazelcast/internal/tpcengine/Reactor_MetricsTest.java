...
public class Reactor_MetricsTest {

    @Test
    public void test() {
        Reactor.Metrics metrics = new Reactor.Metrics();
        ...
        assertEquals(1, metrics.taskQueueCsCount());

        assertEquals(0, metrics.ioSchedulerTicks());
        metrics.incIoSchedulerTicks();
        assertEquals(1, metrics.ioSchedulerTicks());

        assertEquals(0, metrics.parkTimeNanos());
        metrics.incParkTimeNanos(20);
        assertEquals(20, metrics.parkTimeNanos());
