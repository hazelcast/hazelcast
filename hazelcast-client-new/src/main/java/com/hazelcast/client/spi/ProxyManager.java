...
public final class ProxyManager {
    ...
    private final ListenerMessageCodec addDistributedObjectListenerCodec = new ListenerMessageCodec() {
        @Override
    ...
    public String addDistributedObjectListener(final DistributedObjectListener listener) {
        ...
        return client.getListenerService().startListening(addDistributedObjectListenerCodec, eventHandler);
    }
    ...
    public boolean removeDistributedObjectListener(String id) {
        return client.getListenerService().stopListening(id);
    }
