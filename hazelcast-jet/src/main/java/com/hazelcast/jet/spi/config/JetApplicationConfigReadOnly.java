...
/**
 * Read-only config for JET application;
 */
public class JetApplicationConfigReadOnly extends JetApplicationConfig {
    public JetApplicationConfigReadOnly(JetApplicationConfig defConfig, String name) {
        super(defConfig, name);
    }

    public JetApplicationConfigReadOnly(String name) {
        super(name);
    }
