...
import com.hazelcast.jet.io.spi.Types;
import com.hazelcast.nio.ObjectDataOutput;

import java.io.IOException;

public class DefaultObjectWriter implements ObjectWriter<Object> {
    @Override
    public void writeType(Object object,
                          ObjectDataOutput objectDataOutput,
                          ObjectWriterFactory objectWriterFactory) throws IOException {
        objectDataOutput.writeByte(Types.OBJECT.getTypeID());
    }
