...
public @interface SerializableByConvention {
    ...
    enum Reason {
        /**
         * Class definition is part of public API so cannot be migrated to {@code IdentifiedDataSerializable} in
         * minor or patch releases.
         */
        PUBLIC_API,
        /**
         * Class is {@code Serializable} due to inheritance or other coding conventions and cannot or is not desirable
         * to have it converted to {@code IdentifiedDataSerializable}.
         * Examples:
         * <ul>
         ...
         *     {@code com.hazelcast.cache.impl.CacheEntryEventImpl} is never used in serialized form, so there
         *     is no interest in converting this class to {@code IdentifiedDataSerializable}</li>
         ...
         * {@code IdentifiedDataSerializable}, so these are not annotated with {@code SerializableByConvention}.
