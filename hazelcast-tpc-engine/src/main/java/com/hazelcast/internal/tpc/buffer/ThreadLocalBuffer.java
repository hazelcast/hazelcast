...
public class ThreadLocalBuffer implements Buffer {
    ByteBuffer[] chunks;

    private final ConcurrentBufferAllocator superAllocator;
    ...
    void overtakenBy(ThreadLocalBufferAllocator allocator) {
        this.allocator = allocator;
    }
