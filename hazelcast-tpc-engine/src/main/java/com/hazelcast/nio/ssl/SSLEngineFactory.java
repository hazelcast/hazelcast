 ...
 * {@link com.hazelcast.internal.tpcengine.net.AsyncSocketBuilder} can rely on it.
 */
public interface SSLEngineFactory {
     ...
     * @param forClient if the SslEngineFactory is created for a client or for a member.
     ...
     *        be in 'serverMode'.
     * @param peerAddress peer's {@link SocketAddress} - can be {@code null}. The address can be used for instance to a TLS
     *        hostname validation.
