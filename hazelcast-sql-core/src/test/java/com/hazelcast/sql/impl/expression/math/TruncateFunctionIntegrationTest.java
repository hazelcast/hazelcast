...
public class TruncateFunctionIntegrationTest extends ExpressionTestSupport {
    ...
    public void test_boolean() {
        checkColumnFailure_2(new ExpressionBiValue.BooleanIntegerVal().fields(true, 127), SqlErrorCode.PARSING, "Cannot apply [BOOLEAN, INTEGER] to the 'TRUNCATE' function (consider adding an explicit CAST)");
        checkColumnFailure_2(new ExpressionBiValue.IntegerBooleanVal().fields(127, true), SqlErrorCode.PARSING, "Cannot apply [INTEGER, BOOLEAN] to the 'TRUNCATE' function (consider adding an explicit CAST)");
    }

    @Test
    public void test_temporal() {
        checkColumnFailure_2(new ExpressionBiValue.IntegerLocalDateVal().fields(127, LOCAL_DATE_VAL), SqlErrorCode.PARSING, "Cannot apply [INTEGER, DATE] to the 'TRUNCATE' function (consider adding an explicit CAST)");
        checkColumnFailure_2(new ExpressionBiValue.IntegerLocalTimeVal().fields(127, LOCAL_TIME_VAL), SqlErrorCode.PARSING, "Cannot apply [INTEGER, TIME] to the 'TRUNCATE' function (consider adding an explicit CAST)");
        checkColumnFailure_2(new ExpressionBiValue.IntegerLocalDateTimeVal().fields(127, LOCAL_DATE_TIME_VAL), SqlErrorCode.PARSING, "Cannot apply [INTEGER, TIMESTAMP] to the 'TRUNCATE' function (consider adding an explicit CAST)");
        checkColumnFailure_2(new ExpressionBiValue.IntegerOffsetDateTimeVal().fields(127, OFFSET_DATE_TIME_VAL), SqlErrorCode.PARSING, "Cannot apply [INTEGER, TIMESTAMP_WITH_TIME_ZONE] to the 'TRUNCATE' function (consider adding an explicit CAST)");
    }

    @Test
    public void test_object() {
        checkColumnFailure_2(new IntegerObjectVal().fields(127, "bad"), SqlErrorCode.PARSING, "Cannot apply [INTEGER, OBJECT] to the 'TRUNCATE' function (consider adding an explicit CAST)");
    }
    ...
    public void testLiterals() {
        ...
        checkFailure_2("'15'", "field1", SqlErrorCode.PARSING, "Cannot apply [VARCHAR, INTEGER] to the 'TRUNCATE' function");
        checkFailure_2("true", "field1", SqlErrorCode.PARSING, "Cannot apply [BOOLEAN, INTEGER] to the 'TRUNCATE' function (consider adding an explicit CAST)");

        // Second operand
        put(new IntegerVal().field1(15));
        check_2("field1", "-1", SqlColumnType.INTEGER, 10);
        checkFailure_2("field1", "'-1'", SqlErrorCode.PARSING, "Cannot apply [INTEGER, VARCHAR] to the 'TRUNCATE' function (consider adding an explicit CAST)");
        checkFailure_2("field1", "true", SqlErrorCode.PARSING, "Cannot apply [INTEGER, BOOLEAN] to the 'TRUNCATE' function (consider adding an explicit CAST)");
    }
