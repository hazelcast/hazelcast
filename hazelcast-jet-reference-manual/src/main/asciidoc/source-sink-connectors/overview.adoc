...
|image::cross-mark.png[X,0,2.5ex]
|✅
|image::cross-mark.png[X,,2.5ex]
|✅
|Src ✅

Sink image::cross-mark.png[X,,2.5ex]
...
|Local FS ✅
 ...
 Shared FS image::cross-mark.png[X,,2.5ex]
...
Topic Source image::cross-mark.png[X,,2.5ex]
