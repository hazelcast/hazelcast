...
|{jet-samples}/files/src/main/java/com/hazelcast/jet/examples/files/s3/S3WordCount.java[Source Sample]

{jet-samples}/files/src/main/java/com/hazelcast/jet/examples/files/s3/S3WordCount.java[Sink Sample]
|image:cross-mark.png[X,16,16]
|image:check-mark.png[X,16,16]
|image:cross-mark.png[X,16,16]
|image:check-mark.png[X,16,16]
