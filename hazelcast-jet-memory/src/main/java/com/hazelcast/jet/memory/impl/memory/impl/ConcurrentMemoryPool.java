...
package com.hazelcast.jet.memory.impl.memory.impl;
...
public class ConcurrentMemoryPool implements MemoryPool {
    private final long total;
    private final MemoryType memoryType;
    private final AtomicLong usedMemory = new AtomicLong(0L);

    public ConcurrentMemoryPool(long totalSizeInBytes,
