...
/**
 * Comparator of binary data. Also provides a hasher compatible with the comparison logic.
 */
public interface Comparator {
     ...
     */
    int compare(long leftAddress, long leftSize, long rightAddress, long rightSize);
     ...
     * 0 if blobs are equal;
     */
    int compare(MemoryAccessor leftAccessor, MemoryAccessor rightAccessor,
