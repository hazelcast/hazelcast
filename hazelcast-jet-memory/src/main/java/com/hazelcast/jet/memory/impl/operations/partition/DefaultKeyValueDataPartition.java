...
public class DefaultKeyValueDataPartition<T>
        extends BaseKeyValueDataPartition<T, BinaryKeyValueStorage<T>> {
    public DefaultKeyValueDataPartition(int partitionId,
        ...
        super(
                ...
                memoryContext,
                memoryChainingType,
                BinaryStorageFactory.getStorage(
