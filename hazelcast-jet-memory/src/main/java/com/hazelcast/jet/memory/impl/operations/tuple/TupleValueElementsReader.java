...
public class TupleValueElementsReader implements ElementsReader<Tuple> {
    ...
    public Object next() {
        try {
            return source.getValue(valueIndex);
        } finally {
            valueIndex++;
        }
    }
    ...
    public boolean hasNext() {
        return valueIndex < source.keySize();
    }

    @Override
    public int size() {
        return source.valueSize();
    }
