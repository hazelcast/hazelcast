...
/**
 * Accumulates short values into a short value.
 */
public abstract class ShortAccumulator implements Accumulator {
    @Override
    public void accept(
        ...
        short oldValue = EndiannessUtil.readShort(CUSTOM_ACCESS,
                accMemoryAccessor, oldDataAddress, useBigEndian);
        short newValue = EndiannessUtil.readShort(CUSTOM_ACCESS,
                newMemoryAccessor, newDataAddress, useBigEndian);
        EndiannessUtil.writeShort(CUSTOM_ACCESS,
                accMemoryAccessor, oldDataAddress, apply(oldValue, newValue), useBigEndian);
    }

    protected abstract short apply(short oldValue, short newValue);
}
